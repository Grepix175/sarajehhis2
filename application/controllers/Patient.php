...
class Patient extends CI_Controller
{
    ...
    public function patient_excel()
    {
        ...
        $fields = array($data, 'Patient Category', 'Patient Name', 'Gender', 'Mobile No.', 'Created Date');
        ...
        if (!empty($list)) {
            ...
            foreach ($list as $patients) {
                ...
                array_push($rowData, $patients->patient_code, $patients->patient_category_name, $patients->patient_name, $gender, $patients->mobile_no, $created_date);
                $count = count($rowData);
                for ($j = 0; $j < $count; $j++) {
