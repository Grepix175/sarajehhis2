...
class Add_eye_prescription extends CI_Controller
{
  ...
  public function view_prescription($pres_id, $booking_id = '')
  {
    ...
    $diagnosis_data = json_decode($diagno_result['diagnosis_data']);
    $diagno_lists = (array) $diagnosis_data;
    $data['diagno_lists'] = $diagno_lists['icd'] ?? '';
    $data['provisional_comment'] = $diagno_result['provisional_cmnt'];
    $data['provisional_check'] = $diagno_result['provisional_check'];
    $data['provisional_date'] = $diagno_result['created_date'];
    ...
    $data['biometry_ob_k1_one'] = $result_biometry['biometry_ob_k1_one'] ?? null;
    $data['biometry_ob_k1_two'] = $result_biometry['biometry_ob_k1_two'] ?? null;
    $data['biometry_ob_k1_three'] = $result_biometry['biometry_ob_k1_three'] ?? null;
    $data['biometry_ob_k2_one'] = $result_biometry['biometry_ob_k2_one'] ?? null;
    $data['biometry_ob_k2_two'] = $result_biometry['biometry_ob_k2_two'] ?? null;
    $data['biometry_ob_k2_three'] = $result_biometry['biometry_ob_k2_three'] ?? null;
    $data['biometry_ob_al_one'] = $result_biometry['biometry_ob_al_one'] ?? null;
    $data['biometry_ob_al_two'] = $result_biometry['biometry_ob_al_two'] ?? null;
    $data['biometry_ob_al_three'] = $result_biometry['biometry_ob_al_three'] ?? null;
    $data['biometry_ascan_one'] = $result_biometry['biometry_ascan_one'] ?? null;
    $data['biometry_ascan_two'] = $result_biometry['biometry_ascan_two'] ?? null;
    $data['biometry_ascan_three'] = $result_biometry['biometry_ascan_three'] ?? null;
    $data['biometry_ascan_sec_one'] = $result_biometry['biometry_ascan_sec_one'] ?? null;
    $data['biometry_ascan_sec_two'] = $result_biometry['biometry_ascan_sec_two'] ?? null;
    $data['biometry_ascan_sec_three'] = $result_biometry['biometry_ascan_sec_three'] ?? null;
    $data['biometry_ascan_thr_one'] = $result_biometry['biometry_ascan_thr_one'] ?? null;
    $data['biometry_ascan_thr_two'] = $result_biometry['biometry_ascan_thr_two'] ?? null;
    $data['biometry_ascan_thr_three'] = $result_biometry['biometry_ascan_thr_three'] ?? null;
    $data['biometry_iol_one'] = $result_biometry['biometry_iol_one'] ?? null;

    $data['biometry_srk_one'] = $result_biometry['biometry_srk_one'] ?? null;

    $data['biometry_error_one'] = $result_biometry['biometry_error_one'] ?? null;
    $data['biometry_barett_one'] = $result_biometry['biometry_barett_one'] ?? null;
    $data['biometry_error_one_two'] = $result_biometry['biometry_error_one_two'] ?? null;
    $data['biometry_iol_two'] = $result_biometry['biometry_iol_two'] ?? null;
    $data['biometry_ascan_sec_sec'] = $result_biometry['biometry_ascan_sec_sec'] ?? null;
    $data['biometry_error_sec'] = $result_biometry['biometry_error_sec'] ?? null;

    $data['biometry_barett_sec'] = $result_biometry['biometry_barett_sec'] ?? null;
    $data['biometry_error_one_sec'] = $result_biometry['biometry_error_one_sec'] ?? null;
    $data['biometry_iol_thr'] = $result_biometry['biometry_iol_thr'] ?? null;
    $data['biometry_ascan_sec_thr'] = $result_biometry['biometry_ascan_sec_thr'] ?? null;
    $data['biometry_error_thr'] = $result_biometry['biometry_error_thr'] ?? null;
    $data['biometry_barett_thr'] = $result_biometry['biometry_barett_thr'] ?? null;
    $data['biometry_error_one_thr'] = $result_biometry['biometry_error_one_thr'] ?? null;
    $data['biometry_iol_four'] = $result_biometry['biometry_iol_four'] ?? null;
    $data['biometry_ascan_sec_four'] = $result_biometry['biometry_ascan_sec_four'] ?? null;
    $data['biometry_error_four'] = $result_biometry['biometry_error_four'] ?? null;
    $data['biometry_barett_four'] = $result_biometry['biometry_barett_four'] ?? null;
    $data['biometry_error_one_four'] = $result_biometry['biometry_error_one_four'] ?? null;

    $data['biometry_iol_five'] = $result_biometry['biometry_iol_five'] ?? null;
    $data['biometry_ascan_sec_five'] = $result_biometry['biometry_ascan_sec_five'] ?? null;

    $data['biometry_error_five'] = $result_biometry['biometry_error_five'] ?? null;

    $data['biometry_barett_five'] = $result_biometry['biometry_barett_five'] ?? null;

    $data['biometry_error_one_five'] = $result_biometry['biometry_error_one_five'] ?? null;

    $data['biometry_remarks'] = $result_biometry['biometry_remarks'] ?? null;
  ...
  public function prescription_file_upload()
  {
    if (!empty($_FILES['file'])) {
      ...
      if ($this->upload->do_upload('file')) {
        ...
        if (!empty($eye_file_upload)) { // echo '<pre>'; print_r($eye_file_upload);die;
