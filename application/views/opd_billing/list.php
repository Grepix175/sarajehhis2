  ...
  <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-sm-4">
              ...
              <div class="row m-b-5">
                ...
                <div class="col-xs-7">
                  <input name="reciept_code" id="reciept_code" class="m_input_default" onkeyup="return form_submit();"
                    value="<?php echo $form_data['reciept_code'] ?>" type="text" autofocus>
                </div>
              </div>
              <div class="row m-b-5">
            ...
            <div class="col-sm-4">
              <input value="Reset" class="btn-custom" class="col-sm-4 d-flex justify-content-center"
        ...
        <div class="fixed">
          <div class="btns opd_booking_list_right_btns">
            ...
            <a href="javascript:void(0)" class="btn-anchor m-b-2"
              onClick="return print_window_page('<?php echo base_url("opd_billing/opd_billing_print"); ?>');">
    ...
    <script>
      ...
      function clear_form_elements(ele) {
        $.ajax({
          url: "<?php echo base_url(); ?>opd_billing/reset_search/",
          success: function (result) {
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a data-dismiss="modal" class="btn-anchor"
              onClick="return handlePrintAndRedirect('<?php echo base_url("opd_billing/print_billing_report"); ?>');">Print</a>
