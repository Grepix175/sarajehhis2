      ...
      <div class="row">
        <div class="col-xs-4 media_50">
          ...
          <div class="row m-b-5">
            ...
            <div class="col-xs-8">
              <input type="text" readonly="" class="m_input_default" name="patient_code" id="patient_code"
          ...
          <div class="row m-b-5">
            ...
            <div class="col-xs-8">
              <input type="text" readonly="" name="reciept_code" class="m_input_default"
                value="<?php echo $form_data['reciept_code']; ?>" />
            </div>
          </div> <!-- row -->
          ...
          <div class="row m-b-5">
            ...
            <div class="col-xs-8">
              ...
              <input type="text" name="patient_name" id="patient_name"
                value="<?php echo $form_data['patient_name']; ?>" class="mr-name m_name txt_firstCap"
                style="width:134px!important;" autofocus />
          ...
          <div class="row m-b-5">
            ...
            <div class="col-xs-8">
              ...
              <input type="text"
                value="<?php if (isset($form_data['relation_name'])) {
          ...
          <div class="row m-b-5">
            ...
            <div class="col-xs-8">
              <input type="text" name="age_y" id="age_y" class="input-tiny m_tiny numeric" maxlength="3"
                value="<?php echo $form_data['age_y']; ?>"> Y &nbsp;
              <input type="text" name="age_m" id="age_m" class="input-tiny m_tiny numeric" maxlength="2"
                value="<?php echo $form_data['age_m']; ?>"> M &nbsp;
              <input type="text" name="age_d" id="age_d" class="input-tiny m_tiny numeric" maxlength="2"
          ...
          <div class="row m-b-5">
            ...
            <div class="col-xs-8">
              <input type="text" id="mobile_no" name="mobile_no" data-toggle="tooltip" title="Allow only numeric."
                class="tooltip-text numeric m_input_default" value="<?php echo $form_data['mobile_no']; ?>"
                maxlength="10" onkeyup="get_patient_detail_by_mobile();">
          ...
          <div class="row m-b-5">
            ...
            <div class="col-xs-8">
              <input type="text" name="patient_email" id="patient_email" class="email_address m_input_default"
          ...
          <div class="row m-b-5">
            ...
            <div class="col-xs-8">
              <input type="text" name="adhar_no" class="numeric m_input_default"
                value="<?php echo $form_data['adhar_no']; ?>" />
              <?php if (!empty($form_error)) {
          ...
          <div class="row m-b-4">
            ...
            <div class="col-xs-8">
              <input type="text" name="address" class="m_input_default address" id="address" maxlength="250"
                value="<?php echo $form_data['address']; ?>" />
            </div>
          </div> <!-- row -->
          <div class="row m-b-4">
            <div class="col-xs-4">
              <strong>Dist./Taluk/Thana</strong>
            </div>
            <div class="col-xs-8">
              <input type="text" name="address_second" class="m_input_default address" id="address" maxlength="250"
          ...
          <!-- <div class="row m-b-4">
            ...
            <div class="col-xs-8">
              <input type="text" name="address_third" class="m_input_default address" id="address" maxlength="250"
                value="<?php echo $form_data['address_third']; ?>" />
            </div>
          </div> row -->
          ...
          <!-- <div class="row m-b-5">
            ...
            <div class="col-xs-8">
              <select name="country_id" class="m_input_default" id="countrys_id"
          ...
          <!-- <div class="row m-b-5">
            <div class="col-md-12">
              <div class="row">
                <div class="col-xs-4"><b>Panel Type</b> <sup class="info"><a href="javascript:void(null)"
                      class="small info"> ?<span>A doctor within a given area available for consultation by patients
                        insured under the National Health Insurance Scheme It has two type <br> Normal: Having no
                        policy. <br>Panel:Having policy.</span></a></sup></div>
                <div class="col-xs-8" id="pannel_type11">
                  <input type="radio" name="pannel_type" id='' value="0"
                    onclick="set_tpa(0); particular_payment_calculation(); refresh_page();" <?php //if ($form_data['pannel_type'] == 0) {
                      //echo 'checked="checked"';
                    //} ?>> Normal &nbsp;
                  <input type="radio" name="pannel_type" value="1" id='' onclick="set_tpa(1);" <?php //if ($form_data['pannel_type'] == 1) {
                    //echo 'checked="checked"';
                  //} ?>> Panel
                  <?php //if (!empty($form_error)) {
                ...
                <div class="row">
                  ...
                  <div class="col-xs-8">
                    <select name="ins_company_id" id="ins_company_id" class="w-150px m_select_btn"
                      onchange="particular_payment_calculation(1);">
        ...
        <div class="col-xs-4 media_50">
                  ...
                  if (!empty($authrize_person_list)) {
                    foreach ($authrize_person_list as $authrizelist) {
                      ...
                      <option <?php if ($form_data['authorize_person'] == $authrizelist->id) {
                        ...
                        value="<?php echo $authrizelist->id; ?>"><?php echo $authrizelist->authorize_person; ?></option>
          ...
          <div class="row m-b-5" id="doctor_div" <?php if ($form_data['referred_by'] == 0) {
            ...
            <div class="col-xs-9">
              <select name="referral_doctor" id="refered_id" class="m_select_btn"
                onChange="return get_others(this.value)">
                ...
                if (!empty($referal_doctor_list)) {
                  foreach ($referal_doctor_list as $referal_doctor) {
                    ...
                    <option <?php if ($form_data['referral_doctor'] == $referal_doctor->id) {
                      ...
                      value="<?php echo $referal_doctor->id; ?>"><?php echo $referal_doctor->doctor_name; ?></option>
          ...
          <div class="row m-b-5" id="ref_by_other" <?php if (!empty($form_data['ref_by_other']) && $form_data['referral_doctor'] == '0') {
                ...
                if (!empty($referal_hospital_list)) {
                  foreach ($referal_hospital_list as $referal_hospital) {
                    ...
                    <option <?php if ($form_data['referral_hospital'] == $referal_hospital->id) {
                      echo 'selected="selected"';
                    } ?> value="<?php echo $referal_hospital->id; ?>"><?php echo $referal_hospital->hospital_name; ?>
                    </option>
          ...
          <!-- <div class="row m-b-5">
            ...
            <div class="col-xs-9" id="specilizationid">
              <select name="specialization" class="m_select_btn" id="specilization_id"
                onChange="return get_doctor_specilization_dental(this.value);">
                ...
                //     ?>
                //     <option <?php //echo $select; ?> value="<?php //cho $specializationlist->id; ?>">
          ...
          <!-- <div class="row m-b-5">
            <div class="col-md-3"><b>Consultant</b> <sup class="info"><a href="javascript:void(null)"
                  class="small info"> ?<span>This is a doctor type which have two forms one is attended other is
                    referral it may be both. </span></a></sup></div>
            <div class="col-xs-9">
              <select name="attended_doctor" class="m_select_btn" id="attended_doctor"
                onchange="generate_token(this.value);">
          ...
          <div class="row m-b-5">
            ...
            <div class="col-xs-9">
              <input type="text" name="booking_date" id="booking_date" class="datepicker m_input_default"
                value="<?php echo $form_data['booking_date']; ?>" onchange="generate_token_by_date(this.value);" />
            </div>
          </div> <!-- row particulars -->
          ...
          <div class="row m-b-5">
            <div class="col-xs-3">
              <strong>Particulars <span class="star">*</span> </strong><sup class="info"><a
                  href="javascript:void(null)" class="small info"> ?<span>This is an objects used in hospital like
                    injections,xray machine.</span></a></sup>
            </div>
            <div class="col-xs-9">
              <select name="particulars" id="particulars" class="m_select_btn"
              ...
              <?php if (in_array('546', $users_data['permission']['action'])) {
                ?>
                <!-- <a title="Add Particulars" href="javascript:void(0)" onclick="return add_particulars();"
                  class="btn-new"><i class="fa fa-plus"></i> New</a> -->
              <?php } ?>
          ...
          <div class="row m-b-5">
            ...
            <div class="col-xs-9">
              <input type="text" name="charges" class="price_float m_input_default" id="charges"
                value="<?php echo $form_data['charges'] ?>">
            </div>
          </div> <!-- row -->
          ...
          <div class="row m-b-5" id="quantity_id">
            ...
            <div class="col-xs-9">
              <input type="text" name="quantity" id="quantity" class="numeric m_input_default"
                onkeyup="get_particular_amount();" value="<?php echo $form_data['quantity'] ?>">
            </div>
          </div> <!-- row -->
          <?php
          ...
          <div class="row m-b-5" id="amount_id" style='<?php echo $specialization_val_amount; ?>'>
            ...
            <div class="col-xs-9">
              <input type="text" class="price_float m_input_default" name="amount" id="amount"
                value="<?php echo $form_data['amount']; ?>"> <a title="Add Charge" class="btn-new"
                onclick="particular_payment_calculation(0);"> Add </a>
          ...
          <div class="row m-b-5">
            ...
            <div class="col-xs-9">
              <textarea name="remarks" id="remarks" class="m_input_default"
            ...
            <table class="table table-bordered table-striped opd_billing_table" id="particular_list">
              ...
              if (!empty($perticuller_list)) {
                ...
                foreach ($perticuller_list as $perticuller) {
                  ...
                  <tr>
                    <td>
                      <input type="checkbox" class="part_checkbox booked_checkbox" name="particular_id[]"
                        value="<?php echo $perticuller['particular']; ?>">
                    </td>
                    <td><?php echo $i; ?></td>
          ...
          <div id="particular_list_dental_id" style="<?php echo $specialization_val; ?>">
            ...
            <table class="table table-bordered table-striped opd_billing_table" id="particular_list_dental">
              <thead class="bg-theme">
                <tr>
                  <th align="center" width="">
                    <input name="selectall_dental" class="" id="selectall_dental" value="" type="checkbox"
                      onclick="toggle_dental(this);"><?php echo $check_script = "<script>$('#selectAll').on('click', function () { 
                                if ($(this).hasClass('allChecked')) {
                                    $('.checklist').prop('checked', false);
                                } else {
                                    $('.checklist').prop('checked', true);
              ...
              if (!empty($perticuller_list_dental) && (isset($perticuller_list_dental))) {
                ...
                foreach ($perticuller_list_dental as $perticuller_dental) {
                  ...
                  <tr>
                    <td>
                      <input type="checkbox" class="part_checkbox_dental booked_checkbox_dental" name="particular_id[]"
                        value="<?php echo $perticuller_dental['particular']; ?>">
                    </td>
                    <td><?php echo $i; ?></td>
...
--> <?php //else: ?>
              ...
              <select name="payment_mode" class="m_input_default" onChange="payment_function(this.value,'');">
                <?php foreach ($payment_mode as $payment_mode) { ?>
                  <option value="<?php echo $payment_mode->id; ?>" <?php if ($form_data['payment_mode'] == $payment_mode->id) {
                    ...
                    <?php echo $payment_mode->payment_mode; ?></option>
                <?php } ?>
            ...
            <?php if (!empty($form_data['field_name'])) {
              foreach ($form_data['field_name'] as $field_names) {
                ...
                <div class="row m-b-5" id="branch">
                  ...
                  <div class="col-xs-8">
                    <input type="text" name="field_name[]" class="m_input_default"
    ...
    <div class="col-xs-8">
        <input type="text"  name="kit_amount" id="kit_amount" class="price_float m_input_default" onblur="update_kit_amount(this.value);" value="<?php echo number_format($form_data['kit_amount'], 2, '.', ''); ?>">
          ...
          <?php //else: ?>
          <input type="hidden" name="kit_amount" class="m_input_default" id="kit_amount" value="0" />
          <?php //endif; ?>
          <div class="row m-b-5">
            <div class="col-xs-4">
            ...
            <div class="col-xs-8">
              <input type="text" readonly="" class="price_float m_input_default" name="particulars_charges"
                id="particulars_charges"
                value="<?php if (!empty($opd_particular_payment['particulars_charges'])) {
                  echo number_format($opd_particular_payment['particulars_charges'], 2, '.', '');
                } else {
                  echo number_format($form_data['particulars_charges'], 2, '.', '');
                } ?>">
            </div>
          </div> <!-- row -->
          ...
          <div class="row m-b-5">
            ...
            <div class="col-xs-8">
              <input type="text" readonly="" class="price_float m_input_default" name="total_amount" id="total_amount"
                value="<?php if (!empty($opd_particular_payment['total_amount'])) {
                  echo number_format($opd_particular_payment['total_amount'], 2, '.', '');
                } else {
                  echo number_format($form_data['total_amount'], 2, '.', '');
                } ?>">
            </div>
          </div> <!-- row -->
          <?php
          ...
          if ($discount_val_setting == 1) {
            ...
            <div class="row m-b-5">
              ...
              <div class="col-xs-8">
                <input type="text" name="discount" class="price_float m_input_default"
                  onkeyup="check_paid_amount();discount_vals();" id="discount"
                  value="<?php if (!empty($opd_particular_payment['discount'])) {
                    echo $opd_particular_payment['discount'];
                  } else {
          ...
          <div class="row m-b-5">
            ...
            <div class="col-xs-8">
              <input type="text" readonly="" class="price_float m_input_default" name="net_amount" id="net_amount"
                value="<?php if (!empty($opd_particular_payment['net_amount'])) {
                  echo number_format($opd_particular_payment['net_amount'], 2, '.', '');
                } else {
                  echo number_format($form_data['net_amount'], 2, '.', '');
                } ?>">
            </div>
          </div> <!-- row -->
          ...
          <div class="row m-b-5">
            ...
            <div class="col-xs-8">
              <input type="text" name="paid_amount" class="price_float m_input_default" id="paid_amount"
                value="<?php if (!empty($opd_particular_payment['paid_amount'])) {
          ...
          <div class="row m-b-5">
            ...
            <div class="col-xs-8">
              ...
              <button class="btn-update" type="button"
                onclick="window.location.href='<?php echo base_url('opd_billing'); ?>'">
  ...
  <div id="load_add_particular_modal_popup" class="modal fade" role="dialog" data-backdrop="static"
    data-keyboard="false"></div>
...
<div id="load_add_disease_modal_popup" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
</div><!-- container-fluid -->
  ...
  <div class="modal-content">
    ...
    <div class="modal-footer">
      <a data-dismiss="modal" class="btn-anchor"
        onClick="return print_window_page('<?php echo base_url("opd_billing/print_billing_report"); ?>');">Print</a>
