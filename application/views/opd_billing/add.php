    ...
    <div class="col-xs-8">
        <input type="text"  name="kit_amount" id="kit_amount" class="price_float m_input_default" onblur="update_kit_amount(this.value);" value="<?php echo number_format($form_data['kit_amount'], 2, '.', ''); ?>">
            ...
            <div class="row m-b-5">
              ...
              <div class="col-xs-8">
                <input type="text" readonly="" class="price_float m_input_default" name="particulars_charges"
                  id="particulars_charges" value="<?php if (!empty($opd_particular_payment['particulars_charges'])) {
              ...
              <div class="row m-b-5">
                ...
                <div class="col-xs-8">
                  <input type="text" name="discount" class="price_float m_input_default"
                    onkeyup="check_paid_amount();discount_vals();" id="discount" value="<?php if (!empty($opd_particular_payment['discount'])) {
            ...
            <div class="row m-b-5">
              ...
              <div class="col-xs-8">
                <input type="text" name="paid_amount" class="price_float m_input_default" id="paid_amount" value="<?php if (!empty($opd_particular_payment['paid_amount'])) {
