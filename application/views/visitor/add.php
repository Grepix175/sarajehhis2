      ...
      <form id="patient_form" name="ptaient_form" action="<?php echo current_url(); ?>" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" name="patient_code" id="patient_code" value="<?php echo $form_data['patient_code']; ?>" />
            ...
            <div class="grp">
              ...
              <div class="box-right">
                <input type="text" name="from" id="form" class="from" maxlength="255" value="<?php echo $form_data['from']; ?>" />
                <?php
                if (!empty($form_error)) {
        ...
        <div class="box-right" id="gender">
            ...
            <div class="grp">
              ...
              <div class="box-right">
                <input type="text" name="purpose" id="purpose" class="purpose" maxlength="255" value="<?php echo $form_data['purpose']; ?>" />
                <?php
                if (!empty($form_error)) {
  ...
  ?>
            ...
            <div class="grp">
              ...
              <div class="box-right">
                ...
                <a href="<?php echo base_url('visitor'); ?>" class="btn-update" style="text-decoration:none!important;color:#FFF;padding:8px 2em;"><i class="fa fa-sign-out"></i> Exit</a>
              </div>
            </div>
