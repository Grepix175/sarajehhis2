  ...
  <div class="navmain">
    <div class="menu">
      ...
      <ul class="ul_01">
        ...
        <li><a href="javascript:void(0)" onclick="comission(<?php echo $users_data['parent_id']; ?>);">Share Details
          </a></li>
        <?php
        }
        ?>
        ...
        <li><a href="<?php echo base_url(); ?>payroll/dashboard_reporting_manager"><span
              class="glyphicon glyphicon-home"></span></a></li>
        <li><a href="<?php echo base_url(); ?>payroll/employee/view_reporting_manager/<?php echo $emp_id ?>"><span
              class="glyphicon glyphicon-th-list"></span>&nbsp;Profile</a></li>

        <li><a href="javascript:void(0);" onclick="ok(1);" id="ok1"><i class="fa fa-list"></i> Service Request<span
              class="caret"></span></a>
          ...
          <span id="menu_2">
            <ul class="child_ul parent_2">
              <li><a>E-mails<span class="caret"></span></a>
                <span id="menu_2">
                  <ul class="child_ul parent_2">
                    <li><a href="<?php echo base_url(); ?>payroll/employee/mail_reporting/<?php echo $emp_id ?>"
                        ;>E-Mail
                        Application Form</a></li>

                    <li><a
                        href="<?php echo base_url() . 'payroll/employee/mail_application_list_emp_reporting/' . $emp_id; ?>"
                        id="aa1">E-Mail Application List</a></li>
                  </ul>
                </span>
              </li>
              <li><a>Leaves<span class="caret"></a>
                <span id="menu_2">
                  <ul class="child_ul parent_2">
                    <li><a
                        href="<?php echo base_url(); ?>payroll/employee/leave_application_reporting_manager/<?php echo $emp_id ?>"
                        ;>Leaves Application Form</a></li>

                    <li><a
                        href="<?php echo base_url(); ?>payroll/dashboard_reporting_manager/leave_application_list/<?php echo $emp_id ?>"
                        id="aa1">Leaves Application List</a></li>
                  </ul>
                </span>
              </li>
        ...
        <li><a href="javascript:void(0);" onclick="ok(1);" id="ok1"><i class="fa fa-file-text-o"></i> Appraisal<span
              class="caret"></span></a>
          ...
          <span id="menu_2">
            <ul class="child_ul parent_2">
              ...
              <li><a
                  href="<?php echo base_url(); ?>payroll/dashboard_reporting_manager/appraisel_form_rm/<?php echo $emp_id ?>"
                  id="aa1">Performance Review Form</a>

              </li>
              <li><a
                  href="<?php echo base_url(); ?>payroll/dashboard_reporting_manager/probation_form_rm/<?php echo $emp_id ?>"
                  id="aa1">Probation Form</a>
        ...
        <li><a href="javascript:void(0);" onclick="ok(1);" id="ok1"><i class="fa fa-envelope"></i> Recruitment<span
              class="caret"></span></a>

          <span id="menu_2">
            <ul class="child_ul parent_2">
              <li><a href="<?php echo base_url(); ?>payroll/referral/index/<?php echo $emp_id ?>" ;>Openings</a></li>
              <li><a href="<?php echo base_url(); ?>payroll/new_candidate_for_rm/index/<?php echo $emp_id ?>"
                  id="aa1">Interview</a>
        ...
        <li><a href="javascript:void(0);" onclick="ok(1);" id="ok1"><i class="fa fa-users"></i> Team<span
              class="caret"></span></a>
          ...
          <span id="menu_2">
            <ul class="child_ul parent_2">
              ...
              <li><a
                  href="<?php echo base_url(); ?>payroll/dashboard_reporting_manager/employee_list/<?php echo $emp_id ?>"
                  id="aa1">Employee List</a>

              </li>

              <li><a
                  href="<?php echo base_url(); ?>payroll/dashboard_reporting_manager/attendance_list/<?php echo $emp_id ?>"
                  ;>Attendance List</a></li>

              <li><a
                  href="<?php echo base_url(); ?>payroll/dashboard_reporting_manager/roster_list/<?php echo $emp_id ?>">Roster
                  List</a></li>

              <li><a
                  href="<?php echo base_url(); ?>payroll/dashboard_reporting_manager/leave_details/<?php echo $emp_id ?>">
                  Leave Details</a></li>


              <li><a
                  href="<?php echo base_url(); ?>payroll/dashboard_reporting_manager/appraisel_form/<?php echo $emp_id ?>">Performance
                  Review Form</a></li>
              <li><a
                  href="<?php echo base_url(); ?>payroll/dashboard_reporting_manager/probation_form/<?php echo $emp_id ?>">Probation
                  Form</a></li>
        ...
        <li><a href="<?php echo base_url(); ?>payroll/dashboard_employee"><span
              class="glyphicon glyphicon-home"></span></a></li>

        <li><a href="<?php echo base_url(); ?>payroll/employee/view/<?php echo $emp_id ?>"><span
              class="glyphicon glyphicon-th-list"></span>&nbsp;Profile</a></li>
        ...
        <li><a href="javascript:void(0);" onclick="ok(1);" id="ok1"><i class="fa fa-list"></i> Service Request<span
          ...
          <!--<ul class="ul2">-->
                <span id="menu_2">
                  <ul class="child_ul parent_2">
                    <li><a href="javascript:void(0);">E-Mails </a>
                      <span id="menu_2">
                        <ul class="child_ul parent_2">
                          <li><a href="<?php echo base_url(); ?>payroll/employee/mail/<?php echo $emp_id ?>" ;>E-Mail
                              Application Form</a></li>

                          <li><a href="<?php echo base_url() . 'payroll/employee/mail_application_list_emp/' . $emp_id; ?>"
                              id="aa1">E-Mail Application List</a>
                    ...
                    <li><a href="javascript:void(0);">Leaves </a>
                      <span id="menu_2">
                        <ul class="child_ul parent_2">
                          ...
                          <li><a href="<?php echo base_url(); ?>payroll/employee/leave_application/<?php echo $emp_id ?>"
                              ;>Leaves Application Form</a></li>

                          <li><a href="<?php echo base_url() . 'payroll/employee/leave_application_list_emp/' . $emp_id; ?>"
                              id="aa1">Leaves Application List</a>
            ...
            <li><a href="javascript:void(0);" onclick="ok(1);" id="ok1"><i class="fa fa-file-text"></i> Appraisal<span
                  class="caret"></span></a>

              <span id="menu_2">
                <ul class="child_ul parent_2">
                  <li><a href="<?php echo base_url(); ?>payroll/employee_appraisel_form/appraisel_form/<?php echo $emp_id ?>"
                      ;>Performance Review Form</a></li>
                  <li><a href="<?php echo base_url(); ?>payroll/employee_probation_form/probation_form/<?php echo $emp_id ?>"
                      ;>Probation Form</a></li>
            ...
            <li><a href="javascript:void(0);" onclick="ok(1);" id="ok1"><i class="fa fa-user"></i> Openings<span
                  class="caret"></span></a>
                ...
                <span id="menu_2">
                  <ul class="child_ul parent_2">
                    <li><a>E-mails<span class="caret"></span></a>
                      <span id="menu_2">
                        <ul class="child_ul parent_2">
                          <li><a href="<?php echo base_url(); ?>payroll/employee/mail_reporting/<?php echo $emp_id ?>" ;>E-Mail
                              Application Form</a></li>
                ...
                <?php if ($users_data['users_role'] == '2') { ?>
                  <li onclick="$('.allul-child').slideToggle();"><i class="fa fa-caret-right"></i><a>Settings</a>
                    <ul class="allul-child">
                      ...
                      <li><a href="<?php echo base_url('company_settings'); ?>"><i class="fa fa-angle-right"></i> Company
                          Setting</a></li>
                      <li><a href="javascript:void(0)" id="default_search_setting"><i class="fa fa-angle-right"></i> Default
                          Search Setting</a></li>
                      <?php if (in_array('85', $permission_section) || in_array('121', $permission_section)) { ?>
                        <li><a href="javascript:void(0)" id="opd_print_setting"><i class="fa fa-angle-right"></i> OPD Print
                            Setting</a></li>
                        <?php
                      }
                      if (in_array('150', $permission_section)) {
                        ?>
                        <li><a href="<?php echo base_url("website_setting"); ?>"><i class="fa fa-angle-right"></i> Config
                            Setting</a></li>
                        <?php
                      }
                      ...
                      if (in_array('150', $permission_section)) {
                        ?>
                        <li><a href="<?php echo base_url("address_print_setting"); ?>"><i class="fa fa-angle-right"></i>
                            Address Print Setting</a></li>

                        <li><a href="<?php echo base_url("time_print_setting"); ?>"><i class="fa fa-angle-right"></i> Print
                            Time Setting</a></li>
                      ...
                      if (in_array('218', $permission_section)) {
                        ?>
                        <li><a href="<?php echo base_url("receipt_no_setting"); ?>"><i class="fa fa-angle-right"></i> Receipt
                            No. Setting</a></li>
                        <?php
                      }
                      if (in_array('85', $permission_section) || in_array('121', $permission_section)) {
                        ?>
                        <li><a href="<?php echo base_url("mlc_no_setting"); ?>"><i class="fa fa-angle-right"></i> MLC No.
                            Setting</a></li>

                        <li><a href="<?php echo base_url("default_doc_setting"); ?>"><i class="fa fa-angle-right"></i> OPD
                            Default Doctor</a></li>

                        <?php
                      }
                      if (in_array('145', $permission_section)) { ?>
                        <li><a href="<?php echo base_url("default_path_doc_setting"); ?>"><i
                              class="fa fa-angle-right"></i>Pathology Default Doctor</a></li>
                      <?php }
                      if (in_array('165', $permission_section) || in_array('60', $permission_section)) { ?>
                        <li><a href="javascript:void(0)" id="inventory_discount_setting"><i class="fa fa-angle-right"></i>
                            Discount Setting</a></li>
                      <?php }
                      if (in_array('60', $permission_section)) { ?>
                        <li><a href="javascript:void(0)" id="medicine_gst_setting"><i class="fa fa-angle-right"></i> Medicine
                            Sale GST Setting</a></li>
                      <?php }
                      if (in_array('60', $permission_section)) { ?>
                        <li><a href="javascript:void(0)" id="medicine_order_setting"><i class="fa fa-angle-right"></i>
                            Medicine Sale Order Setting</a></li>
                      <?php } ?>

                      <li><a href="javascript:void(0)" id="commission_setting"><i class="fa fa-angle-right"></i> Commission
                          Setting</a></li>

                    </ul>
                  </li>
                <?php } ?>
                <li><i class="fa fa-caret-right"></i><a href="javascript:void(0)" id="change_password">Change Password</a>
                </li>
...
<script>
  function sub_menu(id) {
    ...
    $.ajax({
      url: "<?php echo base_url(); ?>general/branch_menu/" + id,
