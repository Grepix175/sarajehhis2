                        ...
                        <div class="row">
                            <div class="col-xs-5">
                                ...
                                <div class="row m-b-5">
                                        ...
                                        <div class="col-xs-8">
                                            <input type="text" name="booking_code" value="<?php echo isset($booking_data['token_no']) ? $booking_data['token_no'] : 'N/A'; ?>" readonly="" style="width:100% !important;height:25px;background:#f8f8f8;font-size:13px;padding:2px;">
                                        </div>
                                    </div>
                            </div>
                            <div class="col-xs-5">
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    showAlert(
                        ...
                        "<?php echo base_url('contact_lens'); ?>" // URL for redirection
                    );
                } 
                 else {
