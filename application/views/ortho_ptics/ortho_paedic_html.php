 ...
 <?php
   if(!empty($data_list))
   {
        ...
        if ($age_d > 0) {
   	   ...
   	   ?>
   	    <tr>
          <td><?php echo $ortho_paedic->token; ?></td>
          <td><?php echo $ortho_paedic->booking_id; ?></td>
          ...
          echo ($last_status); ?></td>
          <!-- <td><?php echo $ortho_paedic->created; ?></td> -->
          <td><?php echo date('d-m-Y h:i A', strtotime($ortho_paedic->created)); ?></td>
          </tr>
   	   <?php
   	   $i++;	
   	 }	
