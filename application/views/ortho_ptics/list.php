  ...
  <script type="text/javascript">
    ...
    <?php if (in_array('2485', $users_data['permission']['action'])) { ?>
      $(document).ready(function () {
        table = $('#table').DataTable({
            ...
            "pageLength": '20',
            "ajax": {
                "url": "<?php echo base_url('ortho_ptics/ajax_list') ?>",
                "type": "POST",
            },
            "columnDefs": [
                {
    ...
    $(document).ready(function () {
      ...
      $('#adv_search').on('click', function () {
        $modal.load('<?php echo base_url() . 'ortho_ptics/advance_search/' ?>',
          {
          },
          function () {
            $modal.modal('show');
    ...
    function edit_refraction(id) {
      ...
      window.location.href = '<?php echo base_url('ortho_ptics/edit/'); ?>' + id;
    }
      ...
      if (allVals != "") {
        $('#confirm').modal({
          ...
          .one('click', '#delete', function (e) {
            $.ajax({
              type: "POST",
              url: "<?php echo base_url('ortho_ptics/deleteall'); ?>",
              data: { row_id: allVals },
  ...
  <a href="javascript:void(0)" class="btn-a-search" id="patient_adv_search">
        ...
        <div class="btns">
          <?php if (in_array('2486', $users_data['permission']['action'])) { ?>
            <!-- <button class="btn-update" id="1modal_add"
                onclick="window.location.href='<?php echo base_url('ortho_ptics/add'); ?>'">
          ...
          <a data-toggle="tooltip" title="Download list in pdf" href="#" id="ortho_paedic_pdf"
            class="btn-anchor m-b-2">
    ...
    <script>
      ...
      document.getElementById('ortho_peadics_excel').addEventListener('click', function (e) {
        ...
        var url = '<?php echo base_url("ortho_ptics/ortho_peadics_excel"); ?>';
      ...
      document.getElementById('ortho_paedic_pdf').addEventListener('click', function (e) {
        ...
        var url = '<?php echo base_url("ortho_ptics/ortho_paedic_pdf"); ?>';
