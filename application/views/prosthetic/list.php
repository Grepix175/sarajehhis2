  ...
  <script type="text/javascript">
    ...
    <?php if (in_array('2485', $users_data['permission']['action'])) { ?>
      $(document).ready(function () {
        table = $('#table').DataTable({
          ...
          "pageLength": '20',
          "ajax": {
            "url": "<?php echo base_url('prosthetic/ajax_list') ?>",
            "type": "POST",
          },
          "columnDefs": [
            {
    ...
    $(document).ready(function () {
      ...
      $('#adv_search').on('click', function () {
        $modal.load('<?php echo base_url() . 'prosthetic/advance_search/' ?>',
          {
          },
          function () {
            $modal.modal('show');
    ...
    function edit_refraction(id) {
      ...
      window.location.href = '<?php echo base_url('prosthetic/edit/'); ?>' + id;
    }
      ...
      if (allVals != "") {
        $('#confirm').modal({
          ...
          .one('click', '#delete', function (e) {
            $.ajax({
              type: "POST",
              url: "<?php echo base_url('prosthetic/deleteall'); ?>",
              data: { row_id: allVals },
...
<br>
  <a href="javascript:void(0)" class="btn-a-search" id="patient_adv_search">
        ...
        <div class="btns">
          <?php if (in_array('2486', $users_data['permission']['action'])) { ?>
            <!-- <button class="btn-update" id="1modal_add"
                onclick="window.location.href='<?php echo base_url('prosthetic/add'); ?>'">
              <i class="fa fa-plus"></i> New
            </button> -->
          <?php } ?>
          <a data-toggle="tooltip" title="Download list in excel" href="#" id="prosthetic_excel"
            class="btn-anchor m-b-2">
            <i class="fa fa-file-excel-o"></i> Excel
          </a>
          <a data-toggle="tooltip" title="Download list in pdf" href="#" id="prosthetic_pdf" class="btn-anchor m-b-2">
    ...
    <script>
      ...
      document.getElementById('prosthetic_excel').addEventListener('click', function (e) {
        e.preventDefault();
        ...
        var url = '<?php echo base_url("prosthetic/prosthetic_excel"); ?>';
      ...
      document.getElementById('prosthetic_pdf').addEventListener('click', function (e) {
        // alert();
        e.preventDefault();
        ...
        var url = '<?php echo base_url("prosthetic/prosthetic_pdf"); ?>';
