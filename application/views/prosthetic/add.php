                ...
                <div class="row">
                        ...
                        <div class="row m-b-5">
                            ...
                            <div class="col-xs-8">
                                <input type="text" name="patient_name"
                                    value="<?php echo isset($booking_data['patient_name']) ? $booking_data['patient_name'] : ''; ?>"
                                    readonly=""
                        ...
                        <div class="row m-b-5">
                            ...
                            <div class="col-xs-8">
                                <input type="text" name="patient_code"
                                    value="<?php echo isset($booking_data['patient_code']) ? $booking_data['patient_code'] : ''; ?>"
                                    readonly=""
                                    style="width:100% !important;height:25px;background:#f8f8f8;font-size:13px;padding:2px;">
                            </div>
                        </div>
                        <div class="row m-b-5">
                            ...
                            <div class="col-xs-8">
                                <input type="text" name="booking_code"
                                    value="<?php echo isset($booking_data['booking_code']) ? $booking_data['booking_code'] : ''; ?>"
                                    readonly=""
                                    style="width:100% !important;height:25px;background:#f8f8f8;font-size:13px;padding:2px;">
                            </div>
                        ...
                        <div class="row m-b-5">
                            ...
                            <div class="col-xs-8">
                                <input type="text" name="token_no"
                                    value="<?php echo isset($booking_data['token_no']) ? $booking_data['token_no'] : ''; ?>"
                                    readonly=""
                                    style="width:100% !important;height:25px;background:#f8f8f8;font-size:13px;padding:2px;">
                            </div>
                        </div>
                    ...
                    <div class="col-xs-5">
                        <div class="row m-b-5">
                            ...
                            <div class="col-xs-8">
                                <input type="text" name="mobile_no"
                                    value="<?php echo isset($booking_data['mobile_no']) ? $booking_data['mobile_no'] : ''; ?>"
                                    readonly=""
                                    style="width:100% !important;height:25px;background:#f8f8f8;font-size:13px;padding:2px;">
                            </div>
                        </div>
                        <div class="row m-b-5">
                            ...
                            <div class="col-xs-8">
                                <input type="text" name="mobile_no" value="<?php echo isset($age) ? $age : ''; ?>"
                                    readonly=""
                                    style="width:100% !important;height:25px;background:#f8f8f8;font-size:13px;padding:2px;">
                            </div>
                        </div>
                ...
                <section class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="grp" style="">
                            <label>Date </label>
                            <div class="box-right">
                                <input type="text" disabled name="date" class="txt_firstCap input-height" id="date"
                                    value="<?php echo isset($form_data['date']) ? htmlspecialchars($form_data['date']) : date('Y-m-d'); ?>"
                                    style="width: 374px;" />
                        ...
                        <div class="grp" style="">
                            <label>Time </label>
                            <div class="box-right">
                                <input type="text" disabled name="time" class="txt_firstCap input-height" id="time"
                                    value="<?php echo isset($form_data['time']) ? htmlspecialchars($form_data['time']) : date('H:i:s'); ?>"
                                    style="width: 374px;" />
                        ...
                        <div class="grp" style="">
                            ...
                            <div class="box-right">
                                <input type="text" name="indication" class="txt_firstCap input-height" id="indication"
                                    value="<?php echo isset($form_data['indication']) ? htmlspecialchars($form_data['indication']) : ''; ?>"
                                    style="width: 374px;" />
                        ...
                        <div class="grp" style="">
                            ...
                            <div class="box-right">
                                <input type="text" name="anterior_segment_evaluation" class="txt_firstCap input-height"
                                    id="ANTERIOR SEGMENT EVALUATION"
                                    value="<?php echo isset($form_data['anterior_segment_evaluation']) ? htmlspecialchars($form_data['anterior_segment_evaluation']) : ''; ?>"
                                    style="width: 374px;" />
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="text"
                                                    value="<?php echo isset($form_data['spectacle_power_od']) ? htmlspecialchars($form_data['spectacle_power_od']) : ''; ?>"
                                                    name="spectacle_power_od" id="spectacle_power_od"
                                                    class="w-50px auto_fer2"></td>
                                            <td><input type="text"
                                                    value="<?php echo isset($form_data['spectacle_power_os']) ? htmlspecialchars($form_data['spectacle_power_os']) : ''; ?>"
                                                    name="spectacle_power_os" id="spectacle_power_os"
                                                    class="w-50px auto_fer2"></td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:left;">KERATOMETRY</td>
                                            <td><input type="text"
                                                    value="<?php echo isset($form_data['keratometry_od']) ? htmlspecialchars($form_data['keratometry_od']) : ''; ?>"
                                                    name="keratometry_od" id="keratometry_od" class="w-50px auto_fer2">
                                            </td>
                                            <td><input type="text"
                                                    value="<?php echo isset($form_data['keratometry_os']) ? htmlspecialchars($form_data['keratometry_os']) : ''; ?>"
                                                    name="keratometry_os" id="keratometry_os" class="w-50px auto_fer2">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:left;">HVID</td>
                                            <td><input type="text"
                                                    value="<?php echo isset($form_data['hvid_od']) ? htmlspecialchars($form_data['hvid_od']) : ''; ?>"
                                                    name="hvid_od" id="hvid_od" class="w-50px auto_fer2"></td>
                                            <td><input type="text"
                                                    value="<?php echo isset($form_data['hvid_os']) ? htmlspecialchars($form_data['hvid_os']) : ''; ?>"
                                                    name="hvid_os" id="hvid_os" class="w-50px auto_fer2"></td>
                                        </tr>
                        ...
                        <div class="row">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control"
                                                    name="contact_lens_trial_table[bc_od]"
                                                    value="<?= isset($form_data['contact_lens_trial_table']['bc_od']) ? $form_data['contact_lens_trial_table']['bc_od'] : ''; ?>">
                                            </td>
                                            <td><input type="text" class="form-control"
                                                    name="contact_lens_trial_table[dia_od]"
                                                    value="<?= isset($form_data['contact_lens_trial_table']['dia_od']) ? $form_data['contact_lens_trial_table']['dia_od'] : ''; ?>">
                                            </td>
                                            <td><input type="text" class="form-control"
                                                    name="contact_lens_trial_table[power_od]"
                                                    value="<?= isset($form_data['contact_lens_trial_table']['power_od']) ? $form_data['contact_lens_trial_table']['power_od'] : ''; ?>">
                                            </td>
                                            <td><input type="text" class="form-control"
                                                    name="contact_lens_trial_table[vn_od]"
                                                    value="<?= isset($form_data['contact_lens_trial_table']['vn_od']) ? $form_data['contact_lens_trial_table']['vn_od'] : ''; ?>">
                                            </td>
                                            <td><input type="text" class="form-control"
                                                    name="contact_lens_trial_table[remarks_od]"
                                                    value="<?= isset($form_data['contact_lens_trial_table']['remarks_od']) ? $form_data['contact_lens_trial_table']['remarks_od'] : ''; ?>">
                                            </td>
                                            <td><input type="text" class="form-control"
                                                    name="contact_lens_trial_table[rx_od]"
                                                    value="<?= isset($form_data['contact_lens_trial_table']['rx_od']) ? $form_data['contact_lens_trial_table']['rx_od'] : ''; ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>OD OS</td>
                                            <td><input type="text" class="form-control"
                                                    name="contact_lens_trial_table[bc_os]"
                                                    value="<?= isset($form_data['contact_lens_trial_table']['bc_os']) ? $form_data['contact_lens_trial_table']['bc_os'] : ''; ?>">
                                            </td>
                                            <td><input type="text" class="form-control"
                                                    name="contact_lens_trial_table[dia_os]"
                                                    value="<?= isset($form_data['contact_lens_trial_table']['dia_os']) ? $form_data['contact_lens_trial_table']['dia_os'] : ''; ?>">
                                            </td>
                                            <td><input type="text" class="form-control"
                                                    name="contact_lens_trial_table[power_os]"
                                                    value="<?= isset($form_data['contact_lens_trial_table']['power_os']) ? $form_data['contact_lens_trial_table']['power_os'] : ''; ?>">
                                            </td>
                                            <td><input type="text" class="form-control"
                                                    name="contact_lens_trial_table[vn_os]"
                                                    value="<?= isset($form_data['contact_lens_trial_table']['vn_os']) ? $form_data['contact_lens_trial_table']['vn_os'] : ''; ?>">
                                            </td>
                                            <td><input type="text" class="form-control"
                                                    name="contact_lens_trial_table[remarks_os]"
                                                    value="<?= isset($form_data['contact_lens_trial_table']['remarks_os']) ? $form_data['contact_lens_trial_table']['remarks_os'] : ''; ?>">
                                            </td>
                                            <td><input type="text" class="form-control"
                                                    name="contact_lens_trial_table[rx_os]"
                                                    value="<?= isset($form_data['contact_lens_trial_table']['rx_os']) ? $form_data['contact_lens_trial_table']['rx_os'] : ''; ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>OD OS</td>
                                            <td><input type="text" class="form-control"
                                                    name="contact_lens_trial_table[bc_os2]"
                                                    value="<?= isset($form_data['contact_lens_trial_table']['bc_os2']) ? $form_data['contact_lens_trial_table']['bc_os2'] : ''; ?>">
                                            </td>
                                            <td><input type="text" class="form-control"
                                                    name="contact_lens_trial_table[dia_os2]"
                                                    value="<?= isset($form_data['contact_lens_trial_table']['dia_os2']) ? $form_data['contact_lens_trial_table']['dia_os2'] : ''; ?>">
                                            </td>
                                            <td><input type="text" class="form-control"
                                                    name="contact_lens_trial_table[power_os2]"
                                                    value="<?= isset($form_data['contact_lens_trial_table']['power_os2']) ? $form_data['contact_lens_trial_table']['power_os2'] : ''; ?>">
                                            </td>
                                            <td><input type="text" class="form-control"
                                                    name="contact_lens_trial_table[vn_os2]"
                                                    value="<?= isset($form_data['contact_lens_trial_table']['vn_os2']) ? $form_data['contact_lens_trial_table']['vn_os2'] : ''; ?>">
                                            </td>
                                            <td><input type="text" class="form-control"
                                                    name="contact_lens_trial_table[remarks_o2]"
                                                    value="<?= isset($form_data['contact_lens_trial_table']['remarks_o2']) ? $form_data['contact_lens_trial_table']['remarks_o2'] : ''; ?>">
                                            </td>
                                            <td><input type="text" class="form-control"
                                                    name="contact_lens_trial_table[rx_os2]"
                                                    value="<?= isset($form_data['contact_lens_trial_table']['rx_os2']) ? $form_data['contact_lens_trial_table']['rx_os2'] : ''; ?>">
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <div class="grp" style="padding:15px;">
                                ...
                                <div class="box-right">
                                    <select class="txt_firstCap input-height form-control" id="trial_given"
                                        name="trial_given" style="width: 374px;">
                            ...
                            <div class="col-md-12">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>OD</td>
                                            <td><input type="text" class="form-control" name="final_order_table[bc_od]"
                                                    value="<?php echo isset($form_data['final_order_table']['bc_od']) ? $form_data['final_order_table']['bc_od'] : ''; ?>"
                                                    placeholder="OD"></td>
                                            <td><input type="text" class="form-control" name="final_order_table[dia_od]"
                                                    value="<?php echo isset($form_data['final_order_table']['dia_od']) ? $form_data['final_order_table']['dia_od'] : ''; ?>"
                                                    placeholder="OD"></td>
                                            <td><input type="text" class="form-control"
                                                    name="final_order_table[power_od]"
                                                    value="<?php echo isset($form_data['final_order_table']['power_od']) ? $form_data['final_order_table']['power_od'] : ''; ?>"
                                                    placeholder="OD"></td>
                                            <td><input type="text" class="form-control"
                                                    name="final_order_table[tint_od]"
                                                    value="<?php echo isset($form_data['final_order_table']['tint_od']) ? $form_data['final_order_table']['tint_od'] : ''; ?>"
                                                    placeholder="OD"></td>
                                            <td><input type="text" class="form-control"
                                                    name="final_order_table[material_od]"
                                                    value="<?php echo isset($form_data['final_order_table']['material_od']) ? $form_data['final_order_table']['material_od'] : ''; ?>"
                                                    placeholder="OD"></td>
                                            <td><input type="text" class="form-control"
                                                    name="final_order_table[company_od]"
                                                    value="<?php echo isset($form_data['final_order_table']['company_od']) ? $form_data['final_order_table']['company_od'] : ''; ?>"
                                                    placeholder="OD"></td>
                                        </tr>
                                        <tr>
                                            <td>OS</td>
                                            <td><input type="text" class="form-control" name="final_order_table[bc_os]"
                                                    value="<?php echo isset($form_data['final_order_table']['bc_os']) ? $form_data['final_order_table']['bc_os'] : ''; ?>"
                                                    placeholder="OS"></td>
                                            <td><input type="text" class="form-control" name="final_order_table[dia_os]"
                                                    value="<?php echo isset($form_data['final_order_table']['dia_os']) ? $form_data['final_order_table']['dia_os'] : ''; ?>"
                                                    placeholder="OS"></td>
                                            <td><input type="text" class="form-control"
                                                    name="final_order_table[power_os]"
                                                    value="<?php echo isset($form_data['final_order_table']['power_os']) ? $form_data['final_order_table']['power_os'] : ''; ?>"
                                                    placeholder="OS"></td>
                                            <td><input type="text" class="form-control"
                                                    name="final_order_table[tint_os]"
                                                    value="<?php echo isset($form_data['final_order_table']['tint_os']) ? $form_data['final_order_table']['tint_os'] : ''; ?>"
                                                    placeholder="OS"></td>
                                            <td><input type="text" class="form-control"
                                                    name="final_order_table[material_os]"
                                                    value="<?php echo isset($form_data['final_order_table']['material_os']) ? $form_data['final_order_table']['material_os'] : ''; ?>"
                                                    placeholder="OS"></td>
                                            <td><input type="text" class="form-control"
                                                    name="final_order_table[company_os]"
                                                    value="<?php echo isset($form_data['final_order_table']['company_os']) ? $form_data['final_order_table']['company_os'] : ''; ?>"
                                                    placeholder="OS"></td>
                                        </tr>
                                    </tbody>
                                </table>
                        ...
                        value="<?php echo isset($form_data['instruction_given_lens_dispensed_on']) ? $form_data['instruction_given_lens_dispensed_on'] : ''; ?>"> -->
                                <input type="date" class="form-control" id="instruction_given"
                                    name="instruction_given_lens_dispensed_on"
                                    value="<?php echo isset($form_data['instruction_given_lens_dispensed_on']) && !empty($form_data['instruction_given_lens_dispensed_on']) ? $form_data['instruction_given_lens_dispensed_on'] : date('Y-m-d'); ?>">
                                    ...
                                    <td class="small text-center mt-5" style="width: 34%;">
                                        <div class="text-center">
                                            ...
                                            <div class="border-top pt-2 mx-auto"
                                                ...
                                                <input type="text" name="patient_signature" class=""
                                                    style="width: 200px;"
                                                    value="<?= isset($booking_data['patient_name']) ? htmlspecialchars($booking_data['patient_name']) : 'Current Patient Name'; ?>"
                                                    readonly />
                                            </div>
                                        </div>
                                    </td>
