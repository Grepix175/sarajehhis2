      ...
      <form action="<?php echo current_url(); ?>" method="post" id="opd_form">
        ...
        <div class="row">
              ...
              <div class="row m-b-4">
                <div class="col-md-12">
                  <div class="row">
                    ...
                    <div class="col-md-8">
                      <input type="text" name="address_third" id="address_third" class="address" maxlength="255"
          ...
          <div class="col-xs-4 media_margin_left">
              ...
              <div class="col-md-12">
                <div class="row">
                  ...
                  <div class="col-md-7" id="patient_category">
                    <input type="hidden" name="patient_category" value="Corporate"
                    ...
                    <input type="hidden" name="patient_category" value="Subsidy"
                      onclick="update_doctor_panel_charges(); set_tpa1('<?php echo $form_data['patient_category_name']; ?>')"
                      ...
                      <select name="corporate_id" id="corporate_id" class="w-150px m_select_btn">
                        ...
                        if (!empty($corporate_list)) {
                          foreach ($corporate_list as $corporate) {
                            ...
                            echo '<option value="' . $corporate->id . '" ' . $selected_co_id . '>' . $corporate->name . '</option>';
                          }
                        }
                        ?>
                      </select>
              ...
              <div class="row m-b-5">
                <div class="col-md-12">
                  <div class="row">
                    ...
                    <div class="col-md-7">
                      <input type="text" name="emp_no" class="emp_no" id="emp_no"
                        value="<?php echo $form_data['emp_no']; ?>" />
                    </div>
                  </div>
                </div>
              </div> <!-- row -->
                      ...
                      <select name="department_id" id="department_id" class="w-150px m_select_btn">
                        ...
                        if (!empty($department_list)) {
                          foreach ($department_list as $department) {
                            ...
                            echo '<option value="' . $department->id . '" ' . $selected_de_id . '>' . $department->name . '</option>';
                          }
                        }
                        ?>
                      </select>
            ...
            <!-- Subsidy Section -->
            <div id="subsidy_box"
              style="display: <?php echo ($form_data['patient_category_name'] == 'Subsidy') ? 'block' : 'none'; ?>">
...
<?php }*/ ?>
    ...
    <script type="text/javascript">
      ...
      $('#branch_id').change(function () {
        ...
        $.ajax({
          url: "<?php echo base_url(); ?>opd/get_branch_data/" + branch_id,
          success: function (result) {
            load_values(result);
      ...
      function load_simulation_values(branch_id) {
        $.ajax({
          url: "<?php echo base_url(); ?>opd/get_simulation_data/" + branch_id,
          success: function (result) {
      ...
      function load_referral_doctor_values(branch_id) {
        $.ajax({
          url: "<?php echo base_url(); ?>opd/get_referral_doctor_data/" + branch_id,
          success: function (result) {
      ...
      function load_specialization_values(branch_id) {
        $.ajax({
          url: "<?php echo base_url(); ?>opd/get_specialization_data/" + branch_id,
          success: function (result) {
      ...
      function load_attended_doctor_values(branch_id) {
        $.ajax({
          url: "<?php echo base_url(); ?>opd/get_attended_doctor_data/" + branch_id,
          success: function (result) {
            $('#attended_doctor').html(result);
          }
        });
      ...
      function load_source_from_values(branch_id) {
        $.ajax({
          url: "<?php echo base_url(); ?>opd/get_source_from_data/" + branch_id,
          success: function (result) {
      ...
      function load_diseases_values(branch_id) {
        $.ajax({
          url: "<?php echo base_url(); ?>opd/get_diseases_data/" + branch_id,
          success: function (result) {
      ...
      function load_package_values(branch_id) {
        $.ajax({
          url: "<?php echo base_url(); ?>opd/get_package_data/" + branch_id,
          success: function (result) {
