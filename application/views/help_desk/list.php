...
{ 
  ...
  $.ajax({url: "<?php echo base_url(); ?>help_desk/reset_search/", 
    success: function(result)
    { 
      reload_table();
    } 
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <a  data-dismiss="modal" class="btn-anchor"  onClick="return print_window_page('<?php echo base_url("help_desk/print_prescriptions"); ?>');">Print</a>
