	...
	<div class="row">
		<div class="col-lg-12 text-center ">
			<ul class="nav nav-pills eye-tabs">
				<li class="col-lg-3" role="presentation"><a href="#ophthal" data-toggle="tab"
						class="active op">Ophthal</a></li>
				<li class="col-lg-3" role="presentation"><a href="#Laboratory" data-toggle="tab"
						class=" op">Laboratory</a></li>
				<li class="col-lg-3" role="presentation"><a href="#Radiology" data-toggle="tab"
						class=" op">Radiology</a></li>
			</ul>
			<script>
			...
			<div class="tab-content">
					...
					<div class="row text-right">
						...
						<div class="col-lg-3">
							<div style="position:relative;text-align:left;">
								<input class="form-control m-b-4" type="text" name="" id="opthal_search"
									onkeyup="return ophthal_search(this.value);"
									placeholder="Search by any Ophthal Investigations Name"><br>
									...
									<table class="table table-bordered add_opthal_<?php echo $i; ?>">
										<tr>
											<td style="width:unset;text-align:left;">
												<div class="d-block">
													<input type="radio"
														name="investig_name[ophthal][ophthal_set][<?php echo $i; ?>][radio]"
														value="1" class="adv_<?php echo $i; ?> advis"
														onchange="return performed(this.value,'<?php echo $i; ?>');" <?php if ($investigation->radio == 1) { ?> checked <?php } ?>>Advised
												</div>
												<div class="d-block">
													<input type="radio"
														name="investig_name[ophthal][ophthal_set][<?php echo $i; ?>][radio]"
														class="adv_<?php echo $i; ?>" value="2"
														onchange="return performed(this.value,'<?php echo $i; ?>');" <?php if ($investigation->radio == 2) { ?> checked <?php } ?>>
													Performed
												</div>
											</td>
											<td>
												<input type="text"
													name="investig_name[ophthal][ophthal_set][<?php echo $i; ?>][test_name]"
													class="form-control m-b-4" value="<?php echo $investigation->test_name; ?>">
												<input type="hidden"
													name="investig_name[ophthal][ophthal_set][<?php echo $i; ?>][set_id]"
													class="form-control m-b-4" value="<?php echo $investigation->set_id; ?>">
												<div class="<?php if ($investigation->radio == 2) {
													echo 'd-block';
												} else {
													echo 'd-none';
												} ?>"
													id="performed_res<?php echo $i; ?>">
													<div class="small text-bold"> Findings </div><input type="text"
														name="investig_name[ophthal][ophthal_set][<?php echo $i; ?>][performed_res]"
														class="form-control m-b-4 "
														value="<?php echo $investigation->performed_res; ?>">
												</div>

											</td>
											<td>
												<select name="investig_name[ophthal][ophthal_set][<?php echo $i; ?>][eye_side]"
													class="w-50px">
													<option <?php if ($investigation->eye_side == 'B/E') {
														echo "selected";
													} ?>
														value="B/E">B/E</option>
													<option <?php if ($investigation->eye_side == 'R') {
														echo "selected";
													} ?>
														value="R">R</option>
													<option <?php if ($investigation->eye_side == 'L') {
														echo "selected";
													} ?>
														value="L">L</option>
												</select>
											...
											<td>
												<button type="button" class="btn-custom aa_'+count+'"
													onclick="return remove_opthal_test('<?php echo $i; ?>');"><i
														class="fa fa-times"></i>
												</button>
											</td>
										</tr>
									...
									<table class="table table-bordered add_opthal_<?php echo $i; ?>">
										<tr>
											<td valign="top" style="width:unset;text-align:left;">
												<div class="d-block">
													<input type="radio"
														name="investig_name[ophthal][ophthal_test][<?php echo $investigation->test_id; ?>][test_radio]"
														value="1" class="adv_<?php echo $i; ?> advis"
														onchange="return performed(this.value,'<?php echo $i; ?>');" <?php if ($investigation->test_radio == 1) { ?> checked <?php } ?>>Advised
												</div>
												<div class="d-block">
													<input type="radio"
														name="investig_name[ophthal][ophthal_test][<?php echo $investigation->test_id; ?>][test_radio]"
														class="adv_<?php echo $i; ?>" value="2"
														onchange="return performed(this.value,'<?php echo $i; ?>');" <?php if ($investigation->test_radio == 2) { ?> checked <?php } ?>>
													Performed
												</div>
											</td>
											<td valign="top">
												<input type="text"
													name="investig_name[ophthal][ophthal_test][<?php echo $investigation->test_id; ?>][test_name]"
													class="form-control m-b-4" value="<?php echo $investigation->test_name; ?>">
												<input type="hidden"
													name="investig_name[ophthal][ophthal_test][<?php echo $investigation->test_id; ?>][eye_region_id]"
													class="form-control m-b-4"
													value="<?php echo $investigation->eye_region_id; ?>">
												<input type="hidden"
													name="investig_name[ophthal][ophthal_test][<?php echo $investigation->test_id; ?>][test_id]"
													class="form-control m-b-4" value="<?php echo $investigation->test_id; ?> ">
												<div class="<?php if ($investigation->test_radio == 2) {
													echo 'd-block';
												} else {
													echo 'd-none';
												} ?>"
													...
													<input type="text"
														name="investig_name[ophthal][ophthal_test][<?php echo $investigation->test_id; ?>][performed_res]"
														class="form-control m-b-4"
														value="<?php echo $investigation->performed_res; ?>">
												</div>
											...
											<td valign="top">
												<select
													name="investig_name[ophthal][ophthal_test][<?php echo $investigation->test_id; ?>][eye_side]"
													class="w-50px">
													<option <?php if ($investigation->eye_side == 'B/E') {
														echo "selected";
													} ?>
											...
											<td valign="top">
												<button type="button" class="btn-custom aa_<?php echo $i; ?>"
													onclick="return remove_opthal_test('<?php echo $i; ?>');"><i
														class="fa fa-times"></i>
												</button>
											</td>
					...
					<div class="row">
						...
						<div class="col-md-3">
							<ul class="list-unstyled">
								<li class="m-b-5"> <span class="label-icon">C</span> <span>Custom Created ICD</span>
								</li>
				...
				<div role="tabpanel" class="tab-pane" id="Laboratory">
					...
					<div class="row text-right">
						...
						<div class="col-lg-3">
							<div style="position:relative;text-align:left;">
								<input class="form-control" type="text" name="" id="lab_search"
									onkeyup="return lab1_search(this.value);"
									placeholder="Search by any Laboratory Investigations Name">
							...
							<select name="lab_set" id="lab_set" class="form-control" multiple="">
								...
								if (!empty($lab_set)) {
									foreach ($lab_set as $lab) {
										$lab_select = "";
										// Check if the current lab ID matches the form data
										if (!empty($form_data['lab_set']) && $lab->id == $form_data['lab_set']) {
											$lab_select = "selected='selected'";
										}
										// Properly display the lab options
										echo '<option value="' . htmlspecialchars($lab->id, ENT_QUOTES, 'UTF-8') . '" ' . $lab_select . '>' . htmlspecialchars($lab->set_name, ENT_QUOTES, 'UTF-8') . '</option>';
									}
								}
								?>
							</select>
						...
						<div class="col-lg-6" id="lab_append_div">
							...
							if ($laboratory_data['lab_set']) {
								foreach ($laboratory_data['lab_set'] as $investigation) {
									?>
									<table class="table table-bordered add_lab_<?php echo $j; ?>">
										<tr>
											<td style="width:unset;text-align:left;">
												<div class="d-block">
													<input type="radio"
														name="investig_name[lab][lab_set][<?php echo $j; ?>][lab_radio]"
														value="1" class="adv_<?php echo $j; ?> ladvis"
														onchange="return lab_performed(this.value,'<?php echo $j; ?>');" <?php if ($investigation->lab_radio == 1) { ?> checked <?php } ?>>Advised
												</div>
												<div class="d-block">
													<input type="radio"
														name="investig_name[lab][lab_set][<?php echo $j; ?>][lab_radio]"
														class="adv_<?php echo $j; ?>" value="2"
														onchange="return lab_performed(this.value,'<?php echo $j; ?>');" <?php if ($investigation->lab_radio == 2) { ?> checked <?php } ?>>
													Performed
												</div>
											</td>
											<td>
												<input type="text"
													name="investig_name[lab][lab_set][<?php echo $j; ?>][test_name]"
													class="form-control m-b-4" value="<?php echo $investigation->test_name; ?>">
												<div class=" <?php if ($investigation->lab_radio == 2) {
													echo 'd-block';
												} else {
													echo 'd-none';
												} ?>"
													id="lab_performed_res<?php echo $j; ?>">
													<div class="small text-bold"> Findings </div>
													<input type="text"
														name="investig_name[lab][lab_set][<?php echo $j; ?>][lab_performed_res]"
														class="form-control m-b-4"
														value="<?php echo $investigation->lab_performed_res; ?>">
												</div>

												<input type="hidden"
													name="investig_name[lab][lab_set][<?php echo $j; ?>][lab_performed_res]"
													class="<?php if ($investigation->lab_radio == 1) {
														echo 'd-block';
													} else {
														echo 'd-none';
													} ?>">
												...
												<input type="hidden"
													name="investig_name[lab][lab_set][<?php echo $j; ?>][test_id]"
													class="form-control m-b-4" value="<?php echo $investigation->test_id; ?>">
												<input type="hidden"
													name="investig_name[lab][lab_set][<?php echo $j; ?>][lab_test_id]"
													class="form-control m-b-4" value="<?php echo $investigation->lab_set_id; ?>">
											</td>
											<td>
												<button type="button" class="btn-custom aa_<?php echo $j; ?>"
													onclick="return remove_lab_test('<?php echo $j; ?>');"><i
							...
							if (!empty($laboratory_data['lab_test'])) {
								foreach ($laboratory_data['lab_test'] as $investigation) {
									...
									<table class="table table-bordered add_lab_<?php echo $j; ?>">
										<tr>
											<td style="width:unset;text-align:left;">
												<div class="d-block"><input type="radio"
														name="investig_name[lab][lab_test][<?php echo $investigation->lab_test_id; ?>][test_radio]"
														value="1" class="adv_<?php echo $j; ?> ladvis"
														onchange="return lab_performed(this.value,'<?php echo $j; ?>');" <?php if ($investigation->test_radio == 1) { ?> checked <?php } ?>>Advised</div>
												<div class="d-block"><input type="radio"
														name="investig_name[lab][lab_test][<?php echo $investigation->lab_test_id; ?>][test_radio]"
														class="adv_<?php echo $j; ?>" value="2"
														onchange="return lab_performed(this.value,'<?php echo $j; ?>');" <?php if ($investigation->test_radio == 2) { ?> checked <?php } ?>>Performed</div>
											</td>
											<td><input type="text"
													name="investig_name[lab][lab_test][<?php echo $investigation->lab_test_id; ?>][investig_name]"
													id="investig_name" class="form-control m-b-4"
													value="<?php echo $investigation->investig_name; ?>">
												...
												<div class="<?php if ($investigation->test_radio == 2) {
													...
													<div class="small text-bold"> Findings </div>
													<input type="text"
														name="investig_name[lab][lab_test][<?php echo $investigation->lab_test_id; ?>][lab_performed_res]"
														class="form-control m-b-4"
														value="<?php echo $investigation->lab_performed_res; ?> ">
												</div>
												<input type="hidden"
													name="investig_name[lab][lab_test][<?php echo $investigation->lab_test_id; ?>][lab_performed_res]"
													class="<?php if ($investigation->test_radio == 1) {
														echo 'd-block';
													} else {
														echo 'd-none';
													} ?>">

												<input type="hidden" name="investig_id[]" class="form-control m-b-4"
													value="<?php echo $investigation->lab_test_id; ?>"><input type="hidden"
													name="investig_name[lab][lab_test][<?php echo $investigation->lab_test_id; ?>][lab_test_id]"
													class="form-control m-b-4"
													value="<?php echo $investigation->lab_test_id; ?>">
											</td>
											<td><button type="button" class="btn-custom aa_<?php echo $j; ?>"
													onclick="return remove_lab_test('<?php echo $j; ?>');"><i
					...
					<div class="row">
						...
						<div class="col-md-5">
							<textarea class="form-control"
								name="comment_lab"><?php echo $invest_comment['comment_lab']; ?></textarea>
						</div>
				...
				<div role="tabpanel" class="tab-pane" id="Radiology">
					...
					<div class="row text-right">
						...
						<div class="col-lg-3">
							<div style="position:relative;text-align:left;">
								<input class="form-control" type="text" name="" id="radio_search"
									onkeyup="return radio1_search(this.value);"
									placeholder="Search by any Radiology Investigations Name">
					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-4 col-sm-6">
							...
							<select name="provisional_diagnosis" id="radiology_investig" class="form-control"
								multiple="">
									...
									<table class="table table-bordered add_radio_<?php echo $k; ?>">
										<tr>
											<td style="width:unset;text-align:left;">
												<div class="d-block">
													<input type="radio"
														name="investig_name[radio][radio_set][<?php echo $k; ?>][radiolo_radio]"
														value="1" class="adv_<?php echo $k; ?> radvis"
														onchange="return radio_performed(this.value,'<?php echo $k; ?>');" <?php if ($investigation->radiolo_radio == 1) { ?> checked <?php } ?>> Advised
												</div>
												<div class="d-block">
													<input type="radio"
														name="investig_name[radio][radio_set][<?php echo $k; ?>][radiolo_radio]"
														class="adv_<?php echo $k; ?>" value="2"
														onchange="return radio_performed(this.value,'<?php echo $k; ?>');" <?php if ($investigation->radiolo_radio == 2) { ?> checked <?php } ?>> Performed
												</div>
											</td>
											<td>
												<input type="text"
													name="investig_name[radio][radio_set][<?php echo $k; ?>][test_name]"
													id="investig_name" class="form-control m-b-4"
													value="<?php echo $investigation->test_name; ?>">
												<div class="<?php if ($investigation->radiolo_radio == 2) {
													echo 'd-block';
												} else {
													echo 'd-none';
												} ?>"
													id="radio_performed_res<?php echo $k; ?>">
													<div class="small text-bold"> Findings </div>
													<input type="text"
														name="investig_name[radio][radio_set][<?php echo $k; ?>][radio_performed_res]"
														class="form-control m-b-4"
														value="<?php echo $investigation->radio_performed_res; ?>">
												</div>

												<input type="hidden"
													name="investig_name[radio][radio_set][<?php echo $k; ?>][test_id]"
													class="form-control m-b-4" value="<?php echo $investigation->test_id; ?>">
												<input type="hidden"
													name="investig_name[radio][radio_set][<?php echo $k; ?>][radio_set_id]"
													class="form-control m-b-4"
													value="<?php echo $investigation->radio_set_id; ?>">
											</td>
											<td>
											...
											<td>
												<button type="button" class="btn-custom aa_<?php echo $k; ?>"
													onclick="return remove_radio_test('<?php echo $k; ?>');"><i
														class="fa fa-times"></i>
												</button>
											</td>
										</tr>
									...
									<table class="table table-bordered add_radio_<?php echo $k; ?>">
										<tr>
											<td style="width:unset;text-align:left;">
												<div class="d-block">
													<input type="radio"
														name="investig_name[radio][radio_test][<?php echo $investigation->test_id; ?>][test_radio]"
														value="1" class="adv_<?php echo $k; ?> radvis"
														onchange="return radio_performed(this.value,'<?php echo $k; ?>');" <?php if ($investigation->test_radio == 1) { ?> checked <?php } ?>>Advised
												</div>
												<div class="d-block">
													<input type="radio"
														name="investig_name[radio][radio_test][<?php echo $investigation->test_id; ?>][test_radio]"
														class="adv_<?php echo $k; ?>" value="2"
														onchange="return radio_performed(this.value,'<?php echo $k; ?>');" <?php if ($investigation->test_radio == 2) { ?> checked <?php } ?>> Performed
												</div>
											</td>
											<td>
												<input type="text"
													name="investig_name[radio][radio_test][<?php echo $investigation->test_id; ?>][test_name]"
													class="form-control m-b-4" value="<?php echo $investigation->test_name; ?>">
												<div class="<?php if ($investigation->test_radio == 2) {
													echo 'd-block';
												} else {
													...
													<div class="small text-bold"> Findings </div>
													<input type="text"
														name="investig_name[radio][radio_test][<?php echo $investigation->test_id; ?>][radio_performed_res]"
														class="form-control m-b-4"
														value="<?php echo $investigation->radio_performed_res; ?>">
												</div>
												<input type="hidden"
													name="investig_name[radio][radio_test][<?php echo $investigation->test_id; ?>][test_id]"
													class="form-control m-b-4" value="<?php echo $investigation->test_id; ?>">
											</td>
											<td>
												<select name="" id="" class="form-control">
											...
											<td>
												<button type="button" class="btn-custom aa_<?php echo $k; ?>"
													onclick="return remove_opthal_test('<?php echo $k; ?>');"><i
														class="fa fa-times"></i>
												</button>
											</td>
										</tr>
					...
					<div class="row">
						...
						<div class="col-md-5">
							<textarea class="form-control"
								name="comment_radiology"><?php echo $invest_comment['comment_radiology']; ?></textarea>
						</div>
...
<script>
	...
	$('#eye_region').change(function () {
		...
		$.ajax({
			url: "<?php echo base_url(); ?>eye/ophthal_set/eye_region_test/" + test_head_id,
			success: function (result) {
				$('#investig_box').show();
