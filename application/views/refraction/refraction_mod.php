...
function add_values()
{
 var tab_name='<?php echo $page_title;?>';
  $('#refraction_ar_l_dv_sph').val($('.tab_f_1').val());
  $('#refraction_ar_l_dv_cyl').val($('.tab_f_2').val());
  $('#refraction_ar_l_dv_axis').val($('.tab_f_3').val());
  $('#refraction_ar_l_nv_sph').val($('.tab_f_4').val());
  $('#refraction_ar_l_nv_cyl').val($('.tab_f_5').val());
  $('#refraction_ar_l_nv_axis').val($('.tab_f_6').val());
  ...
  $('#refraction_ar_r_dv_sph').val($('.tab_f_13').val());
  $('#refraction_ar_r_dv_cyl').val($('.tab_f_14').val());
  $('#refraction_ar_r_dv_axis').val($('.tab_f_15').val());
  $('#refraction_ar_r_nv_sph').val($('.tab_f_16').val());
  $('#refraction_ar_r_nv_cyl').val($('.tab_f_17').val());
  $('#refraction_ar_r_nv_axis').val($('.tab_f_18').val());
