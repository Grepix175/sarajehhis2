                        ...
                        <td style="width: 26%;">
                            <div class="text-center">
                                <div class="label_name">COLOR VISION 
                                    <i onclick="low_vision_col_vis_ltr();" title="Copy Left to Right" class="fa fa-arrow-right"></i>
                                </div>
                            </div>
                        </td>
                        <td style="width: 20%;">
                            <input type="text" name="low_vision_col_vis_l" id="low_vision_col_vis_l" class="form-control" value="<?php echo htmlspecialchars($low_vision_col_vis_l); ?>" readonly />
                        </td>
                        <td style="width: 25%;">
                            <div class="text-center">
                                <div class="label_name">COLOR VISION 
                                    <i onclick="low_vision_col_vis_rtl();" title="Copy Right to Left" class="fa fa-arrow-left pointer"></i>
                                </div>
                            </div>
                        </td>
                        <td style="width: 20%;">
                            <input type="text" name="low_vision_col_vis_r" id="low_vision_col_vis_r" class="form-control" value="<?php echo htmlspecialchars($low_vision_col_vis_r); ?>" readonly />
                        </td>
                    </tr>
                </table>
            </div>
