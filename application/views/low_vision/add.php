            ...
            <form id="low_vision_form" method="post" action="<?php echo current_url(); ?>">
                ...
                <section class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-2">
                                <div class="label_name">COLOR VISION <i onclick="low_vision_col_vis_ltr();"
                                        title="Copy Left to Right" class="fa fa-arrow-right"></i></div>
                            </div>
                            <div class="col-md-4">
                                <textarea name="low_vision_col_vis_l" id="low_vision_col_vis_l" style="height: 60px"
                                    class="form-control"><?php echo isset($form_data['low_vision_col_vis_l']) ? htmlspecialchars($form_data['low_vision_col_vis_l']) : ''; ?></textarea>
                            </div>
                            <div class="col-md-2">
                                <div class="label_name">COLOR VISION <i onclick="low_vision_col_vis_rtl();"
                                        title="Copy Right to Left" class="fa fa-arrow-left pointer"></i></div>
                            </div>
                            <div class="col-md-4">
                                <textarea name="low_vision_col_vis_r" id="low_vision_col_vis_r" style="height: 60px"
                                    class="form-control"><?php echo isset($form_data['low_vision_col_vis_r']) ? htmlspecialchars($form_data['low_vision_col_vis_r']) : ''; ?></textarea>
                            </div>
                        </div>
                    </div>
                </section>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="btn-group">
                                    ...
                                    <input type="hidden" name="low_vision_contra_sens_l"
                                        value="<?= $form_data['low_vision_contra_sens_l'] ?>">

                                    <?php foreach ($contrast_values as $value): ?>
                                        <label
                                            class="btn_radio_small d-none con_sen <?= $form_data['low_vision_contra_sens_l'] == $value ? 'active' : '' ?>"
                                            style="display: inline-block;">
                                            <input type="radio" name="low_vision_contra_sens_l"
                                                class="low_vision_contra_sens_l" value="<?= $value ?>"
                                                <?= $form_data['low_vision_contra_sens_l'] == $value ? 'checked' : '' ?>>
                                            <?= $value ?>
                                        </label>
                                    <?php endforeach; ?>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="btn-group">
                                    <!-- Hidden input to retain previous value if no new value is selected -->
                                    <input type="hidden" name="low_vision_contra_sens_r"
                                        value="<?= $form_data['low_vision_contra_sens_r'] ?>">

                                    <?php foreach ($contrast_values as $value): ?>
                                        <label
                                            class="btn_radio_small d-none con_sen <?= $form_data['low_vision_contra_sens_r'] == $value ? 'active' : '' ?>"
                                            style="display: inline-block;">
                                            <input type="radio" name="low_vision_contra_sens_r"
                                                class="low_vision_contra_sens_r" value="<?= $value ?>"
                                                <?= $form_data['low_vision_contra_sens_r'] == $value ? 'checked' : '' ?>>
                                            <?= $value ?>
                                        </label>
                                    <?php endforeach; ?>
                                </div>
                ...
                <div class="box-right" style="padding-left: 2.5rem;">
                    ...
                    <div class="grp" style="width: 115%;">
                        ...
                        <div class="box-right" style="padding-left: 2.5rem;">
                            <input type="text" name="amsler_grid" class="txt_firstCap input-height" id="amsler_grid"
                                value="<?php echo isset($form_data['amsler_grid']) ? htmlspecialchars($form_data['amsler_grid']) : ''; ?>"
                                style="width: 374px;" />
                    ...
                    <div class="grp" style="width: 115%;">
                        ...
                        <div class="box-right" style="padding-left: 2.5rem;">
                            <input type="text" name="lva_trial" class="txt_firstCap input-height" id="lva_trial"
                                value="<?php echo isset($form_data['lva_trial']) ? htmlspecialchars($form_data['lva_trial']) : ''; ?>"
                                style="width: 374px;" />
                    ...
                    <div class="grp" style="width: 115%;">
                        ...
                        <div class="box-right" style="padding-left: 2.5rem;">
                            <input type="text" name="distance_lva" class="txt_firstCap input-height" id="distance_lva"
                                value="<?php echo isset($form_data['distance_lva']) ? htmlspecialchars($form_data['distance_lva']) : ''; ?>"
                                style="width: 374px;" />
                    ...
                    <div class="grp" style="width: 115%;">
                        ...
                        <div class="box-right" style="padding-left: 2.5rem;">
                            <input type="text" name="near_lva" class="txt_firstCap input-height" id="near_lva"
                                value="<?php echo isset($form_data['near_lva']) ? htmlspecialchars($form_data['near_lva']) : ''; ?>"
                                style="width: 374px;" />
                    ...
                    <div class="grp" style="width: 115%;">
                        ...
                        <div class="box-right" style="padding-left: 2.5rem;">
                            <input type="text" name="non_optical_device" class="txt_firstCap input-height"
                                id="non_optical_device"
                                value="<?php echo isset($form_data['non_optical_device']) ? htmlspecialchars($form_data['non_optical_device']) : ''; ?>"
                                style="width: 374px;" />
                    ...
                    <div class="grp" style="width: 115%;">
                        ...
                        <div class="box-right" style="padding-left: 2.5rem;">
                            <input type="text" name="final_advice" class="txt_firstCap input-height" id="final_advice"
                                value="<?php echo isset($form_data['final_advice']) ? htmlspecialchars($form_data['final_advice']) : ''; ?>"
                                style="width: 374px;" />
                    ...
                    <div class="grp" style="width: 115%;">
                        ...
                        <div class="box-right" style="padding-left: 2.5rem;">
                            <input type="text" name="referred_for" class="txt_firstCap input-height" id="referred_for"
                                value="<?php echo isset($form_data['referred_for']) ? htmlspecialchars($form_data['referred_for']) : ''; ?>"
                                style="width: 374px;" />
                    ...
                    <div class="grp" style="width: 115%;">
                        ...
                        <div class="box-right" style="padding-left: 2.5rem;">
                            <input type="text" name="follow_up" class="txt_firstCap input-height" id="follow_up"
                                value="<?php echo isset($form_data['follow_up']) ? htmlspecialchars($form_data['follow_up']) : ''; ?>"
                                style="width: 374px;" />
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    showAlert(
                        ...
                        "<?php echo base_url('low_vision'); ?>" // URL for redirection
                    );
                } else {
