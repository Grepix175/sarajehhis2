          ...
          <div class="row">
            <div class="col-md-12 m-b1">
              <div class="row">
                ...
                <div class="col-md-7">
                    <input type="text" name="charge"  value="<?php echo $form_data['charge']; ?>" class="inputFocus">
...
$("#corporate").on("submit", function(event) { 
  ...
  { 
    var path = 'edit/'+ids;
    var msg = 'Eme. Reg. Charge successfully updated.';
  }
  else
  {
    var path = 'add/';
    var msg = 'Eme. Reg. Charge successfully created.';
  } 
  //alert('ddd');return false;
  $.ajax({
    url: "<?php echo base_url('emg_reg_charge/'); ?>"+path,
    type: "post",
    data: $(this).serialize(),
