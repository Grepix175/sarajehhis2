...
<body>
  ...
  <div class="container-fluid">
    ...
    <?php if (isset($user_role) && $user_role != 4 && $user_role != 3) { ?>
      <form name="search_form" id="search_form" class="search_form " style="margin-top: 10px;">
            ...
            <div class="row m-b-5">
              ...
              <div class="col-xs-7">
                <input id="from_date" name="from_date" class=" start_datepicker m_input_default" type="text"
                  value="<?php echo $form_data['from_date'] ?>">
              </div>
            </div>
            <div class="row m-b-5">
              ...
              <div class="col-xs-7">
                ...
                <label class="radio-inline">
                  <input type="radio" name="search_type" value="" id="search_type_process" onclick="return form_submit();"
                    <?php if (isset($form_data['search_type']) && $form_data['search_type'] == '') { ?> checked="checked"
                    <?php } ?>>
                  All
                </label>
              </div>
            ...
            <div class="row m-b-5">
              ...
              <div class="col-xs-7">
                <input name="to_date" id="to_date" class="end_datepicker m_input_default"
                  value="<?php echo $form_data['to_date'] ?>" type="text">
              </div>
            </div>
