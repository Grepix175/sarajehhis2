...
<body>
    ...
    <div class="container-fluid">
        ...
        <section class="content">
            <form id="dilate_modal_form" method="post" action="<?php echo current_url(); ?>"
                ...
                <div class="content-inner">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-5">
                            ...
                            <div class="row m-b-5">
                                ...
                                <div class="col-xs-8">
                                    <input type="text" name="mobile_no"
                                        value="<?php echo isset($age) ? $age : 'N/A'; ?>" readonly=""
                                        style="width:100% !important;height:25px;background:#f8f8f8;font-size:13px;padding:2px;">
                                </div>
                            </div>
                            <div class="row m-b-5">
                    ...
                    <div class=" text-right">
                        ...
                        <div class="pat-col">
                            <table id="itemTable" class="table table-striped table-bordered" cellspacing="0"
                                width="100%">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                ...
                                <?php if (!empty($form_data['items']) && is_array($form_data['items'])): ?>
                                    <?php foreach ($form_data['items'] as $index => $item): ?>
                                        <?php if (!empty($item)): 
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:100%;">
                                                    <select id="medicine_name_dropdown_<?php echo $index; ?>"
                                                        name="items[<?php echo $index; ?>][medicine_name]"
                                                        class="medicine_name_dropdown" data-index="<?php echo $index; ?>">
                                                ...
                                                <!-- Salt Dropdown -->
                                                <td>
                                                    <select id="salt_dropdown_<?php echo $index; ?>"
                                                        name="items[<?php echo $index; ?>][salt]" class="salt_dropdown"
                                                ...
                                                <td><input type="number" name="items[<?php echo $index; ?>][percentage]"
                                                        value="<?php echo $item['percentage']; ?>" placeholder="Percentage">
                                                </td>
                                    ...
                                    <?php else: ?>
                                        <tr>
                                            ...
                                            <td>
                                                <select id="medicine_name_dropdown_0" name="items[0][medicine_name]"
                                                    class="medicine_name_dropdown" data-index="0">
                                                    <option value="">Select Medicine Name</option>
                                                    <?php foreach ($medicines as $medicine): ?>
                                            ...
                                            <td>
                                                <select id="salt_dropdown_0" name="items[0][salt]" class="salt_dropdown"
                                                    data-index="0">
                                                    <option value="">Select Salt</option>
                                                    <?php foreach ($medicines as $medicine): ?>
                                            ...
                                            <!-- Percentage Field -->
                                            <td>
                                                <input type="number" name="items[0][percentage]"
                                                    value="<?php echo isset($form_data['percentage']) ? $form_data['percentage'] : ''; ?>"
                    ...
                    <div class="row m-b-5" style="text-align:left;margin-top:10px;">
                        ...
                        <div class="col-sm-3" style="margin: 30px 0;">
                            <textarea type="text" class="m_input_default"
                                name="remarks"><?php echo isset($form_data['remarks']) ? $form_data['remarks'] : ''; ?></textarea>
                        </div>
                    </div>
            ...
            <a href="<?php echo base_url('dilate'); ?>" class="btn-anchor"><i class="fa fa-sign-out"></i> Exit</a>
        </section>
    </div>
    <?php
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    showAlert(
                        ...
                        "<?php echo base_url('dilate'); ?>" // URL for redirection
                    );
                }
                else {
