  ...
  <script type="text/javascript">
    ...
    if (in_array('367', $users_data['permission']['action'])) {
      ...
      $(document).ready(function () {
        ...
        $.ajax({
          url: "<?php echo base_url(); ?>hospital_code_entry/advance_search/",
          type: "post",
          ...
          success: function (result) {
            table = $('#table').DataTable({
              ...
              "pageLength": '20',
              "ajax": {
                "url": "<?php echo base_url('hospital_code_entry/ajax_list') ?>",
                "type": "POST",
              },
              "columnDefs": [
                {
    ...
    $(document).ready(function () {
      ...
      $('#medicine_entry_add_modal').on('click', function () {
        $modal.load('<?php echo base_url() . 'hospital_code_entry/add/' ?>',
          {
            //'id1': '1',
            //'id2': '2'
          },
    ...
    function edit_medicine_entry(id) {
      var $modal = $('#load_add_modal_popup');
      $modal.load('<?php echo base_url() . 'hospital_code_entry/edit/' ?>' + id,
        {
          //'id1': '1',
          //'id2': '2'
        },
    ...
    function view_medicine_entry(id) {
      var $modal = $('#load_add_modal_popup');
      $modal.load('<?php echo base_url() . 'hospital_code_entry/view/' ?>' + id,
        {
          //'id1': '1',
          //'id2': '2'
        },
      ...
      if (allVals != "") {
        $('#confirm').modal({
          ...
          .one('click', '#delete', function (e) {
            $.ajax({
              type: "POST",
              url: "<?php echo base_url('hospital_code_entry/deleteall'); ?>",
              data: { row_id: allVals },
              success: function (result) {
      ...
      if (allVals != "") {
        $('#confirm').modal({
          ...
          .one('click', '#delete', function (e) {
            $.ajax({
              type: "POST",
              url: "<?php echo base_url('hospital_code_entry/allbranch_typedata'); ?>",
  ...
  <div class="container-fluid">
      ...
      <div class="userlist-box">
          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="row m-b-5">
                ...
                <div class="col-xs-7">
                  <input type="text" name="start_date" value="<?php echo $form_data['start_date']; ?>" id="start_date_p"
                    class="datepicker m_input_default" onkeyup="return form_submit();">
                </div>
              </div>
              ...
              <!-- <div class="row m-b-5">
                ...
                <div class="col-xs-7">
                  <input type="text" class="m_input_default" name="medicine_name"
                    value="<?php echo $form_data['medicine_name']; ?>" onkeyup="return form_submit();" autofocus="">
                </div>
              </div> -->
            ...
            <div class="col-sm-4">
              <div class="row m-b-5">
                ...
                <div class="col-xs-7">
                  <input type="text" name="end_date" id="end_date_p" value="<?php echo $form_data['end_date']; ?>"
                    class="datepicker m_input_default" onkeyup="return form_submit();">
                </div>
              </div>
              ...
              <!-- <div class="row m-b-5">
                ...
                <div class="col-xs-7">
                  <input type="text" class="m_input_default" name="medicine_company"
                    value="<?php echo $form_data['medicine_company']; ?>" onkeyup="return form_submit();"
                    id="automplete-1" value="">
                </div>
              </div> -->
            </div> <!-- 4 -->

            <div class="col-sm-4 d-flex justify-content-center" style="margin-left: 222px;margin-top: 15px;margin-bottom:10px;">

              <input value="Reset" class="btn-custom" onclick="clear_form_elements(this.form)" type="button">
              <!-- <a href="javascript:void(0)" class="btn-a-search" id="adv_search_medicine"><i class="fa fa-cubes"
                  aria-hidden="true"></i> Advance Search</a> -->
            </div>
          </div> <!-- row -->
        ...
        <form>
          <?php if (in_array('367', $users_data['permission']['action'])) {
            ...
            <table id="table" class="table table-striped table-bordered table-responsive medicine_entry_list"
              cellspacing="0" width="100%">
              <thead>
                <tr>
                  <th align="center" width="40"> <input type="checkbox" name="selectall" class="" id="selectAll" value="">
                  </th>
                  <th> Hospital Code </th>
        ...
        <div class="btns">
          <?php if (in_array('368', $users_data['permission']['action'])) { ?>
            ...
            <div id="for_other">
              ...
              <a href="<?php echo base_url('hospital_code_entry/medicine_entry_excel'); ?>" class="btn-anchor m-b-2">
                <i class="fa fa-file-excel-o"></i> Excel
              </a>

              <!-- <a href="<?php echo base_url('hospital_code_entry/medicine_entry_csv'); ?>" class="btn-anchor m-b-2">
                <i class="fa fa-file-word-o"></i> CSV
              </a> -->

              <a href="<?php echo base_url('hospital_code_entry/pdf_medicine_entry'); ?>" class="btn-anchor m-b-2">
                <i class="fa fa-file-pdf-o"></i> PDF
              </a>

              <!--  <a href="javascript:void(0)" class="btn-anchor m-b-2" id="deleteAll" onClick="return openPrintWindow('< ?php echo base_url("hospital_code_entry/print_medicine_entry"); ?>', 'windowTitle', 'width=820,height=600');">
              <i class="fa fa-print"></i> Print
              </a> -->

              <a href="javascript:void(0)" class="btn-anchor m-b-2"
                onClick="return print_window_page('<?php echo base_url("hospital_code_entry/print_medicine_entry"); ?>');"> <i
            ...
            if (in_array('368', $users_data['permission']['action'])) { ?>
              <!-- <a href="<?php echo base_url('hospital_code_entry/sample_import_excel'); ?>" class="btn-anchor m-b-2">
          ...
          <?php if (in_array('371', $users_data['permission']['action'])) {
            ?>
            <div id="for_archive">
              <button class="btn-exit" onclick="window.location.href='<?php echo base_url('hospital_code_entry/archive'); ?>'">
                <i class="fa fa-archive"></i> Archive
              </button>
            </div>
          <?php } ?>
          <button class="btn-exit" onclick="window.location.href='<?php echo base_url('hospital_code_entry'); ?>'">
    ...
    <script>
      function clear_form_elements(ele) {
        $.ajax({
          url: "<?php echo base_url(); ?>medicine_entry?>/reset_search/",
          success: function (result) {
      ...
      function delete_medicine_entry(id) {
        $('#confirm').modal({
          ...
          .one('click', '#delete', function (e) {
            $.ajax({
              url: "<?php echo base_url('hospital_code_entry/delete/'); ?>" + id,
              success: function (result) {
                flash_session_msg(result);
                reload_table();
              }
    ...
    <div id="load_add_ipd_label_summary_print_modal_popup" class="modal fade" role="dialog" data-backdrop="static"
      data-keyboard="false"></div>
    <div id="load_medicine_import_modal_popup" class="modal fade modal-40" role="dialog" data-backdrop="static"
      data-keyboard="false"></div>
  </div>
  <script>
    var $modal = $('#load_add_modal_popup');
    $('#adv_search_medicine').on('click', function () {
      // alert();
      $modal.load('<?php echo base_url() . 'hospital_code_entry/advance_search/' ?>',
        {
        },
        function () {
          $modal.modal('show');
    ...
    $('#open_model').on('click', function () {
      //  alert();
      $modal.load('<?php echo base_url() . 'hospital_code_entry/import_medicine_excel' ?>',
        {
        },
        function () {
          $modal.modal('show');
    ...
    function print_label(id) {
      ...
      $modal.load('<?php echo base_url() . 'hospital_code_entry/print_template/'; ?>' + id,
        {
          //'id1': '1',
          //'id2': '2'
        },
