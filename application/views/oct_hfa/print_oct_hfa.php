                        ...
                        <tbody>
                            <?php if ($squint_history['inward'] == 1) { ?>
                                <tr>
                                    ...
                                    <td style="text-align:left;"><?php echo !empty($squint_history['history_chief_inward_side']) ? $squint_history['history_chief_inward_side'] . ' Eye' : 'N/A'; ?></td>
                                    <td style="text-align:left;"><?php echo !empty($squint_history['history_chief_inward_dur']) ?  $squint_history['history_chief_inward_dur'] : 'N/A'; ?></td>
                                    <td style="text-align:left;"><?php echo !empty($squint_history['history_chief_inward_unit']) ? $squint_history['history_chief_inward_unit'] : 'N/A'; ?></td>
                                </tr>
                            <?php } ?>
                            <?php if ($squint_history['outward'] == 1) { ?>
                                <tr>
                                    <td style="text-align:left;">Outward Deviation</td>
                                    <td style="text-align:left;"><?php echo !empty($squint_history['history_chief_outward_side']) ? $squint_history['history_chief_outward_side'] . ' Eye' : 'N/A'; ?></td>
                                    <td style="text-align:left;"><?php echo !empty($squint_history['history_chief_outward_dur']) ?  $squint_history['history_chief_outward_dur'] : 'N/A'; ?></td>
                                    <td style="text-align:left;"><?php echo !empty($squint_history['history_chief_outward_unit']) ? $squint_history['history_chief_outward_unit'] : 'N/A'; ?></td>
                                </tr>
                            <?php } ?>
                            <?php if ($squint_history['upward'] == 1) { ?>
                                <tr>
                                    <td style="text-align:left;">Upward/Downward Deviation</td>
                                    <td style="text-align:left;"><?php echo !empty($squint_history['history_chief_upward_side']) ? $squint_history['history_chief_upward_side'] . ' Eye' : 'N/A'; ?></td>
                                    <td style="text-align:left;"><?php echo !empty($squint_history['history_chief_upward_dur']) ?  $squint_history['history_chief_upward_dur'] : 'N/A'; ?></td>
                                    <td style="text-align:left;"><?php echo !empty($squint_history['history_chief_upward_unit']) ? $squint_history['history_chief_upward_unit'] : 'N/A'; ?></td>
                                </tr>
                            <?php } ?>
                            <?php if ($squint_history['prev_squint'] == 1) { ?>
                                <tr>
                                    <td style="text-align:left;">Previous H/O Squint/Other Surgery</td>
                                    <td><?php echo !empty($squint_history['history_chief_prev_squint_side']) ? $squint_history['history_chief_prev_squint_side'] . ' Eye' : 'N/A'; ?></td>
                                    <td><?php echo !empty($squint_history['history_chief_prev_squint_dur']) ?  $squint_history['history_chief_prev_squint_dur'] : 'N/A'; ?></td>
                                    <td><?php echo !empty($squint_history['history_chief_prev_squint_unit']) ? $squint_history['history_chief_prev_squint_unit'] : 'N/A'; ?></td>
                                </tr>
                            <?php } ?>
                            <?php if ($squint_history['double_vision'] == 1) { ?>
                                <tr>
                                    <td style="text-align:left;">H/O Double Vision</td>
                                    <td><?php echo !empty($squint_history['history_chief_double_vision_side']) ? $squint_history['history_chief_double_vision_side'] . ' Eye' : 'N/A'; ?></td>
                                    <td><?php echo !empty($squint_history['history_chief_double_vision_dur']) ?  $squint_history['history_chief_double_vision_dur'] : 'N/A'; ?></td>
                                    <td><?php echo !empty($squint_history['history_chief_double_vision_unit']) ? $squint_history['history_chief_double_vision_unit'] : 'N/A'; ?></td>
                                </tr>
                            <?php } ?>
                            <?php if ($squint_history['constant'] == 1) { ?>
                                <tr>
                                    <td style="text-align:left;">Constant/Occasional/Intermittent</td>
                                    <td><?php echo !empty($squint_history['history_chief_constant_side']) ? $squint_history['history_chief_constant_side'] . ' Eye' : 'N/A'; ?></td>
                                    <td><?php echo !empty($squint_history['history_chief_constant_dur']) ?  $squint_history['history_chief_constant_dur'] : 'N/A'; ?></td>
                                    <td><?php echo !empty($squint_history['history_chief_constant_unit']) ? $squint_history['history_chief_constant_unit'] : 'N/A'; ?></td>
                                </tr>
                            <?php } ?>
                            <?php if ($squint_history['antisupression'] == 1) { ?>
                                <tr>
                                    <td style="text-align:left;">H/O Wearing Glasses/Patching Therapy/Antisupression</td>
                                    <td><?php echo !empty($squint_history['history_chief_antisupression_side']) ? $squint_history['history_chief_antisupression_side'] . ' Eye' : 'N/A'; ?></td>
                                    <td><?php echo !empty($squint_history['history_chief_antisupression_dur']) ?  $squint_history['history_chief_antisupression_dur'] : 'N/A'; ?></td>
