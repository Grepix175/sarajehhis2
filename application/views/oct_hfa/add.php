            ...
            <form id="oct_hfa_form" method="post" action="<?php echo current_url(); ?>">
                ...
                <div class="row">
                    ...
                    <h4>Chief Complaints</h4>
                        <div class="btn-group">
                            <label class="btn-custom" style="text-transform:unset!important;"><input type="checkbox" <?php if ($chief_complaints['bdv_m'] == 1) {
                                echo 'checked';
                            } ?> name="bdv_m" value="1" id="bdv_m">
                                Blurring/Diminution of vision</label>
                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['redness_m'] == 1) {
                                echo 'checked';
                            } ?> name="redness_m" value="1"
                                    id="redness_m"> Redness</label>
                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['`pain_m`'] == 1) {
                                echo 'checked';
                            } ?> name="pain_m" value="1" id="pain_m"> Pain</label>
                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['injury_m'] == 1) {
                                echo 'checked';
                            } ?> name="injury_m" value="1" id="injury_m"> Injury</label>
                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['water_m'] == 1) {
                                echo 'checked';
                            } ?> name="water_m" value="1" id="water_m"> Watering</label>
                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['discharge_m'] == 1) {
                                echo 'checked';
                            } ?> name="discharge_m" value="1"
                                    id="discharge_m"> Discharge</label>
                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['dryness_m'] == 1) {
                                echo 'checked';
                            } ?> name="dryness_m" value="1"
                                    id="dryness_m"> Dryness</label>
                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['itch_m'] == 1) {
                                echo 'checked';
                            } ?> name="itch_m" value="1" id="itch_m"> Itching</label>
                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['fbd_m'] == 1) {
                                echo 'checked';
                            } ?> name="fbd_m" value="1" id="fbd_m"> FB Sensation</label>
                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['devs_m'] == 1) {
                                echo 'checked';
                            } ?> name="devs_m" value="1" id="devs_m"> Deviation/Squint</label>
                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['heads_m'] == 1) {
                                echo 'checked';
                            } ?> name="heads_m" value="1" id="heads_m"> Headache/Strain</label>
                            <label class="btn-custom" style="text-transform:unset!important;"><input type="checkbox" <?php if ($chief_complaints['canss_m'] == 1) {
                                echo 'checked';
                            } ?> name="canss_m" value="1"
                                    id="canss_m"> Change in Size/Shape</label>
                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['ovs_m'] == 1) {
                                echo 'checked';
                            } ?> name="ovs_m" value="1" id="ovs_m"> Other Visual Symptoms</label>
                            <label class="btn-custom" style="text-transform:unset!important;"><input type="checkbox" <?php if ($chief_complaints['sdv_m'] == 1) {
                                echo 'checked';
                            } ?> name="sdv_m" value="1" id="sdv_m">
                                Shadow/Defect in vision</label>
                            <label class="btn-custom" style="text-transform:unset!important;"><input type="checkbox" <?php if ($chief_complaints['doe_m'] == 1) {
                                echo 'checked';
                            } ?> name="doe_m" value="1" id="doe_m">
                                Discoloration of Eye</label>
                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['swel_m'] == 1) {
                                echo 'checked';
                            } ?> name="swel_m" value="1" id="swel_m"> Swelling</label>
                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['burns_m'] == 1) {
                                echo 'checked';
                            } ?> name="burns_m" value="1" id="burns_m"> Burning Sensation</label>
                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['ptosis_sx'] == 1) {
                                echo 'checked';
                            } ?> name="ptosis_sx" value="1"
                                    id="ptosis_sx"> Ptosis Sx</label>
                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['lid_sx'] == 1) {
                                echo 'checked';
                            } ?> name="lid_sx" value="1" id="lid_sx"> Lid Sx</label>
                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['corneal_sx'] == 1) {
                                echo 'checked';
                            } ?> name="corneal_sx" value="1"
                                    id="corneal_sx"> Corneal Sx</label>
                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['cataract_sx'] == 1) {
                                echo 'checked';
                            } ?> name="cataract_sx" value="1"
                                    id="cataract_sx"> Cataract Sx</label>
                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['squint_sx'] == 1) {
                                echo 'checked';
                            } ?> name="squint_sx" value="1"
                                    id="squint_sx"> Squint Sx</label>
                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['pterygium_sx'] == 1) {
                                echo 'checked';
                            } ?> name="pterygium_sx"
                                    value="1" id="pterygium_sx"> Pterygium Sx</label>
                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['dcr'] == 1) {
                                echo 'checked';
                            } ?> name="dcr" value="1" id="dcr_sx"> DCR</label>
                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['dct_sx'] == 1) {
                                echo 'checked';
                            } ?> name="dct_sx" value="1" id="dct_sx"> DCT Sx</label>
                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['patching_therapy'] == 1) {
                                echo 'checked';
                            } ?> name="patching_therapy"
                                    value="1" id="patching_therapy">Patching Therapy</label>
                        </div>                    
                                ...
                                <div class="row" id="pains">
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_pains_side">
                                            ...
                                            <option <?php if ($chief_complaints['history_chief_pains_side'] == 'Left') {
                                                echo 'selected';
                                            } ?> value="Left">L</option>
                                            <option <?php if ($chief_complaints['history_chief_pains_side'] == 'Right') {
                                                echo 'selected';
                                            } ?> value="Right">R</option>
                                            <option <?php if ($chief_complaints['history_chief_pains_side'] == 'Both') {
                                                echo 'selected';
                                            } ?> value="Both">B/E</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1 m-b-5">
                                        <select class="form-control" name="history_chief_pains_dur">
                                            <option value="">Please Select</option>
                                            <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                <option <?php if ($chief_complaints['history_chief_pains_dur'] == $i) {
                                                    echo 'selected';
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_pains_unit">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_pains_unit'] == 'Days') {
                                                echo 'selected';
                                            } ?> value="Days">Days</option>
                                            <option <?php if ($chief_complaints['history_chief_pains_unit'] == 'Weeks') {
                                                echo 'selected';
                                            } ?> value="Weeks">Weeks</option>
                                            <option <?php if ($chief_complaints['history_chief_pains_unit'] == 'Months') {
                                                echo 'selected';
                                            } ?> value="Months">Months</option>
                                            <option <?php if ($chief_complaints['history_chief_pains_unit'] == 'Years') {
                                                echo 'selected';
                                    ...
                                    <div class="col-md-3  m-b-5">
                                        <input type="text" placeholder="Comment..."
                                            value="<?php echo $chief_complaints['history_chief_pains_comm']; ?>"
                                            name="history_chief_pains_comm" style="width: 100%;">
                                    </div>
                                </div>

                                <div class="row" id="blurr">
                                    <div class="col-md-2  m-b-5">
                                        <label style="text-transform:unset !important">Blurring Diminution of
                                            Vision</label>
                                    </div>
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_blurr_side">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_blurr_side'] == 'Left') {
                                                echo 'selected';
                                            } ?> value="Left">L</option>
                                            <option <?php if ($chief_complaints['history_chief_blurr_side'] == 'Right') {
                                                echo 'selected';
                                            } ?> value="Right">R</option>
                                            <option <?php if ($chief_complaints['history_chief_blurr_side'] == 'Both') {
                                                echo 'selected';
                                            } ?> value="Both">B/E</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1 m-b-5">
                                        <select class="form-control" name="history_chief_blurr_dur">
                                            <option value="">Please Select</option>
                                            <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                <option <?php if ($chief_complaints['history_chief_blurr_dur'] == $i) {
                                                    echo 'selected';
                                                } ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                            <?php } ?>
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_blurr_unit">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_blurr_unit'] == 'Days') {
                                                echo 'selected';
                                            } ?> value="Days">Days</option>
                                            <option <?php if ($chief_complaints['history_chief_blurr_unit'] == 'Weeks') {
                                                echo 'selected';
                                            } ?> value="Weeks">Weeks</option>
                                            <option <?php if ($chief_complaints['history_chief_blurr_unit'] == 'Months') {
                                                echo 'selected';
                                            } ?> value="Months">Months</option>
                                            <option <?php if ($chief_complaints['history_chief_blurr_unit'] == 'Years') {
                                                echo 'selected';
                                            } ?> value="Years">Years</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3  m-b-5">
                                        <input type="text" placeholder="Comment..."
                                            value="<?php echo $chief_complaints['history_chief_blurr_comm']; ?>"
                                            name="history_chief_blurr_comm" style="width: 100%;">
                                    </div>
                                    <div class="col-md-4  m-b-5">
                                        <div class="btn-group">
                                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['history_chief_blurr_dist'] == 1) {
                                                echo 'checked';
                                            } ?> name="history_chief_blurr_dist"
                                                    id="history_chief_blurr_dist" value="1">Distant</label>
                                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['history_chief_blurr_near'] == 1) {
                                                echo 'checked';
                                            } ?> name="history_chief_blurr_near"
                                                    id="history_chief_blurr_near" value="1">Near</label>
                                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['history_chief_blurr_pain'] == 1) {
                                                echo 'checked';
                                            } ?> name="history_chief_blurr_pain"
                                                    id="history_chief_blurr_pain" value="1">Pain</label>
                                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['history_chief_blurr_ug'] == 1) {
                                                echo 'checked';
                                            } ?> name="history_chief_blurr_ug" id="history_chief_blurr_ug"
                                                    value="1">Using Glasses</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row" id="rednes">
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_rednes_side">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_rednes_side'] == 'Left') {
                                                echo 'selected';
                                            } ?> value="Left">L</option>
                                            <option <?php if ($chief_complaints['history_chief_rednes_side'] == 'Right') {
                                                echo 'selected';
                                            } ?> value="Right">R</option>
                                            <option <?php if ($chief_complaints['history_chief_rednes_side'] == 'Both') {
                                                echo 'selected';
                                            } ?> value="Both">B/E</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1 m-b-5">
                                        <select class="form-control" name="history_chief_rednes_dur">
                                            <option value="">Please Select</option>
                                            <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                <option <?php if ($chief_complaints['history_chief_rednes_dur'] == $i) {
                                                    echo 'selected';
                                                } ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                            <?php } ?>
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_rednes_unit">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_rednes_unit'] == 'Days') {
                                                echo 'selected';
                                            } ?> value="Days">Days</option>
                                            <option <?php if ($chief_complaints['history_chief_rednes_unit'] == 'Weeks') {
                                                echo 'selected';
                                            } ?> value="Weeks">Weeks</option>
                                            <option <?php if ($chief_complaints['history_chief_rednes_unit'] == 'Months') {
                                                echo 'selected';
                                            } ?> value="Months">Months</option>
                                            <option <?php if ($chief_complaints['history_chief_rednes_unit'] == 'Years') {
                                                echo 'selected';
                                            } ?> value="Years">Years</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3  m-b-5">
                                        <input type="text" placeholder="Comment..."
                                            value="<?php echo $chief_complaints['history_chief_rednes_comm']; ?>"
                                            name="history_chief_rednes_comm" style="width: 100%;">
                                    </div>
                                </div>
                                ...
                                <div class="row" id="injuries">
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_injuries_side">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_injuries_side'] == 'Left') {
                                                echo 'selected';
                                            } ?> value="Left">L</option>
                                            <option <?php if ($chief_complaints['history_chief_injuries_side'] == 'Right') {
                                                echo 'selected';
                                            } ?> value="Right">R</option>
                                            <option <?php if ($chief_complaints['history_chief_injuries_side'] == 'Both') {
                                                echo 'selected';
                                            } ?> value="Both">B/E</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1 m-b-5">
                                        <select class="form-control" name="history_chief_injuries_dur">
                                            <option value="">Please Select</option>
                                            <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                <option <?php if ($chief_complaints['history_chief_injuries_dur'] == $i) {
                                                    echo 'selected';
                                                } ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                            <?php } ?>
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_injuries_unit">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_injuries_unit'] == 'Days') {
                                                echo 'selected';
                                            } ?> value="Days">Days</option>
                                            <option <?php if ($chief_complaints['history_chief_injuries_unit'] == 'Weeks') {
                                                echo 'selected';
                                            } ?> value="Weeks">Weeks</option>
                                            <option <?php if ($chief_complaints['history_chief_injuries_unit'] == 'Months') {
                                                echo 'selected';
                                            } ?> value="Months">Months</option>
                                            <option <?php if ($chief_complaints['history_chief_injuries_unit'] == 'Years') {
                                                echo 'selected';
                                            } ?> value="Years">Years</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3  m-b-5">
                                        <input type="text" placeholder="Comment..."
                                            value="<?php echo $chief_complaints['history_chief_injuries_comm']; ?>"
                                            name="history_chief_injuries_comm" style="width: 100%;">
                                    </div>
                                </div>
                                ...
                                <div class="row" id="waterings">
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_waterings_side">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_waterings_side'] == 'Left') {
                                                echo 'selected';
                                            } ?> value="Left">L</option>
                                            <option <?php if ($chief_complaints['history_chief_waterings_side'] == 'Right') {
                                                echo 'selected';
                                            } ?> value="Right">R</option>
                                            <option <?php if ($chief_complaints['history_chief_waterings_side'] == 'Both') {
                                                echo 'selected';
                                            } ?> value="Both">B/E</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1 m-b-5">
                                        <select class="form-control" name="history_chief_waterings_dur">
                                            <option value="">Please Select</option>
                                            <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                <option <?php if ($chief_complaints['history_chief_waterings_dur'] == $i) {
                                                    echo 'selected';
                                                } ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                            <?php } ?>
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_waterings_unit">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_waterings_unit'] == 'Days') {
                                                echo 'selected';
                                            } ?> value="Days">Days</option>
                                            <option <?php if ($chief_complaints['history_chief_waterings_unit'] == 'Weeks') {
                                                echo 'selected';
                                            } ?> value="Weeks">Weeks</option>
                                            <option <?php if ($chief_complaints['history_chief_waterings_unit'] == 'Months') {
                                                echo 'selected';
                                            } ?> value="Months">Months</option>
                                            <option <?php if ($chief_complaints['history_chief_waterings_unit'] == 'Years') {
                                                echo 'selected';
                                            } ?> value="Years">Years</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3  m-b-5">
                                        <input type="text" placeholder="Comment..."
                                            value="<?php echo $chief_complaints['history_chief_waterings_comm']; ?>"
                                            name="history_chief_waterings_comm" style="width: 100%;">
                                    </div>
                                </div>
                                ...
                                <div class="row" id="discharges">
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_discharges_side">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_discharges_side'] == 'Left') {
                                                echo 'selected';
                                            } ?> value="Left">L</option>
                                            <option <?php if ($chief_complaints['history_chief_discharges_side'] == 'Right') {
                                                echo 'selected';
                                            } ?> value="Right">R</option>
                                            <option <?php if ($chief_complaints['history_chief_discharges_side'] == 'Both') {
                                                echo 'selected';
                                            } ?> value="Both">B/E</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1 m-b-5">
                                        <select class="form-control" name="history_chief_discharges_dur">
                                            <option value="">Please Select</option>
                                            <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                <option <?php if ($chief_complaints['history_chief_discharges_dur'] == $i) {
                                                    echo 'selected';
                                                } ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                            <?php } ?>
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_discharges_unit">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_discharges_unit'] == 'Days') {
                                                echo 'selected';
                                            } ?> value="Days">Days</option>
                                            <option <?php if ($chief_complaints['history_chief_discharges_unit'] == 'Weeks') {
                                                echo 'selected';
                                            } ?> value="Weeks">Weeks</option>
                                            <option <?php if ($chief_complaints['history_chief_discharges_unit'] == 'Months') {
                                                echo 'selected';
                                            } ?> value="Months">Months</option>
                                            <option <?php if ($chief_complaints['history_chief_discharges_unit'] == 'Years') {
                                                echo 'selected';
                                            } ?> value="Years">Years</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3  m-b-5">
                                        <input type="text" placeholder="Comment..."
                                            value="<?php echo $chief_complaints['history_chief_discharges_comm']; ?>"
                                            name="history_chief_discharges_comm" style="width: 100%;">
                                    </div>
                                </div>
                                ...
                                <div class="row" id="dryness">
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_dryness_side">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_dryness_side'] == 'Left') {
                                                echo 'selected';
                                            } ?> value="Left">L</option>
                                            <option <?php if ($chief_complaints['history_chief_dryness_side'] == 'Right') {
                                                echo 'selected';
                                            } ?> value="Right">R</option>
                                            <option <?php if ($chief_complaints['history_chief_dryness_side'] == 'Both') {
                                                echo 'selected';
                                            } ?> value="Both">B/E</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1 m-b-5">
                                        <select class="form-control" name="history_chief_dryness_dur">
                                            <option value="">Please Select</option>
                                            <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                <option <?php if ($chief_complaints['history_chief_dryness_dur'] == $i) {
                                                    echo 'selected';
                                                } ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                            <?php } ?>
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_dryness_unit">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_dryness_unit'] == 'Days') {
                                                echo 'selected';
                                            } ?> value="Days">Days</option>
                                            <option <?php if ($chief_complaints['history_chief_dryness_unit'] == 'Weeks') {
                                                echo 'selected';
                                            } ?> value="Weeks">Weeks</option>
                                            <option <?php if ($chief_complaints['history_chief_dryness_unit'] == 'Months') {
                                                echo 'selected';
                                            } ?> value="Months">Months</option>
                                            <option <?php if ($chief_complaints['history_chief_dryness_unit'] == 'Years') {
                                                echo 'selected';
                                            } ?> value="Years">Years</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3  m-b-5">
                                        <input type="text" placeholder="Comment..."
                                            value="<?php echo $chief_complaints['history_chief_dryness_comm']; ?>"
                                            name="history_chief_dryness_comm" style="width: 100%;">
                                    </div>
                                </div>
                                ...
                                <div class="row" id="itchings">
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_itchings_side">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_itchings_side'] == 'Left') {
                                                echo 'selected';
                                            } ?> value="Left">L</option>
                                            <option <?php if ($chief_complaints['history_chief_itchings_side'] == 'Right') {
                                                echo 'selected';
                                            } ?> value="Right">R</option>
                                            <option <?php if ($chief_complaints['history_chief_itchings_side'] == 'Both') {
                                                echo 'selected';
                                            } ?> value="Both">B/E</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1 m-b-5">
                                        <select class="form-control" name="history_chief_itchings_dur">
                                            <option value="">Please Select</option>
                                            <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                <option <?php if ($chief_complaints['history_chief_itchings_dur'] == $i) {
                                                    echo 'selected';
                                                } ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                            <?php } ?>
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_itchings_unit">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_itchings_unit'] == 'Days') {
                                                echo 'selected';
                                            } ?> value="Days">Days</option>
                                            <option <?php if ($chief_complaints['history_chief_itchings_unit'] == 'Weeks') {
                                                echo 'selected';
                                            } ?> value="Weeks">Weeks</option>
                                            <option <?php if ($chief_complaints['history_chief_itchings_unit'] == 'Months') {
                                                echo 'selected';
                                            } ?> value="Months">Months</option>
                                            <option <?php if ($chief_complaints['history_chief_itchings_unit'] == 'Years') {
                                                echo 'selected';
                                            } ?> value="Years">Years</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3  m-b-5">
                                        <input type="text" placeholder="Comment..."
                                            value="<?php echo $chief_complaints['history_chief_itchings_comm']; ?>"
                                            name="history_chief_itchings_comm" style="width: 100%;">
                                    </div>
                                </div>
                                ...
                                <div class="row" id="fbsensation">
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_fbsensation_side">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_fbsensation_side'] == 'Left') {
                                                echo 'selected';
                                            } ?> value="Left">L</option>
                                            <option <?php if ($chief_complaints['history_chief_fbsensation_side'] == 'Right') {
                                                echo 'selected';
                                            } ?> value="Right">R</option>
                                            <option <?php if ($chief_complaints['history_chief_fbsensation_side'] == 'Both') {
                                                echo 'selected';
                                            } ?> value="Both">B/E</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1 m-b-5">
                                        <select class="form-control" name="history_chief_fbsensation_dur">
                                            <option value="">Please Select</option>
                                            <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                <option <?php if ($chief_complaints['history_chief_fbsensation_dur'] == $i) {
                                                    echo 'selected';
                                                } ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                            <?php } ?>
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_fbsensation_unit">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_fbsensation_unit'] == 'Days') {
                                                echo 'selected';
                                            } ?> value="Days">Days</option>
                                            <option <?php if ($chief_complaints['history_chief_fbsensation_unit'] == 'Weeks') {
                                                echo 'selected';
                                            } ?> value="Weeks">Weeks</option>
                                            <option <?php if ($chief_complaints['history_chief_fbsensation_unit'] == 'Months') {
                                                echo 'selected';
                                            } ?> value="Months">Months</option>
                                            <option <?php if ($chief_complaints['history_chief_fbsensation_unit'] == 'Years') {
                                                echo 'selected';
                                            } ?> value="Years">Years</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3  m-b-5">
                                        <input type="text" placeholder="Comment..."
                                            value="<?php echo $chief_complaints['history_chief_fbsensation_comm']; ?>"
                                            name="history_chief_fbsensation_comm" style="width: 100%;">
                                    </div>
                                </div>
                                ...
                                <div class="row" id="dev_squint">
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_dev_squint_side">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_dev_squint_side'] == 'Left') {
                                                echo 'selected';
                                            } ?> value="Left">L</option>
                                            <option <?php if ($chief_complaints['history_chief_dev_squint_side'] == 'Right') {
                                                echo 'selected';
                                            } ?> value="Right">R</option>
                                            <option <?php if ($chief_complaints['history_chief_dev_squint_side'] == 'Both') {
                                                echo 'selected';
                                            } ?> value="Both">B/E</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1 m-b-5">
                                        <select class="form-control" name="history_chief_dev_squint_dur">
                                            <option value="">Please Select</option>
                                            <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                <option <?php if ($chief_complaints['history_chief_dev_squint_dur'] == $i) {
                                                    echo 'selected';
                                                } ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                            <?php } ?>
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_dev_squint_unit">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_dev_squint_unit'] == 'Days') {
                                                echo 'selected';
                                            } ?> value="Days">Days</option>
                                            <option <?php if ($chief_complaints['history_chief_dev_squint_unit'] == 'Weeks') {
                                                echo 'selected';
                                            } ?> value="Weeks">Weeks</option>
                                            <option <?php if ($chief_complaints['history_chief_dev_squint_unit'] == 'Months') {
                                                echo 'selected';
                                            } ?> value="Months">Months</option>
                                            <option <?php if ($chief_complaints['history_chief_dev_squint_unit'] == 'Years') {
                                                echo 'selected';
                                            } ?> value="Years">Years</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3  m-b-5">
                                        <input type="text" placeholder="Comment..."
                                            value="<?php echo $chief_complaints['history_chief_dev_squint_comm']; ?>"
                                            name="history_chief_dev_squint_comm" style="width: 100%;">
                                    </div>
                                    <div class="col-md-4  m-b-5">
                                        <div class="btn-group">

                                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['history_chief_dev_diplopia'] == 1) {
                                                echo 'checked';
                                            } ?> name="history_chief_dev_diplopia"
                                                    id="history_chief_dev_diplopia" value="1">Diplopia</label>

                                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['history_chief_dev_truma'] == 1) {
                                                echo 'checked';
                                            } ?> name="history_chief_dev_truma"
                                                    id="history_chief_dev_truma" value="1">Trauma</label>

                                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['history_chief_dev_ps'] == 1) {
                                                echo 'checked';
                                            } ?> name="history_chief_dev_ps" id="history_chief_dev_ps"
                                                    value="1">Past Surgery</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row" id="head_strain">
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_head_strain_side">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_head_strain_side'] == 'Left') {
                                                echo 'selected';
                                            } ?> value="Left">L</option>
                                            <option <?php if ($chief_complaints['history_chief_head_strain_side'] == 'Right') {
                                                echo 'selected';
                                            } ?> value="Right">R</option>
                                            <option <?php if ($chief_complaints['history_chief_head_strain_side'] == 'Both') {
                                                echo 'selected';
                                            } ?> value="Both">B/E</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1 m-b-5">
                                        <select class="form-control" name="history_chief_head_strain_dur">
                                            <option value="">Please Select</option>
                                            <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                <option <?php if ($chief_complaints['history_chief_head_strain_dur'] == $i) {
                                                    echo 'selected';
                                                } ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                            <?php } ?>
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_head_strain_unit">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_head_strain_unit'] == 'Days') {
                                                echo 'selected';
                                            } ?> value="Days">Days</option>
                                            <option <?php if ($chief_complaints['history_chief_head_strain_unit'] == 'Weeks') {
                                                echo 'selected';
                                            } ?> value="Weeks">Weeks</option>
                                            <option <?php if ($chief_complaints['history_chief_head_strain_unit'] == 'Months') {
                                                echo 'selected';
                                            } ?> value="Months">Months</option>
                                            <option <?php if ($chief_complaints['history_chief_head_strain_unit'] == 'Years') {
                                                echo 'selected';
                                            } ?> value="Years">Years</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3  m-b-5">
                                        <input type="text" placeholder="Comment..."
                                            value="<?php echo $chief_complaints['history_chief_head_strain_comm']; ?>"
                                            name="history_chief_head_strain_comm" style="width: 100%;">
                                    </div>
                                </div>
                                ...
                                <div class="row" id="size_shape">
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_size_shape_side">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_size_shape_side'] == 'Left') {
                                                echo 'selected';
                                            } ?> value="Left">L</option>
                                            <option <?php if ($chief_complaints['history_chief_size_shape_side'] == 'Right') {
                                                echo 'selected';
                                            } ?> value="Right">R</option>
                                            <option <?php if ($chief_complaints['history_chief_size_shape_side'] == 'Both') {
                                                echo 'selected';
                                            } ?> value="Both">B/E</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1 m-b-5">
                                        <select class="form-control" name="history_chief_size_shape_dur">
                                            <option value="">Please Select</option>
                                            <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                <option <?php if ($chief_complaints['history_chief_size_shape_dur'] == $i) {
                                                    echo 'selected';
                                                } ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                            <?php } ?>
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_size_shape_unit">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_size_shape_unit'] == 'Days') {
                                                echo 'selected';
                                            } ?> value="Days">Days</option>
                                            <option <?php if ($chief_complaints['history_chief_size_shape_unit'] == 'Weeks') {
                                                echo 'selected';
                                            } ?> value="Weeks">Weeks</option>
                                            <option <?php if ($chief_complaints['history_chief_size_shape_unit'] == 'Months') {
                                                echo 'selected';
                                            } ?> value="Months">Months</option>
                                            <option <?php if ($chief_complaints['history_chief_size_shape_unit'] == 'Years') {
                                                echo 'selected';
                                            } ?> value="Years">Years</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3  m-b-5">
                                        <input type="text" placeholder="Comment..."
                                            value="<?php echo $chief_complaints['history_chief_size_shape_comm']; ?>"
                                            name="history_chief_size_shape_comm" style="width: 100%;">
                                    </div>
                                </div>
                                ...
                                <div class="row" id="ovs">
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_ovs_side">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_ovs_side'] == 'Left') {
                                                echo 'selected';
                                            } ?> value="Left">L</option>
                                            <option <?php if ($chief_complaints['history_chief_ovs_side'] == 'Right') {
                                                echo 'selected';
                                            } ?> value="Right">R</option>
                                            <option <?php if ($chief_complaints['history_chief_ovs_side'] == 'Both') {
                                                echo 'selected';
                                            } ?> value="Both">B/E</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1 m-b-5">
                                        <select class="form-control" name="history_chief_ovs_dur">
                                            <option value="">Please Select</option>
                                            <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                <option <?php if ($chief_complaints['history_chief_ovs_dur'] == $i) {
                                                    echo 'selected';
                                                } ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                            <?php } ?>
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_ovs_unit">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_ovs_unit'] == 'Days') {
                                                echo 'selected';
                                            } ?> value="Days">Days</option>
                                            <option <?php if ($chief_complaints['history_chief_ovs_unit'] == 'Weeks') {
                                                echo 'selected';
                                            } ?> value="Weeks">Weeks</option>
                                            <option <?php if ($chief_complaints['history_chief_ovs_unit'] == 'Months') {
                                                echo 'selected';
                                            } ?> value="Months">Months</option>
                                            <option <?php if ($chief_complaints['history_chief_ovs_unit'] == 'Years') {
                                                echo 'selected';
                                            } ?> value="Years">Years</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3  m-b-5">
                                        <input type="text" placeholder="Comment..."
                                            value="<?php echo $chief_complaints['history_chief_ovs_comm']; ?>"
                                            name="history_chief_ovs_comm" style="width: 100%;">
                                    </div>
                                    <div class="col-md-4  m-b-5">
                                        <div class="btn-group">
                                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['history_chief_ovs_glare'] == 1) {
                                                echo 'checked';
                                            } ?> name="history_chief_ovs_glare" value="1"
                                                    id="history_chief_ovs_glare">Glare</label>
                                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['history_chief_ovs_floaters'] == 1) {
                                                echo 'checked';
                                            } ?> name="history_chief_ovs_floaters" value="1"
                                                    id="history_chief_ovs_floaters">Floaters</label>
                                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['history_chief_ovs_photophobia'] == 1) {
                                                echo 'checked';
                                            } ?> name="history_chief_ovs_photophobia" value="1"
                                                    id="history_chief_ovs_photophobia">Photophobia</label>
                                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['history_chief_ovs_color_halos'] == 1) {
                                                echo 'checked';
                                            } ?> name="history_chief_ovs_color_halos" value="1"
                                                    id="history_chief_ovs_color_halos">Colored Halos</label>
                                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['history_chief_ovs_metamorphopsia'] == 1) {
                                                echo 'checked';
                                            } ?> name="history_chief_ovs_metamorphopsia" value="1"
                                                    id="history_chief_ovs_metamorphopsia">Metamorphopsia</label>
                                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['history_chief_ovs_chromatopsia'] == 1) {
                                                echo 'checked';
                                            } ?> name="history_chief_ovs_chromatopsia" value="1"
                                                    id="history_chief_ovs_chromatopsia">Chromatopsia</label>
                                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['history_chief_ovs_dnv'] == 1) {
                                                echo 'checked';
                                            } ?> name="history_chief_ovs_dnv" value="1"
                                                    id="history_chief_ovs_dnv">Diminished Night Vision</label>
                                            <label class="btn-custom"><input type="checkbox" <?php if ($chief_complaints['history_chief_ovs_ddv'] == 1) {
                                                echo 'checked';
                                            } ?> name="history_chief_ovs_ddv" value="1"
                                                    id="history_chief_ovs_ddv">Diminished Day Vision</label>
                                ...
                                <div class="row" id="sdiv">
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_sdiv_side">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_sdiv_side'] == 'Left') {
                                                echo 'selected';
                                            } ?> value="Left">L</option>
                                            <option <?php if ($chief_complaints['history_chief_sdiv_side'] == 'Right') {
                                                echo 'selected';
                                            } ?> value="Right">R</option>
                                            <option <?php if ($chief_complaints['history_chief_sdiv_side'] == 'Both') {
                                                echo 'selected';
                                            } ?> value="Both">B/E</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1 m-b-5">
                                        <select class="form-control" name="history_chief_sdiv_dur">
                                            <option value="">Please Select</option>
                                            <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                <option <?php if ($chief_complaints['history_chief_sdiv_dur'] == $i) {
                                                    echo 'selected';
                                                } ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                            <?php } ?>
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_sdiv_unit">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_sdiv_unit'] == 'Days') {
                                                echo 'selected';
                                            } ?> value="Days">Days</option>
                                            <option <?php if ($chief_complaints['history_chief_sdiv_unit'] == 'Weeks') {
                                                echo 'selected';
                                            } ?> value="Weeks">Weeks</option>
                                            <option <?php if ($chief_complaints['history_chief_sdiv_unit'] == 'Months') {
                                                echo 'selected';
                                            } ?> value="Months">Months</option>
                                            <option <?php if ($chief_complaints['history_chief_sdiv_unit'] == 'Years') {
                                                echo 'selected';
                                            } ?> value="Years">Years</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3  m-b-5">
                                        <input type="text" placeholder="Comment..."
                                            value="<?php echo $chief_complaints['history_chief_sdiv_comm']; ?>"
                                            name="history_chief_sdiv_comm" style="width: 100%;">
                                    </div>
                                </div>
                                ...
                                <div class="row" id="doe">
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_doe_side">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_doe_side'] == 'Left') {
                                                echo 'selected';
                                            } ?> value="Left">L</option>
                                            <option <?php if ($chief_complaints['history_chief_doe_side'] == 'Right') {
                                                echo 'selected';
                                            } ?> value="Right">R</option>
                                            <option <?php if ($chief_complaints['history_chief_doe_side'] == 'Both') {
                                                echo 'selected';
                                            } ?> value="Both">B/E</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1 m-b-5">
                                        <select class="form-control" name="history_chief_doe_dur">
                                            <option value="">Please Select</option>
                                            <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                <option <?php if ($chief_complaints['history_chief_doe_dur'] == $i) {
                                                    echo 'selected';
                                                } ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                            <?php } ?>
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_doe_unit">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_doe_unit'] == 'Days') {
                                                echo 'selected';
                                            } ?> value="Days">Days</option>
                                            <option <?php if ($chief_complaints['history_chief_doe_unit'] == 'Weeks') {
                                                echo 'selected';
                                            } ?> value="Weeks">Weeks</option>
                                            <option <?php if ($chief_complaints['history_chief_doe_unit'] == 'Months') {
                                                echo 'selected';
                                            } ?> value="Months">Months</option>
                                            <option <?php if ($chief_complaints['history_chief_doe_unit'] == 'Years') {
                                                echo 'selected';
                                            } ?> value="Years">Years</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3  m-b-5">
                                        <input type="text" placeholder="Comment..."
                                            value="<?php echo $chief_complaints['history_chief_doe_comm']; ?>"
                                            name="history_chief_doe_comm" style="width: 100%;">
                                    </div>
                                </div>
                                ...
                                <div class="row" id="swell">
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_swell_side">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_swell_side'] == 'Left') {
                                                echo 'selected';
                                            } ?> value="Left">L</option>
                                            <option <?php if ($chief_complaints['history_chief_swell_side'] == 'Right') {
                                                echo 'selected';
                                            } ?> value="Right">R</option>
                                            <option <?php if ($chief_complaints['history_chief_swell_side'] == 'Both') {
                                                echo 'selected';
                                            } ?> value="Both">B/E</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1 m-b-5">
                                        <select class="form-control" name="history_chief_swell_dur">
                                            <option value="">Please Select</option>
                                            <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                <option <?php if ($chief_complaints['history_chief_swell_dur'] == $i) {
                                                    echo 'selected';
                                                } ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                            <?php } ?>
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_swell_unit">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_swell_unit'] == 'Days') {
                                                echo 'selected';
                                            } ?> value="Days">Days</option>
                                            <option <?php if ($chief_complaints['history_chief_swell_unit'] == 'Weeks') {
                                                echo 'selected';
                                            } ?> value="Weeks">Weeks</option>
                                            <option <?php if ($chief_complaints['history_chief_swell_unit'] == 'Months') {
                                                echo 'selected';
                                            } ?> value="Months">Months</option>
                                            <option <?php if ($chief_complaints['history_chief_swell_unit'] == 'Years') {
                                                echo 'selected';
                                            } ?> value="Years">Years</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3  m-b-5">
                                        <input type="text" placeholder="Comment..."
                                            value="<?php echo $chief_complaints['history_chief_swell_comm']; ?>"
                                            name="history_chief_swell_comm" style="width: 100%;">
                                    </div>
                                </div>
                                ...
                                <div class="row" id="sen_burn">
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_sen_burn_side">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_sen_burn_side'] == 'Left') {
                                                echo 'selected';
                                            } ?> value="Left">L</option>
                                            <option <?php if ($chief_complaints['history_chief_sen_burn_side'] == 'Right') {
                                                echo 'selected';
                                            } ?> value="Right">R</option>
                                            <option <?php if ($chief_complaints['history_chief_sen_burn_side'] == 'Both') {
                                                echo 'selected';
                                            } ?> value="Both">B/E</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1 m-b-5">
                                        <select class="form-control" name="history_chief_sen_burn_dur">
                                            <option value="">Please Select</option>
                                            <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                <option <?php if ($chief_complaints['history_chief_sen_burn_dur'] == $i) {
                                                    echo 'selected';
                                                } ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                            <?php } ?>
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_sen_burn_unit">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_sen_burn_unit'] == 'Days') {
                                                echo 'selected';
                                            } ?> value="Days">Days</option>
                                            <option <?php if ($chief_complaints['history_chief_sen_burn_unit'] == 'Weeks') {
                                                echo 'selected';
                                            } ?> value="Weeks">Weeks</option>
                                            <option <?php if ($chief_complaints['history_chief_sen_burn_unit'] == 'Months') {
                                                echo 'selected';
                                            } ?> value="Months">Months</option>
                                            <option <?php if ($chief_complaints['history_chief_sen_burn_unit'] == 'Years') {
                                                echo 'selected';
                                            } ?> value="Years">Years</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3  m-b-5">
                                        <input type="text" placeholder="Comment..."
                                            value="<?php echo $chief_complaints['history_chief_sen_burn_comm']; ?>"
                                            name="history_chief_sen_burn_comm" style="width: 100%;">
                                    </div>
                                </div>
                                <div class="row" id="sx_ptosis">
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_ptosis_side">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_ptosis_side'] == 'Left') {
                                                echo 'selected';
                                            } ?> value="Left">L</option>
                                            <option <?php if ($chief_complaints['history_chief_ptosis_side'] == 'Right') {
                                                echo 'selected';
                                            } ?> value="Right">R</option>
                                            <option <?php if ($chief_complaints['history_chief_ptosis_side'] == 'Both') {
                                                echo 'selected';
                                            } ?> value="Both">B/E</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1 m-b-5">
                                        <select class="form-control" name="history_chief_ptosis_dur">
                                            <option value="">Please Select</option>
                                            <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                <option <?php if ($chief_complaints['history_chief_ptosis_dur'] == $i) {
                                                    echo 'selected';
                                                } ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                            <?php } ?>
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_ptosis_unit">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_ptosis_unit'] == 'Days') {
                                                echo 'selected';
                                            } ?> value="Days">Days</option>
                                            <option <?php if ($chief_complaints['history_chief_ptosis_unit'] == 'Weeks') {
                                                echo 'selected';
                                            } ?> value="Weeks">Weeks</option>
                                            <option <?php if ($chief_complaints['history_chief_ptosis_unit'] == 'Months') {
                                                echo 'selected';
                                            } ?> value="Months">Months</option>
                                            <option <?php if ($chief_complaints['history_chief_ptosis_unit'] == 'Years') {
                                                echo 'selected';
                                            } ?> value="Years">Years</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3  m-b-5">
                                        <input type="text" placeholder="Comment..."
                                            value="<?php echo $chief_complaints['history_chief_ptosis_comm']; ?>"
                                            name="history_chief_ptosis_comm" style="width: 100%;">
                                    </div>
                                </div>
                                <div class="row" id="sx_lid">
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_lid_sx_side">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_lid_sx_side'] == 'Left') {
                                                echo 'selected';
                                            } ?> value="Left">L</option>
                                            <option <?php if ($chief_complaints['history_chief_lid_sx_side'] == 'Right') {
                                                echo 'selected';
                                            } ?> value="Right">R</option>
                                            <option <?php if ($chief_complaints['history_chief_lid_sx_side'] == 'Both') {
                                                echo 'selected';
                                            } ?> value="Both">B/E</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1 m-b-5">
                                        <select class="form-control" name="history_chief_lid_sx_dur">
                                            <option value="">Please Select</option>
                                            <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                <option <?php if ($chief_complaints['history_chief_lid_sx_dur'] == $i) {
                                                    echo 'selected';
                                                } ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                            <?php } ?>
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_lid_sx_unit">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_lid_sx_unit'] == 'Days') {
                                                echo 'selected';
                                            } ?> value="Days">Days</option>
                                            <option <?php if ($chief_complaints['history_chief_lid_sx_unit'] == 'Weeks') {
                                                echo 'selected';
                                            } ?> value="Weeks">Weeks</option>
                                            <option <?php if ($chief_complaints['history_chief_lid_sx_unit'] == 'Months') {
                                                echo 'selected';
                                            } ?> value="Months">Months</option>
                                            <option <?php if ($chief_complaints['history_chieflid_sx_unit'] == 'Years') {
                                                echo 'selected';
                                            } ?> value="Years">Years</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3  m-b-5">
                                        <input type="text" placeholder="Comment..."
                                            value="<?php echo $chief_complaints['history_chief_lid_sx_comm']; ?>"
                                            name="history_chieflid_sx_comm" style="width: 100%;">
                                    </div>
                                </div>
                                <div class="row" id="sx_corneal">
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_corneal_sx_side">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_corneal_sx_side'] == 'Left') {
                                                echo 'selected';
                                            } ?> value="Left">L</option>
                                            <option <?php if ($chief_complaints['history_chief_corneal_sx_side'] == 'Right') {
                                                echo 'selected';
                                            } ?> value="Right">R</option>
                                            <option <?php if ($chief_complaints['history_chief_corneal_sx_side'] == 'Both') {
                                                echo 'selected';
                                            } ?> value="Both">B/E</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1 m-b-5">
                                        <select class="form-control" name="history_chief_corneal_sx_dur">
                                            <option value="">Please Select</option>
                                            <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                <option <?php if ($chief_complaints['history_chief_corneal_sx_dur'] == $i) {
                                                    echo 'selected';
                                                } ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                            <?php } ?>
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_sen_cornel_sx_unit">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_sen_corneal_sx_unit'] == 'Days') {
                                                echo 'selected';
                                            } ?> value="Days">Days</option>
                                            <option <?php if ($chief_complaints['history_chief_sen_corneal_sx_unit'] == 'Weeks') {
                                                echo 'selected';
                                            } ?> value="Weeks">Weeks</option>
                                            <option <?php if ($chief_complaints['history_chief_sen_corneal_sx_unit'] == 'Months') {
                                                echo 'selected';
                                            } ?> value="Months">Months</option>
                                            <option <?php if ($chief_complaints['history_chief_sen_corneal_sx_unit'] == 'Years') {
                                                echo 'selected';
                                            } ?> value="Years">Years</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3  m-b-5">
                                        <input type="text" placeholder="Comment..."
                                            value="<?php echo $chief_complaints['history_chief_corneal_sx_comm']; ?>"
                                            name="history_chief_corneal_sx_comm" style="width: 100%;">
                                    </div>
                                </div>
                                ...
                                <div class="row" id="sx_cataract">
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_cataract_sx_side">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_cataract_sx_side'] == 'Left') {
                                                echo 'selected';
                                            } ?> value="Left">L</option>
                                            <option <?php if ($chief_complaints['history_chief_cataract_sx_side'] == 'Right') {
                                                echo 'selected';
                                            } ?> value="Right">R</option>
                                            <option <?php if ($chief_complaints['history_chief_cataract_sx_side'] == 'Both') {
                                                echo 'selected';
                                            } ?> value="Both">B/E</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1 m-b-5">
                                        <select class="form-control" name="history_chief_cataract_sx_dur">
                                            <option value="">Please Select</option>
                                            <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                <option <?php if ($chief_complaints['history_chief_cataract_sx_dur'] == $i) {
                                                    echo 'selected';
                                                } ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                            <?php } ?>
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_cataract_sx_unit">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_cataract_sx_unit'] == 'Days') {
                                                echo 'selected';
                                            } ?> value="Days">Days</option>
                                            <option <?php if ($chief_complaints['history_chief_cataract_sx_unit'] == 'Weeks') {
                                                echo 'selected';
                                            } ?> value="Weeks">Weeks</option>
                                            <option <?php if ($chief_complaints['history_chief_cataract_sx_unit'] == 'Months') {
                                                echo 'selected';
                                            } ?> value="Months">Months</option>
                                            <option <?php if ($chief_complaints['history_chief_cataract_sx_unit'] == 'Years') {
                                                echo 'selected';
                                            } ?> value="Years">Years</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3  m-b-5">
                                        <input type="text" placeholder="Comment..."
                                            value="<?php echo $chief_complaints['history_chief_cataract_sx_comm']; ?>"
                                            name="history_chief_cataract_sx_comm" style="width: 100%;">
                                    </div>
                                </div>
                                <div class="row" id="sx_squint">
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_squint_sx_side">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_squint_sx_side'] == 'Left') {
                                                echo 'selected';
                                            } ?> value="Left">L</option>
                                            <option <?php if ($chief_complaints['history_chief_squint_sx_side'] == 'Right') {
                                                echo 'selected';
                                            } ?> value="Right">R</option>
                                            <option <?php if ($chief_complaints['history_chief_squint_sx_side'] == 'Both') {
                                                echo 'selected';
                                            } ?> value="Both">B/E</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1 m-b-5">
                                        <select class="form-control" name="history_chief_squint_sx_dur">
                                            <option value="">Please Select</option>
                                            <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                <option <?php if ($chief_complaints['history_chief_squint_sx_dur'] == $i) {
                                                    echo 'selected';
                                                } ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                            <?php } ?>
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_squint_sx_unit">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_squint_sx_unit'] == 'Days') {
                                                echo 'selected';
                                            } ?> value="Days">Days</option>
                                            <option <?php if ($chief_complaints['history_chief_squint_sx_unit'] == 'Weeks') {
                                                echo 'selected';
                                            } ?> value="Weeks">Weeks</option>
                                            <option <?php if ($chief_complaints['history_chief_squint_sx_unit'] == 'Months') {
                                                echo 'selected';
                                            } ?> value="Months">Months</option>
                                            <option <?php if ($chief_complaints['history_chief_squint_sx_unit'] == 'Years') {
                                                echo 'selected';
                                            } ?> value="Years">Years</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3  m-b-5">
                                        <input type="text" placeholder="Comment..."
                                            value="<?php echo $chief_complaints['history_chief_squint_sx_comm']; ?>"
                                            name="history_chief_squint_sx_comm" style="width: 100%;">
                                    </div>
                                </div>
                                <div class="row" id="sx_pterygium">
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_pterygium_sx_side">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_pterygium_sx_side'] == 'Left') {
                                                echo 'selected';
                                            } ?> value="Left">L</option>
                                            <option <?php if ($chief_complaints['history_chief_pterygium_sx_side'] == 'Right') {
                                                echo 'selected';
                                            } ?> value="Right">R</option>
                                            <option <?php if ($chief_complaints['history_chief_pterygium_sx_side'] == 'Both') {
                                                echo 'selected';
                                            } ?> value="Both">B/E</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1 m-b-5">
                                        <select class="form-control" name="history_chief_squint_sx_dur">
                                            <option value="">Please Select</option>
                                            <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                <option <?php if ($chief_complaints['history_chief_pterygium_sx_dur'] == $i) {
                                                    echo 'selected';
                                                } ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                            <?php } ?>
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_pterygium_sx_unit">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_pterygium_sx_unit'] == 'Days') {
                                                echo 'selected';
                                            } ?> value="Days">Days</option>
                                            <option <?php if ($chief_complaints['history_chief_pterygium_sx_unit'] == 'Weeks') {
                                                echo 'selected';
                                            } ?> value="Weeks">Weeks</option>
                                            <option <?php if ($chief_complaints['history_chief_pterygium_sx_unit'] == 'Months') {
                                                echo 'selected';
                                            } ?> value="Months">Months</option>
                                            <option <?php if ($chief_complaints['history_chief_pterygium_sx_unit'] == 'Years') {
                                                echo 'selected';
                                            } ?> value="Years">Years</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3  m-b-5">
                                        <input type="text" placeholder="Comment..."
                                            value="<?php echo $chief_complaints['history_chief_pterygium_sx_comm']; ?>"
                                            name="history_chief_pterygium_sx_comm" style="width: 100%;">
                                    </div>
                                </div>
                                <div class="row" id="sx_dcr">
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_dcr_sx_side">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_dcr_sx_side'] == 'Left') {
                                                echo 'selected';
                                            } ?> value="Left">L</option>
                                            <option <?php if ($chief_complaints['history_chief_dcr_sx_side'] == 'Right') {
                                                echo 'selected';
                                            } ?> value="Right">R</option>
                                            <option <?php if ($chief_complaints['history_chief_dcr_sx_side'] == 'Both') {
                                                echo 'selected';
                                            } ?> value="Both">B/E</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1 m-b-5">
                                        <select class="form-control" name="history_chief_dcr_sx_dur">
                                            <option value="">Please Select</option>
                                            <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                <option <?php if ($chief_complaints['history_chief_dcr_sx_dur'] == $i) {
                                                    echo 'selected';
                                                } ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                            <?php } ?>
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_dcr_sx_unit">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_dcr_sx_unit'] == 'Days') {
                                                echo 'selected';
                                            } ?> value="Days">Days</option>
                                            <option <?php if ($chief_complaints['history_chief_dcr_sx_unit'] == 'Weeks') {
                                                echo 'selected';
                                            } ?> value="Weeks">Weeks</option>
                                            <option <?php if ($chief_complaints['history_chief_dcr_sx_unit'] == 'Months') {
                                                echo 'selected';
                                            } ?> value="Months">Months</option>
                                            <option <?php if ($chief_complaints['history_chief_dcr_sx_unit'] == 'Years') {
                                                echo 'selected';
                                            } ?> value="Years">Years</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3  m-b-5">
                                        <input type="text" placeholder="Comment..."
                                            value="<?php echo $chief_complaints['history_chief_dcr_sx_comm']; ?>"
                                            name="history_chief_dcr_sx_comm" style="width: 100%;">
                                    </div>
                                </div>
                                <div class="row" id="sx_dct">
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_dct_sx_side">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_dct_sx_side'] == 'Left') {
                                                echo 'selected';
                                            } ?> value="Left">L</option>
                                            <option <?php if ($chief_complaints['history_chief_dct_sx_side'] == 'Right') {
                                                echo 'selected';
                                            } ?> value="Right">R</option>
                                            <option <?php if ($chief_complaints['history_chief_dct_sx_side'] == 'Both') {
                                                echo 'selected';
                                            } ?> value="Both">B/E</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1 m-b-5">
                                        <select class="form-control" name="history_chief_dct_sx_dur">
                                            <option value="">Please Select</option>
                                            <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                <option <?php if ($chief_complaints['history_chief_dct_sx_dur'] == $i) {
                                                    echo 'selected';
                                                } ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                            <?php } ?>
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_dcy_sx_unit">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_dct_sx_unit'] == 'Days') {
                                                echo 'selected';
                                            } ?> value="Days">Days</option>
                                            <option <?php if ($chief_complaints['history_chief_dct_sx_unit'] == 'Weeks') {
                                                echo 'selected';
                                            } ?> value="Weeks">Weeks</option>
                                            <option <?php if ($chief_complaints['history_chief_dct_sx_unit'] == 'Months') {
                                                echo 'selected';
                                            } ?> value="Months">Months</option>
                                            <option <?php if ($chief_complaints['history_chief_dct_sx_unit'] == 'Years') {
                                                echo 'selected';
                                            } ?> value="Years">Years</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3  m-b-5">
                                        <input type="text" placeholder="Comment..."
                                            value="<?php echo $chief_complaints['history_chief_dct_sx_comm']; ?>"
                                            name="history_chief_dct_sx_comm" style="width: 100%;">
                                    </div>
                                </div>
                                <div class="row" id="sx_patching_therapy">
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_patching_therapy_sx_side">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_patching_therapy_sx_side'] == 'Left') {
                                                echo 'selected';
                                            } ?> value="Left">L</option>
                                            <option <?php if ($chief_complaints['history_chief_patching_therapy_sx_side'] == 'Right') {
                                                echo 'selected';
                                            } ?> value="Right">R</option>
                                            <option <?php if ($chief_complaints['history_chief_patching_therapy_sx_side'] == 'Both') {
                                                echo 'selected';
                                            } ?> value="Both">B/E</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1 m-b-5">
                                        <select class="form-control" name="history_chief_patching_therapy_sx_dur">
                                            <option value="">Please Select</option>
                                            <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                <option <?php if ($chief_complaints['history_chief_patching_therapy_sx_dur'] == $i) {
                                                    echo 'selected';
                                                } ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                            <?php } ?>
                                    ...
                                    <div class="col-md-1  m-b-5">
                                        <select class="form-control" name="history_chief_dcy_sx_unit">
                                            <option value="">Please Select</option>
                                            <option <?php if ($chief_complaints['history_chief_patching_therapy_sx_unit'] == 'Days') {
                                                echo 'selected';
                                            } ?> value="Days">Days</option>
                                            <option <?php if ($chief_complaints['history_chief_patching_therapy_sx_unit'] == 'Weeks') {
                                                echo 'selected';
                                            } ?> value="Weeks">Weeks</option>
                                            <option <?php if ($chief_complaints['history_chief_patching_therapy_sx_unit'] == 'Months') {
                                                echo 'selected';
                                            } ?> value="Months">Months</option>
                                            <option <?php if ($chief_complaints['history_chief_patching_therapy_sx_unit'] == 'Years') {
                                                echo 'selected';
                                            } ?> value="Years">Years</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3  m-b-5">
                                        <input type="text" placeholder="Comment..."
                                            value="<?php echo $chief_complaints['history_chief_patching_therapy_sx_comm']; ?>"
                                            name="history_chief_patching_therapy_sx_comm" style="width: 100%;">
                                    </div>
                                </div>
                            </section>
                            <section>
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea class="form-control w-100"
                                            name="history_chief_comm"><?php echo $chief_complaints['history_chief_comm']; ?></textarea>
                                    </div>
                                </div>
                            </section>
                            <div class="grp " style="margin-top:15px;">
                                ...
                                <div class="box-right" style="margin-left: 45px;">
                                    <input type="text" name="ocular_history" class="txt_firstCap input-height"
                                        id="ocular_history"
                                        value="<?php echo isset($form_data['ocular_history']) ? htmlspecialchars($form_data['ocular_history']) : ''; ?>"
                                        style="width: 374px;" />
                            ...
                            <div class="grp" style="">
                                ...
                                <div class="box-right" style="margin-left: 45px;">
                                    <input type="text" name="medical_history" class="txt_firstCap input-height"
                                        id="medical_history"
                                        value="<?php echo isset($form_data['medical_history']) ? htmlspecialchars($form_data['medical_history']) : ''; ?>"
                                        style="width: 374px;" />
                        ...
                        <section style="padding-left:15px;">
                            ...
                            <div class="grp" style="">
                                ...
                                <div class="box-right" style="margin-left: 45px;">
                                    ...
                                    <input type="text" name="no_of_child" class="txt_firstCap input-height"
                                        id="no_of_child"
                                        value="<?php echo isset($form_data['no_of_child']) ? htmlspecialchars($form_data['no_of_child']) : ''; ?>"
                                        style="width: 374px;" />
                            ...
                            <div class="grp" style="">
                                ...
                                <div class="box-right" >
                                    <select name="delivery_type" id="delivery_type"
                                        class="m_input_default select-height" style="margin-left: 45px;">
                                        <option value="">Select Delivery Type</option>
                                        <option value="full_term" <?php echo isset($form_data['delivery_type']) && $form_data['delivery_type'] == 'full_term' ? 'selected="selected"' : ''; ?>>
                                            Full Term</option>
                                        <option value="preterm" <?php echo isset($form_data['delivery_type']) && $form_data['delivery_type'] == 'preterm' ? 'selected="selected"' : ''; ?>>
                                            Preterm</option>
                                        <option value="premature" <?php echo isset($form_data['delivery_type']) && $form_data['delivery_type'] == 'premature' ? 'selected="selected"' : ''; ?>>
                                            Premature</option>
                                        <option value="normal" <?php echo isset($form_data['delivery_type']) && $form_data['delivery_type'] == 'normal' ? 'selected="selected"' : ''; ?>>
                                            Normal</option>
                                        <option value="cesarian" <?php echo isset($form_data['delivery_type']) && $form_data['delivery_type'] == 'cesarian' ? 'selected="selected"' : ''; ?>>
                                            Cesarian Delivery</option>
                                    </select>
                                    <?php
                            ...
                            <div class="grp">
                                ...
                                <div class="box-right" style="margin-left: 45px;">
                                    <input type="text" name="birth_weight" class="txt_firstCap input-height"
                                        id="birth_weight"
                                        value="<?php echo isset($form_data['birth_weight']) ? htmlspecialchars($form_data['birth_weight']) : ''; ?>"
                                        style="width: 374px;" />
                            ...
                            <div class="grp">
                                ...
                                <div class="box-right" style="margin-left: 45px;">
                                    <input type="text" name="recent_weight" class="txt_firstCap input-height"
                                        id="recent_weight"
                                        value="<?php echo isset($form_data['recent_weight']) ? htmlspecialchars($form_data['recent_weight']) : ''; ?>"
                                        style="width: 374px;" />
                            ...
                            <div class="grp">
                                ...
                                <div class="box-right" style="margin-left: 45px;">
                                    <input type="text" name="birth_asphyxia" class="txt_firstCap input-height"
                                        id="birth_asphyxia"
                                        value="<?php echo isset($form_data['birth_asphyxia']) ? htmlspecialchars($form_data['birth_asphyxia']) : ''; ?>"
                                        style="width: 374px;" />
                            ...
                            <div class="grp">
                                ...
                                <div class="box-right">
                                    <select name="cried_after_birth" id="cried_after_birth"
                                        class="m_input_default select-height" style="margin-left: 45px;">
                                        <option value="">Select Yes/No</option>
                                        <option value="yes" <?php echo isset($form_data['cried_after_birth']) && $form_data['cried_after_birth'] == 'yes' ? 'selected="selected"' : ''; ?>>Yes
                                        </option>
                                        <option value="no" <?php echo isset($form_data['cried_after_birth']) && $form_data['cried_after_birth'] == 'no' ? 'selected="selected"' : ''; ?>>No
                                        </option>
                                    </select>
                            ...
                            <div class="grp">
                                ...
                                <div class="box-right">
                                    <select name="infection_history" id="infection_history"
                                        class="m_input_default select-height" style="margin-left: 45px;">
                                        <option value="">Select Infection History</option>
                                        <option value="pre" <?php echo isset($form_data['infection_history']) && $form_data['infection_history'] == 'pre' ? 'selected="selected"' : ''; ?>>Pre
                                        </option>
                                        <option value="peri" <?php echo isset($form_data['infection_history']) && $form_data['infection_history'] == 'peri' ? 'selected="selected"' : ''; ?>>
                                            Peri</option>
                                        <option value="post" <?php echo isset($form_data['infection_history']) && $form_data['infection_history'] == 'post' ? 'selected="selected"' : ''; ?>>
                                            Postnatal</option>
                                    </select>
                            ...
                            <div class="grp">
                                ...
                                <div class="box-right">
                                    <select name="milestone" id="milestone" class="m_input_default select-height" style="margin-left: 45px;">
                                        <option value="">Select Milestone</option>
                                        <option value="normal" <?php echo isset($form_data['milestone']) && $form_data['milestone'] == 'normal' ? 'selected="selected"' : ''; ?>>Normal
                                        </option>
                                        <option value="delayed" <?php echo isset($form_data['milestone']) && $form_data['milestone'] == 'delayed' ? 'selected="selected"' : ''; ?>>Delayed
                                        </option>
                            ...
                            <div class="grp">
                                ...
                                <div class="box-right">
                                    <select name="convulsion_history" id="convulsion_history"
                                        class="m_input_default select-height" style="margin-left: 45px;">
                                        <option value="">Select Convulsion History</option>
                                        <option value="yes" <?php echo isset($form_data['convulsion_history']) && $form_data['convulsion_history'] == 'yes' ? 'selected="selected"' : ''; ?>>Yes
                                        </option>
                                        <option value="no" <?php echo isset($form_data['convulsion_history']) && $form_data['convulsion_history'] == 'no' ? 'selected="selected"' : ''; ?>>No
                                        </option>
                                    </select>
                            ...
                            <div class="grp">
                                ...
                                <div class="box-right" style="margin-left: 45px;">
                                    <input type="text" name="consanguinity_history" class="txt_firstCap input-height"
                                        id="consanguinity_history"
                                        value="<?php echo isset($form_data['consanguinity_history']) ? htmlspecialchars($form_data['consanguinity_history']) : ''; ?>"
                                        style="width: 374px;" />
                        ...
                        <section>
                            ...
                            <div class="btn-group">
                                <label class="btn-custom"><input type="checkbox" <?php if ($squint_history['inward'] == 1) {
                                    echo 'checked';
                                } ?> name="inward" value="1"
                                        id="inward"> Inward Deviation</label>
                                <label class="btn-custom"><input type="checkbox" <?php if ($squint_history['outward'] == 1) {
                                    echo 'checked';
                                } ?> name="outward" value="1"
                                        id="outward"> Outward Deviation</label>
                                <label class="btn-custom"><input type="checkbox" <?php if ($squint_history['upward'] == 1) {
                                    echo 'checked';
                                } ?> name="upward" value="1"
                                        id="upward"> Upward/Downward</label>
                                <label class="btn-custom"><input type="checkbox" <?php if ($squint_history['prev_squint'] == 1) {
                                    echo 'checked';
                                } ?> name="prev_squint"
                                        value="1" id="prev_squint"> Prev.H/O Squint/Other Surgery</label>
                                <label class="btn-custom"><input type="checkbox" <?php if ($squint_history['double_vision'] == 1) {
                                    echo 'checked';
                                } ?> name="double_vision"
                                        value="1" id="double_vision"> H/O Double Vision</label>
                                <label class="btn-custom"><input type="checkbox" <?php if ($squint_history['constant'] == 1) {
                                    echo 'checked';
                                } ?> name="constant" value="1"
                                        id="constant"> Constant/Occassional/Intermittently</label>
                                <label class="btn-custom"><input type="checkbox" <?php if ($squint_history['antisupression'] == 1) {
                                    echo 'checked';
                                } ?>
                                        name="antisupression" value="1" id="antisupression"> H/O Waering
                                    Glasses/Patching Therapy/Antisupression</label>
                            </div>
                            ...
                            <label>Options</label>
                                        ...
                                        <div class="row" id="inward1">
                                            ...
                                            <div class="col-md-2  m-b-5">
                                                <select class="form-control" name="history_chief_inward_side">
                                                    <option value="">Please Select</option>
                                                    <option <?php if ($squint_history['history_chief_inward_side'] == 'Left') {
                                                        echo 'selected';
                                                    } ?> value="Left">L</option>
                                                    <option <?php if ($squint_history['history_chief_inward_side'] == 'Right') {
                                                        echo 'selected';
                                                    } ?> value="Right">R</option>
                                                    <option <?php if ($squint_history['history_chief_inward_side'] == 'Both') {
                                                        echo 'selected';
                                                    } ?> value="Both">B/E</option>
                                                </select>
                                            </div>
                                            <div class="col-md-2 m-b-5">
                                                <select class="form-control" name="history_chief_inward_dur">
                                                    <option value="">Please Select</option>
                                                    <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                        <option <?php if ($squint_history['history_chief_inward_dur'] == $i) {
                                                            echo 'selected';
                                            ...
                                            <div class="col-md-3  m-b-5">
                                                <select class="form-control" name="history_chief_inward_unit">
                                                    <option value="">Please Select</option>
                                                    <option <?php if ($squint_history['history_chief_inward_unit'] == 'Days') {
                                                        echo 'selected';
                                                    } ?> value="Days">Days</option>
                                                    <option <?php if ($squint_history['history_chief_inward_unit'] == 'Weeks') {
                                                        echo 'selected';
                                                    } ?> value="Weeks">Weeks</option>
                                                    <option <?php if ($squint_history['history_chief_inward_unit'] == 'Months') {
                                                        echo 'selected';
                                                    } ?> value="Months">Months</option>
                                                    <option <?php if ($squint_history['history_chief_inward_unit'] == 'Years') {
                                                        echo 'selected';
                                                    } ?> value="Years">Years</option>
                                                </select>
                                            </div>
                                            <div class="col-md-3  m-b-5" style="width:9px !important;">
                                                <input type="text" placeholder="Comment..."
                                                    value="<?php echo $squint_history['history_chief_inward_comm']; ?>"
                                                    name="history_chief_inward_comm"
                                                    style="width: 263px;margin-left:3px;">
                                            </div>
                                        </div>
                                        <div class="row" id="outward1">
                                            ...
                                            <div class="col-md-2  m-b-5">
                                                <select class="form-control" name="history_chief_outward_side">
                                                    <option value="">Please Select</option>
                                                    <option <?php if ($squint_history['history_chief_outward_side'] == 'Left') {
                                                        echo 'selected';
                                                    } ?> value="Left">L</option>
                                                    <option <?php if ($squint_history['history_chief_outward_side'] == 'Right') {
                                                        echo 'selected';
                                                    } ?> value="Right">R</option>
                                                    <option <?php if ($squint_history['history_chief_outward_side'] == 'Both') {
                                                        echo 'selected';
                                                    } ?> value="Both">B/E</option>
                                                </select>
                                            </div>
                                            <div class="col-md-2 m-b-5">
                                                <select class="form-control" name="history_chief_outward_dur">
                                                    <option value="">Please Select</option>
                                                    <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                        <option <?php if ($squint_history['history_chief_outward_dur'] == $i) {
                                                            echo 'selected';
                                                        } ?> value="<?php echo $i; ?>"><?php echo $i; ?>
                                                        </option>
                                                    <?php } ?>
                                            ...
                                            <div class="col-md-3  m-b-5">
                                                <select class="form-control" name="history_chief_outward_unit">
                                                    <option value="">Please Select</option>
                                                    <option <?php if ($squint_history['history_chief_outward_unit'] == 'Days') {
                                                        echo 'selected';
                                                    } ?> value="Days">Days</option>
                                                    <option <?php if ($squint_history['history_chief_outward_unit'] == 'Weeks') {
                                                        echo 'selected';
                                                    } ?> value="Weeks">Weeks</option>
                                                    <option <?php if ($squint_history['history_chief_outward_unit'] == 'Months') {
                                                        echo 'selected';
                                                    } ?> value="Months">Months</option>
                                                    <option <?php if ($squint_history['history_chief_outward_unit'] == 'Years') {
                                                        echo 'selected';
                                                    } ?> value="Years">Years</option>
                                                </select>
                                            </div>
                                            <div class="col-md-3  m-b-5" style="width:9px !important;">
                                                <input type="text" placeholder="Comment..."
                                                    value="<?php echo $squint_history['history_chief_outward_comm']; ?>"
                                                    name="history_chief_outward_comm"
                                                    style="width: 263px;margin-left:3px;">
                                            </div>
                                        </div>
                                        <div class="row" id="upward1">
                                            ...
                                            <div class="col-md-2  m-b-5">
                                                <select class="form-control" name="history_chief_upward_side">
                                                    <option value="">Please Select</option>
                                                    <option <?php if ($squint_history['history_chief_upward_side'] == 'Left') {
                                                        echo 'selected';
                                                    } ?> value="Left">L</option>
                                                    <option <?php if ($squint_history['history_chief_upward_side'] == 'Right') {
                                                        echo 'selected';
                                                    } ?> value="Right">R</option>
                                                    <option <?php if ($squint_history['history_chief_upward_side'] == 'Both') {
                                                        echo 'selected';
                                                    } ?> value="Both">B/E</option>
                                                </select>
                                            </div>
                                            <div class="col-md-2 m-b-5">
                                                <select class="form-control" name="history_chief_upward_dur">
                                                    <option value="">Please Select</option>
                                                    <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                        <option <?php if ($squint_history['history_chief_upward_dur'] == $i) {
                                                            echo 'selected';
                                                        } ?> value="<?php echo $i; ?>"><?php echo $i; ?>
                                                        </option>
                                                    <?php } ?>
                                            ...
                                            <div class="col-md-3  m-b-5">
                                                <select class="form-control" name="history_chief_upward_unit">
                                                    <option value="">Please Select</option>
                                                    <option <?php if ($squint_history['history_chief_upward_unit'] == 'Days') {
                                                        echo 'selected';
                                                    } ?> value="Days">Days</option>
                                                    <option <?php if ($squint_history['history_chief_upward_unit'] == 'Weeks') {
                                                        echo 'selected';
                                                    } ?> value="Weeks">Weeks</option>
                                                    <option <?php if ($squint_history['history_chief_upward_unit'] == 'Months') {
                                                        echo 'selected';
                                                    } ?> value="Months">Months</option>
                                                    <option <?php if ($squint_history['history_chief_upward_unit'] == 'Years') {
                                                        echo 'selected';
                                                    } ?> value="Years">Years</option>
                                                </select>
                                            </div>
                                            <div class="col-md-3  m-b-5" style="width:9px !important;">
                                                <input type="text" placeholder="Comment..."
                                                    value="<?php echo $squint_history['history_chief_upward_comm']; ?>"
                                                    name="history_chief_upward_comm"
                                                    style="width: 263px;margin-left:3px;">
                                            </div>
                                        </div>
                                        <div class="row" id="prev_squint1">
                                            ...
                                            <div class="col-md-2  m-b-5">
                                                <select class="form-control" name="history_chief_prev_squint_side">
                                                    <option value="">Please Select</option>
                                                    <option <?php if ($squint_history['history_chief_prev_squint_side'] == 'Left') {
                                                        echo 'selected';
                                                    } ?> value="Left">L</option>
                                                    <option <?php if ($squint_history['history_chief_prev_squint_side'] == 'Right') {
                                                        echo 'selected';
                                                    } ?> value="Right">R</option>
                                                    <option <?php if ($squint_history['history_chief_prev_squint_side'] == 'Both') {
                                                        echo 'selected';
                                                    } ?> value="Both">B/E</option>
                                                </select>
                                            </div>
                                            <div class="col-md-2 m-b-5">
                                                <select class="form-control" name="history_chief_prev_squint_dur">
                                                    <option value="">Please Select</option>
                                                    <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                        <option <?php if ($squint_history['history_chief_prev_squint_dur'] == $i) {
                                                            echo 'selected';
                                                        } ?> value="<?php echo $i; ?>"><?php echo $i; ?>
                                                        </option>
                                                    <?php } ?>
                                            ...
                                            <div class="col-md-3  m-b-5">
                                                <select class="form-control" name="history_chief_prev_squint_unit">
                                                    <option value="">Please Select</option>
                                                    <option <?php if ($squint_history['history_chief_prev_squint_unit'] == 'Days') {
                                                        echo 'selected';
                                                    } ?> value="Days">Days</option>
                                                    <option <?php if ($squint_history['history_chief_prev_squint_unit'] == 'Weeks') {
                                                        echo 'selected';
                                                    } ?> value="Weeks">Weeks</option>
                                                    <option <?php if ($squint_history['history_chief_prev_squint_unit'] == 'Months') {
                                                        echo 'selected';
                                                    } ?> value="Months">Months</option>
                                                    <option <?php if ($squint_history['history_chief_prev_squint_unit'] == 'Years') {
                                                        echo 'selected';
                                                    } ?> value="Years">Years</option>
                                                </select>
                                            </div>
                                            <div class="col-md-3  m-b-5" style="width:9px !important;">
                                                <input type="text" placeholder="Comment..."
                                                    value="<?php echo $squint_history['history_chief_prev_squint_comm']; ?>"
                                                    name="history_chief_prev_squint_comm"
                                                    style="width: 263px;margin-left:3px;">
                                            </div>
                                        </div>
                                        <div class="row" id="double_vision1">
                                            ...
                                            <div class="col-md-2  m-b-5">
                                                <select class="form-control" name="history_chief_double_vision_side">
                                                    <option value="">Please Select</option>
                                                    <option <?php if ($squint_history['history_chief_double_vision_side'] == 'Left') {
                                                        echo 'selected';
                                                    } ?> value="Left">L</option>
                                                    <option <?php if ($squint_history['history_chief_double_vision_side'] == 'Right') {
                                                        echo 'selected';
                                                    } ?> value="Right">R</option>
                                                    <option <?php if ($squint_history['history_chief_double_vision_side'] == 'Both') {
                                                        echo 'selected';
                                                    } ?> value="Both">B/E</option>
                                                </select>
                                            </div>
                                            <div class="col-md-2 m-b-5">
                                                <select class="form-control" name="history_chief_double_vision_dur">
                                                    <option value="">Please Select</option>
                                                    <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                        <option <?php if ($squint_history['history_chief_double_vision_dur'] == $i) {
                                                            echo 'selected';
                                                        } ?> value="<?php echo $i; ?>"><?php echo $i; ?>
                                                        </option>
                                                    <?php } ?>
                                            ...
                                            <div class="col-md-3  m-b-5">
                                                <select class="form-control" name="history_chief_double_vision_unit">
                                                    <option value="">Please Select</option>
                                                    <option <?php if ($squint_history['history_chief_double_vision_unit'] == 'Days') {
                                                        echo 'selected';
                                                    } ?> value="Days">Days</option>
                                                    <option <?php if ($squint_history['history_chief_double_vision_unit'] == 'Weeks') {
                                                        echo 'selected';
                                                    } ?> value="Weeks">Weeks</option>
                                                    <option <?php if ($squint_history['history_chief_double_vision_unit'] == 'Months') {
                                                        echo 'selected';
                                                    } ?> value="Months">Months</option>
                                                    <option <?php if ($squint_history['history_chief_double_vision_unit'] == 'Years') {
                                                        echo 'selected';
                                                    } ?> value="Years">Years</option>
                                                </select>
                                            </div>
                                            <div class="col-md-3  m-b-5" style="width:9px !important;">
                                                <input type="text" placeholder="Comment..."
                                                    value="<?php echo $squint_history['history_chief_double_vision_comm']; ?>"
                                                    name="history_chief_double_vision_comm"
                                                    style="width: 263px;margin-left:3px;">
                                            </div>
                                        </div>
                                        <div class="row" id="constant1">
                                            ...
                                            <div class="col-md-2  m-b-5">
                                                <select class="form-control" name="history_chief_constant_side">
                                                    <option value="">Please Select</option>
                                                    <option <?php if ($squint_history['history_chief_constant_side'] == 'Left') {
                                                        echo 'selected';
                                                    } ?> value="Left">L</option>
                                                    <option <?php if ($squint_history['history_chief_constant_side'] == 'Right') {
                                                        echo 'selected';
                                                    } ?> value="Right">R</option>
                                                    <option <?php if ($squint_history['history_chief_constant_side'] == 'Both') {
                                                        echo 'selected';
                                                    } ?> value="Both">B/E</option>
                                                </select>
                                            </div>
                                            <div class="col-md-2 m-b-5">
                                                <select class="form-control" name="history_chief_constant_dur">
                                                    <option value="">Please Select</option>
                                                    <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                        <option <?php if ($squint_history['history_chief_constant_dur'] == $i) {
                                                            echo 'selected';
                                                        } ?> value="<?php echo $i; ?>"><?php echo $i; ?>
                                                        </option>
                                                    <?php } ?>
                                            ...
                                            <div class="col-md-3  m-b-5">
                                                <select class="form-control" name="history_chief_constant_unit">
                                                    <option value="">Please Select</option>
                                                    <option <?php if ($squint_history['history_chief_constant_unit'] == 'Days') {
                                                        echo 'selected';
                                                    } ?> value="Days">Days</option>
                                                    <option <?php if ($squint_history['history_chief_constant_unit'] == 'Weeks') {
                                                        echo 'selected';
                                                    } ?> value="Weeks">Weeks</option>
                                                    <option <?php if ($squint_history['history_chief_constant_unit'] == 'Months') {
                                                        echo 'selected';
                                                    } ?> value="Months">Months</option>
                                                    <option <?php if ($squint_history['history_chief_constant_unit'] == 'Years') {
                                                        echo 'selected';
                                                    } ?> value="Years">Years</option>
                                                </select>
                                            </div>
                                            <div class="col-md-3  m-b-5" style="width:9px !important;">
                                                <input type="text" placeholder="Comment..."
                                                    value="<?php echo $squint_history['history_chief_constant_comm']; ?>"
                                                    name="history_chief_constant_comm"
                                                    style="width: 263px;margin-left:3px;">
                                            </div>
                                        </div>
                                        <div class="row" id="antisupression1">
                                            ...
                                            <div class="col-md-2  m-b-5">
                                                <select class="form-control" name="history_chief_antisupression_side">
                                                    <option value="">Please Select</option>
                                                    <option <?php if ($squint_history['history_chief_antisupression_side'] == 'Left') {
                                                        echo 'selected';
                                                    } ?> value="Left">L</option>
                                                    <option <?php if ($squint_history['history_chief_antisupression_side'] == 'Right') {
                                                        echo 'selected';
                                                    } ?> value="Right">R</option>
                                                    <option <?php if ($squint_history['history_chief_antisupression_side'] == 'Both') {
                                                        echo 'selected';
                                                    } ?> value="Both">B/E</option>
                                                </select>
                                            </div>
                                            <div class="col-md-2 m-b-5">
                                                <select class="form-control" name="history_chief_antisupression_dur">
                                                    <option value="">Please Select</option>
                                                    <?php for ($i = 1; $i <= 40; $i++) { ?>
                                                        <option <?php if ($squint_history['history_chief_antisupression_dur'] == $i) {
                                                            echo 'selected';
                                                        } ?> value="<?php echo $i; ?>"><?php echo $i; ?>
                                                        </option>
                                                    <?php } ?>
                                            ...
                                            <div class="col-md-3  m-b-5">
                                                <select class="form-control" name="history_chief_antisupression_unit">
                                                    <option value="">Please Select</option>
                                                    <option <?php if ($squint_history['history_chief_antisupression_unit'] == 'Days') {
                                                        echo 'selected';
                                                    } ?> value="Days">Days</option>
                                                    <option <?php if ($squint_history['history_chief_antisupression_unit'] == 'Weeks') {
                                                        echo 'selected';
                                                    } ?> value="Weeks">Weeks</option>
                                                    <option <?php if ($squint_history['history_chief_antisupression_unit'] == 'Months') {
                                                        echo 'selected';
                                                    } ?> value="Months">Months</option>
                                                    <option <?php if ($squint_history['history_chief_antisupression_unit'] == 'Years') {
                                                        echo 'selected';
                                                    } ?> value="Years">Years</option>
                                                </select>
                                            </div>
                                            <div class="col-md-3  m-b-5" style="width:9px !important;">
                                                <input type="text" placeholder="Comment..."
                                                    value="<?php echo $squint_history['history_chief_antisupression_comm']; ?>"
                                                    name="history_chief_antisupression_comm"
                                                    style="width: 263px;margin-left:3px;">
                                            </div>
                                        </div>
                                    ...
                                    <section>
                                        <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <textarea class="form-control w-100"
                                                    name="squint_comm"><?php echo $squint_history['squint_comm']; ?></textarea>
                                            </div>
                                        </div>
                                    </section>
                                ...
                                <section style="padding-left:15px;">
                                    <div class="grp">
                                        <label>Remarks: </label>
                                        <div class="box-right" style="margin-left: 130px;">
                                            <input type="text" name="remarks" class="txt_firstCap input-height"
                                                id="remarks"
                                                value="<?php echo isset($form_data['remarks']) ? htmlspecialchars($form_data['remarks']) : ''; ?>"
                                                 />
                        ...
                        <div class="fixed">
                            <div class="btns">
                                ...
                                <a href="<?php echo base_url('oct_hfa'); ?>" class="btn-update"
                                    style="text-decoration:none!important;color:#FFF;padding:8px 2em;margin-top:5px;"><i
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    showAlert(
                        ...
                        "<?php echo base_url('oct_hfa'); ?>" // URL for redirection
                    );
                }else {
