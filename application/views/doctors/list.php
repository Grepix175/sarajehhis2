    ...
    <section class="userlist">
      ...
      <div class="userlist-box">
        ...
        <form name="search_form" id="search_form">
          <table class="ptl_tbl">
            <tr>
              <td><label><b>From Date</b></label><input id="start_date" name="start_date"
                  class="datepicker start_datepicker2 m_input_default" value="<?php echo $form_data['start_date']; ?>"
                  type="text"></td>
              <td><label><b>To Date</b></label><input name="end_date" id="end_date"
...
">
            ...
            <tr>
              <td><label><b>Doctor Reg. No.</b></label><input name="doctor_code"
                  value="<?php echo $form_data['doctor_code']; ?>" id="doctor_code" onkeyup="return list_form_submit();"
                  class="upper_case m_input_default m_input_default" value="" type="text" autofocus></td>
              <td><label><b>Doctor Name</b></label><input name="doctor_name" id="doctor_name"
                  onkeyup="return list_form_submit();" class="alpha_space m_input_default"
                  value="<?php echo $form_data['doctor_name']; ?>" type="text"></td>
            </tr>
            <tr>
              <td>
                <label><b>Specialization</b></label>
                <select name="specialization_id" id="specialization_id" class="m_input_default"
                  onchange="return list_form_submit();">
                  <option value=""> Select Specialization </option>
                  <?php
                  if (!empty($specialization_list)) {
                    foreach ($specialization_list as $specialization) {
                      ?>
                      <option value="<?php echo $specialization->id; ?>"><?php echo $specialization->specialization; ?>
                      </option>
                    <?php
                    }
                  }
              ...
              <td>
                ...
                <select name="doctor_type" id="doctor_type" class="m_input_default"
                  onchange="return list_form_submit();">
            ...
            <tr>
              <td><label><b>Mobile No.</b></label><input name="mobile_no" id="mobile_no"
                  onkeyup="return list_form_submit();" class="numeric m_input_default" maxlength="10"
                  value="<?php echo $form_data['mobile_no']; ?>" type="text"></td>
              <td>
            ...
            <?php if (in_array('121', $users_data['permission']['action'])): ?>
              ...
              <table id="table" class="table table-striped table-bordered doctor_list" cellspacing="0" width="100%">
                <thead class="bg-theme">
                  <tr>
                    <th align="center" width="40"> <input type="checkbox" name="selectall" class="" id="selectAll"
                        value=""> </th>
          ...
          <div class="btns">
            <?php if (in_array('122', $users_data['permission']['action'])) {
              ...
              <a href="javascript:void(0)" class="btn-anchor m-b-2"
                onClick="return print_window_page('<?php echo base_url("doctors/doctors_print"); ?>');">
                <i class="fa fa-print"></i> Print
              </a>
    ...
    <script>
      ...
      function clear_form_elements(ele) {
        $.ajax({
          url: "<?php echo base_url(); ?>doctors/reset_search/",
          success: function (result) {
    ...
    <div id="load_doctors_import_modal_popup" class="modal fade modal-40" role="dialog" data-backdrop="static"
...
<div id="load_add_specialization_modal_popup" class="modal fade modal-top" role="dialog" data-backdrop="static"
  data-keyboard="false"></div>
<div id="load_add_comission_modal_popup" class="fgdfgdf modal fade modal-top" role="dialog" data-backdrop="static"
  data-keyboard="false"></div>
<div id="load_add_rate_modal_popup" class="modal fade modal-60" role="dialog" data-backdrop="static"
  data-keyboard="false"></div>
<div id="load_transaction_modal_popup" class="fgdfgdf modal fade modal-40" role="dialog" data-backdrop="static"
  data-keyboard="false"></div>