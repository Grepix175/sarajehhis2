...
//  
   if(!empty($data_list))
   {
        ...
        //echo "<pre>";print_r($dilate);die;
          ...
          <td><?php echo $dilate->booking_code; ?></td>
   	      <td><?php echo $dilate->patient_code; ?></td>
          <td><?php echo $dilate->patient_name; ?></td>
          <td><?php echo $gender[$dilate->gender]; ?></td>
          <td><?php echo $dilate->mobile_no; ?></td>
          <td><?php echo $age; ?></td>
          <td><?php echo $dilate->status == 0 ? 'Pending' : 'Complete';; ?></td>
          <td><?php
                    ...
                    echo ($last_status); ?></td>
          <td><?php echo $dilate->doctor_name; ?></td>
          <td><?php echo $dilate->room_no; ?></td>
