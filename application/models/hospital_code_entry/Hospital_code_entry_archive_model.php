...
class Hospital_code_entry_archive_model extends CI_Model {
	...
	private function _get_datatables_query()
	{
		...
		// $this->db->select("hms_hospital_code_entry.*,hms_medicine_racks.rack_no ,hms_medicine_racks.id as rack_id"); 
		...
		$this->db->from($this->table);
		$this->db->where('hms_hospital_code_entry.branch_id  IN ('.$user_data['parent_id'].',0)');  
        ...
        $this->db->where('hms_hospital_code_entry.is_deleted','1');
		$i = 0;
