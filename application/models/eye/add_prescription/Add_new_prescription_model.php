...
class Add_new_prescription_model extends CI_Model
{
	...
	public function save($post)
	{
		...
		if (
			...
			($post['send_to_type'] === 'Hess Chart' || $post['send_to_type'] === 'Refraction below 8 years')
		) {
			// Keep $post unchanged
		} else {
			$post = $this->input->post();
		...
		// echo "sagar";
		// echo "<pre>"; print_r($post); die('EYEY');
		$history_flag = 0;
		$drawing_flag = 0;
		$refraction_below8 = 0;
		...
		$appendages = array(
			'examnsn_apndgs_l_eyelids' => $examnsn_apndgs_l_eyelids,
			'examnsn_apndgs_l_eyelids_chzn' => $post['examnsn_apndgs_l_eyelids_chzn'],
			'examnsn_apndgs_l_eyelids_ptss' => $post['examnsn_apndgs_l_eyelids_ptss'],
			'examnsn_apndgs_l_eyelids_swln' => $post['examnsn_apndgs_l_eyelids_swln'],
			'examnsn_apndgs_l_eyelids_intrpn' => $post['examnsn_apndgs_l_eyelids_intrpn'],
			'examnsn_apndgs_l_eyelids_ectrpn' => $post['examnsn_apndgs_l_eyelids_ectrpn'],
			'examnsn_apndgs_l_eyelids_mass' => $post['examnsn_apndgs_l_eyelids_mass'],
			'examnsn_apndgs_l_eyelids_mbts' => $post['examnsn_apndgs_l_eyelids_mbts'],
			'examnsn_apndgs_l_eyelshs' => $examnsn_apndgs_l_eyelshs,
			'examnsn_apndgs_l_eyelshs_tchs' => $post['examnsn_apndgs_l_eyelshs_tchs'],
			'examnsn_apndgs_l_eyelshs_dtchs' => $post['examnsn_apndgs_l_eyelshs_dtchs'],
			'examnsn_apndgs_l_lcmlc' => $examnsn_apndgs_l_lcmlc,
			'examnsn_apndgs_l_lcmlc_swln' => $post['examnsn_apndgs_l_lcmlc_swln'],
			'examnsn_apndgs_l_lcmlc_regusn' => $post['examnsn_apndgs_l_lcmlc_regusn'],
			'examnsn_apndgs_l_syrn' => $examnsn_apndgs_l_syrn,
			'examnsn_apndgs_l_syrn_syrn' => $post['examnsn_apndgs_l_syrn_syrn'],
			'examnsn_apndgs_l_comm' => $post['examnsn_apndgs_l_comm'],
			'examnsn_apndgs_r_eyelids' => $examnsn_apndgs_r_eyelids,
			'examnsn_apndgs_r_eyelids_chzn' => $post['examnsn_apndgs_r_eyelids_chzn'],
			'examnsn_apndgs_r_eyelids_ptss' => $post['examnsn_apndgs_r_eyelids_ptss'],
			'examnsn_apndgs_r_eyelids_swln' => $post['examnsn_apndgs_r_eyelids_swln'],
			'examnsn_apndgs_r_eyelids_intrpn' => $post['examnsn_apndgs_r_eyelids_intrpn'],
			'examnsn_apndgs_r_eyelids_ectrpn' => $post['examnsn_apndgs_r_eyelids_ectrpn'],
			'examnsn_apndgs_r_eyelids_mass' => $post['examnsn_apndgs_r_eyelids_mass'],
			'examnsn_apndgs_r_eyelids_mbts' => $post['examnsn_apndgs_r_eyelids_mbts'],
			'examnsn_apndgs_r_eyelshs' => $examnsn_apndgs_r_eyelshs,
			'examnsn_apndgs_r_eyelshs_tchs' => $post['examnsn_apndgs_r_eyelshs_tchs'],
			'examnsn_apndgs_r_eyelshs_dtchs' => $post['examnsn_apndgs_r_eyelshs_dtchs'],
			'examnsn_apndgs_r_lcmlc' => $examnsn_apndgs_r_lcmlc,
			'examnsn_apndgs_r_lcmlc_swln' => $post['examnsn_apndgs_r_lcmlc_swln'],
			'examnsn_apndgs_r_lcmlc_regusn' => $post['examnsn_apndgs_r_lcmlc_regusn'],
			'examnsn_apndgs_r_syrn' => $examnsn_apndgs_r_syrn,
			'examnsn_apndgs_r_syrn_syrn' => $post['examnsn_apndgs_r_syrn_syrn'],
			'examnsn_apndgs_r_comm' => $post['examnsn_apndgs_r_comm'],
			'examnsn_apndgs_l_update' => $post['examnsn_apndgs_l_update'],
			'examnsn_apndgs_r_update' => $post['examnsn_apndgs_r_update']
		);
		...
		$data_biometry = array(
			...
			'patient_id' => $post['patient_id'],
			'booking_id' => $post['booking_id'],
			'biometry_ob_k1_one' => $post['biometry_ob_k1_one'],
			'biometry_ob_k1_two' => $post['biometry_ob_k1_two']
			,
			...
			,
			'biometry_remarks' => $post['biometry_remarks'],
			'status' => 1,
			'ip_address' => $_SERVER['REMOTE_ADDR'],
			'created_by' => $user_data['id'],
			'created_date' => date('Y-m-d H:i:s')
		...
		$pgp = array(
			...
			'refraction_pgp_l_ad_sph' => $post['refraction_pgp_l_ad_sph'],
			'refraction_pgp_l_ad_cyl' => $post['refraction_pgp_l_ad_cyl'],
			'refraction_pgp_l_ad_axis' => $post['refraction_pgp_l_ad_axis'],
			'refraction_pgp_l_ad_vision' => $post['refraction_pgp_l_ad_vision'],
			...
			'refraction_pgp_l_lens' => $post['refraction_pgp_l_lens'],
			...
			'refraction_pgp_r_ad_sph' => $post['refraction_pgp_r_ad_sph'],
			'refraction_pgp_r_ad_cyl' => $post['refraction_pgp_r_ad_cyl'],
			'refraction_pgp_r_ad_axis' => $post['refraction_pgp_r_ad_axis'],
			'refraction_pgp_r_ad_vision' => $post['refraction_pgp_r_ad_vision'],
			...
			'refraction_pgp_r_lens' => $post['refraction_pgp_r_lens']
		);
		...
		$auto_ref = array(
			...
			'refraction_ar_r_b1_sph' => $post['refraction_ar_r_b1_sph'],
			'refraction_ar_r_b1_cyl' => $post['refraction_ar_r_b1_cyl'],
			'refraction_ar_r_b1_axis' => $post['refraction_ar_r_b1_axis'],
			'refraction_ar_r_b2_sph' => $post['refraction_ar_r_b2_sph'],
			'refraction_ar_r_b2_cyl' => $post['refraction_ar_r_b2_cyl'],
		...
		$dry_ref = array(
			...
			'refraction_dry_ref_l_ad_cyl' => $post['refraction_dry_ref_l_ad_cyl'],
			'refraction_dry_ref_l_ad_axis' => $post['refraction_dry_ref_l_ad_axis'],
			'refraction_dry_ref_l_ad_vision' => $post['refraction_dry_ref_l_ad_vision'],
			...
			'refraction_dry_ref_l_comm' => $post['refraction_dry_ref_l_comm'],
			...
			'refraction_dry_ref_r_ad_cyl' => $post['refraction_dry_ref_r_ad_cyl'],
			'refraction_dry_ref_r_ad_axis' => $post['refraction_dry_ref_r_ad_axis'],
			...
			'refraction_dry_ref_r_comm' => $post['refraction_dry_ref_r_comm']
		);
		...
		$ref_dtd = array(
			...
			'refraction_ref_dtd_l_ad_sph' => $post['refraction_ref_dtd_l_ad_sph'],
			'refraction_ref_dtd_l_ad_cyl' => $post['refraction_ref_dtd_l_ad_cyl'],
			'refraction_ref_dtd_l_ad_axis' => $post['refraction_ref_dtd_l_ad_axis'],
			'refraction_ref_dtd_l_ad_vision' => $post['refraction_ref_dtd_l_ad_vision'],
			...
			'refraction_ref_dtd_l_du' => $post['refraction_ref_dtd_l_du'],
			'refraction_ref_dtd_l_comm' => $post['refraction_ref_dtd_l_comm'],
			...
			'refraction_ref_dtd_r_ad_sph' => $post['refraction_ref_dtd_r_ad_sph'],
			'refraction_ref_dtd_r_ad_cyl' => $post['refraction_ref_dtd_r_ad_cyl'],
			'refraction_ref_dtd_r_ad_axis' => $post['refraction_ref_dtd_r_ad_axis'],
			'refraction_ref_dtd_r_ad_vision' => $post['refraction_ref_dtd_r_ad_vision'],
			...
			'refraction_ref_dtd_r_du' => $post['refraction_ref_dtd_r_du'],
			'refraction_ref_dtd_r_comm' => $post['refraction_ref_dtd_r_comm']
		);
		...
		$pmt = array(
			...
			'refraction_pmt_l_ad_sph' => $post['refraction_pmt_l_ad_sph'],
			'refraction_pmt_l_ad_cyl' => $post['refraction_pmt_l_ad_cyl'],
			'refraction_pmt_l_ad_axis' => $post['refraction_pmt_l_ad_axis'],
			'refraction_pmt_l_ad_vision' => $post['refraction_pmt_l_ad_vision'],
			...
			'refraction_pmt_r_ad_sph' => $post['refraction_pmt_r_ad_sph'],
			'refraction_pmt_r_ad_cyl' => $post['refraction_pmt_r_ad_cyl'],
			'refraction_pmt_r_ad_axis' => $post['refraction_pmt_r_ad_axis'],
			'refraction_pmt_r_ad_vision' => $post['refraction_pmt_r_ad_vision'],
		...
		$glass_pres = array(
			'refraction_gps_l_dt_sph' => $post['refraction_gps_l_dt_sph'],
			'refraction_gps_l_dt_cyl' => $post['refraction_gps_l_dt_cyl'],
			'refraction_gps_l_dt_axis' => $post['refraction_gps_l_dt_axis'],
			'refraction_gps_l_dt_vision' => $post['refraction_gps_l_dt_vision'],
			'refraction_gps_l_ad_sph' => $post['refraction_gps_l_ad_sph'],
			'refraction_gps_l_ad_cyl' => $post['refraction_gps_l_ad_cyl'],
			'refraction_gps_l_ad_axis' => $post['refraction_gps_l_ad_axis'],
			'refraction_gps_l_ad_vision' => $post['refraction_gps_l_ad_vision'],
			'refraction_gps_l_nr_sph' => $post['refraction_gps_l_nr_sph'],
			'refraction_gps_l_nr_cyl' => $post['refraction_gps_l_nr_cyl'],
			'refraction_gps_l_nr_axis' => $post['refraction_gps_l_nr_axis'],
			'refraction_gps_l_nr_vision' => $post['refraction_gps_l_nr_vision'],
			'refraction_gps_l_tol' => $post['refraction_gps_l_tol'],
			'refraction_gps_l_ipd' => $post['refraction_gps_l_ipd'],
			'refraction_gps_l_lns_mat' => $post['refraction_gps_l_lns_mat'],
			'refraction_gps_l_lns_tnt' => $post['refraction_gps_l_lns_tnt'],
			'refraction_gps_l_fm' => $post['refraction_gps_l_fm'],
			'refraction_gps_l_advs' => $post['refraction_gps_l_advs'],

			'refraction_gps_r_dt_sph' => $post['refraction_gps_r_dt_sph'],
			'refraction_gps_r_dt_cyl' => $post['refraction_gps_r_dt_cyl'],
			'refraction_gps_r_dt_axis' => $post['refraction_gps_r_dt_axis'],
			'refraction_gps_r_dt_vision' => $post['refraction_gps_r_dt_vision'],
			'refraction_gps_r_ad_sph' => $post['refraction_gps_r_ad_sph'],
			'refraction_gps_r_ad_cyl' => $post['refraction_gps_r_ad_cyl'],
			'refraction_gps_r_ad_axis' => $post['refraction_gps_r_ad_axis'],
			'refraction_gps_r_ad_vision' => $post['refraction_gps_r_ad_vision'],
			'refraction_gps_r_nr_sph' => $post['refraction_gps_r_nr_sph'],
			'refraction_gps_r_nr_cyl' => $post['refraction_gps_r_nr_cyl'],
			'refraction_gps_r_nr_axis' => $post['refraction_gps_r_nr_axis'],
			'refraction_gps_r_nr_vision' => $post['refraction_gps_r_nr_vision'],
			'refraction_gps_r_tol' => $post['refraction_gps_r_tol'],
			'refraction_gps_r_ipd' => $post['refraction_gps_r_ipd'],
			'refraction_gps_r_lns_mat' => $post['refraction_gps_r_lns_mat'],
			'refraction_gps_r_lns_tnt' => $post['refraction_gps_r_lns_tnt'],
			'refraction_gps_r_fm' => $post['refraction_gps_r_fm'],
			'refraction_gps_r_advs' => $post['refraction_gps_r_advs'],
			'refraction_gps_ad_check' => $refraction_gps_ad_check,
			'refraction_gps_ad_show_print' => $refraction_gps_ad_show_print
		);

		$inter_gls_pres = array(
			'refraction_itgp_l_dt_sph' => $post['refraction_itgp_l_dt_sph'],
			'refraction_itgp_l_dt_cyl' => $post['refraction_itgp_l_dt_cyl'],
			'refraction_itgp_l_dt_axis' => $post['refraction_itgp_l_dt_axis'],
			'refraction_itgp_l_dt_vision' => $post['refraction_itgp_l_dt_vision'],
			'refraction_itgp_l_ad_sph' => $post['refraction_itgp_l_ad_sph'],
			'refraction_itgp_l_ad_cyl' => $post['refraction_itgp_l_ad_cyl'],
			'refraction_itgp_l_ad_axis' => $post['refraction_itgp_l_ad_axis'],
			'refraction_itgp_l_ad_vision' => $post['refraction_itgp_l_ad_vision'],
			'refraction_itgp_l_nr_sph' => $post['refraction_itgp_l_nr_sph'],
			'refraction_itgp_l_nr_cyl' => $post['refraction_itgp_l_nr_cyl'],
			'refraction_itgp_l_nr_axis' => $post['refraction_itgp_l_nr_axis'],
			'refraction_itgp_l_nr_vision' => $post['refraction_itgp_l_nr_vision'],
			'refraction_itgp_l_tol' => $post['refraction_itgp_l_tol'],
			'refraction_itgp_l_ipd' => $post['refraction_itgp_l_ipd'],
			'refraction_itgp_l_lns_mat' => $post['refraction_itgp_l_lns_mat'],
			'refraction_itgp_l_lns_tnt' => $post['refraction_itgp_l_lns_tnt'],
			'refraction_itgp_l_fm' => $post['refraction_itgp_l_fm'],
			'refraction_itgp_l_advs' => $post['refraction_itgp_l_advs'],

			'refraction_itgp_r_dt_sph' => $post['refraction_itgp_r_dt_sph'],
			'refraction_itgp_r_dt_cyl' => $post['refraction_itgp_r_dt_cyl'],
			'refraction_itgp_r_dt_axis' => $post['refraction_itgp_r_dt_axis'],
			'refraction_itgp_r_dt_vision' => $post['refraction_itgp_r_dt_vision'],
			'refraction_itgp_r_ad_sph' => $post['refraction_itgp_r_ad_sph'],
			'refraction_itgp_r_ad_cyl' => $post['refraction_itgp_r_ad_cyl'],
			'refraction_itgp_r_ad_axis' => $post['refraction_itgp_r_ad_axis'],
			'refraction_itgp_r_ad_vision' => $post['refraction_itgp_r_ad_vision'],
			'refraction_itgp_r_nr_sph' => $post['refraction_itgp_r_nr_sph'],
			'refraction_itgp_r_nr_cyl' => $post['refraction_itgp_r_nr_cyl'],
			'refraction_itgp_r_nr_axis' => $post['refraction_itgp_r_nr_axis'],
			'refraction_itgp_r_nr_vision' => $post['refraction_itgp_r_nr_vision'],
			'refraction_itgp_r_tol' => $post['refraction_itgp_r_tol'],
			'refraction_itgp_r_ipd' => $post['refraction_itgp_r_ipd'],
			'refraction_itgp_r_lns_mat' => $post['refraction_itgp_r_lns_mat'],
			'refraction_itgp_r_lns_tnt' => $post['refraction_itgp_r_lns_tnt'],
			'refraction_itgp_r_fm' => $post['refraction_itgp_r_fm'],
			'refraction_itgp_r_advs' => $post['refraction_itgp_r_advs'],
			'refraction_itgp_ad_check' => $refraction_itgp_ad_check,
			'refraction_itgp_ad_show_print' => $refraction_itgp_ad_show_print
		);
		...
		$color_vision = array(
			'refraction_col_vis_l' => $post['refraction_col_vis_l'],
		...
		$intra_press = array(
			'refraction_intra_press_l_mg' => $post['refraction_intra_press_l_mg'],
			'refraction_intra_press_l_time' => $post['refraction_intra_press_l_time'],
			'refraction_intra_press_l_comm' => $post['refraction_intra_press_l_comm'],
			'refraction_intra_press_r_mg' => $post['refraction_intra_press_r_mg'],
			'refraction_intra_press_r_time' => $post['refraction_intra_press_r_time'],
			'refraction_intra_press_r_comm' => $post['refraction_intra_press_r_comm'],
			'refraction_intra_l_update' => $post['refraction_intra_press_l_update'],
			'refraction_intra_r_update' => $post['refraction_intra_press_r_update']
		);

		$orthoptics = array(
			'refraction_ortho_l' => $post['refraction_ortho_l'],
		...
		$ophthalmic = array(
			'gla_m' => $gla_m,
			'history_ophthalmic_glau_l_dur' => $post['history_ophthalmic_glau_l_dur'],
			'history_ophthalmic_glau_l_unit' => $post['history_ophthalmic_glau_l_unit'],
			'history_ophthalmic_glau_r_dur' => $post['history_ophthalmic_glau_r_dur'],
			'history_ophthalmic_glau_r_unit' => $post['history_ophthalmic_glau_r_unit'],
			'history_ophthalmic_glau_comm' => $post['history_ophthalmic_glau_comm'],
			'reti_m' => $reti_m,
			...
			'history_ophthalmic_renti_d_r_dur' => $post['history_ophthalmic_renti_d_r_dur'],
			'history_ophthalmic_renti_d_r_unit' => $post['history_ophthalmic_renti_d_r_unit'],
			'history_ophthalmic_renti_d_comm' => $post['history_ophthalmic_renti_d_comm'],
			'glass_m' => $glass_m,
			'history_ophthalmic_glas_l_dur' => $post['history_ophthalmic_glas_l_dur'],
			'history_ophthalmic_glas_l_unit' => $post['history_ophthalmic_glas_l_unit'],
			'history_ophthalmic_glas_r_dur' => $post['history_ophthalmic_glas_r_dur'],
			'history_ophthalmic_glas_r_unit' => $post['history_ophthalmic_glas_r_unit'],
			'history_ophthalmic_glas_comm' => $post['history_ophthalmic_glas_comm'],
			'eyedi_m' => $eyedi_m,
			'history_ophthalmic_eye_d_l_dur' => $post['history_ophthalmic_eye_d_l_dur'],
			'history_ophthalmic_eye_d_l_unit' => $post['history_ophthalmic_eye_d_l_unit'],
			'history_ophthalmic_eye_d_r_dur' => $post['history_ophthalmic_eye_d_r_dur'],
			'history_ophthalmic_eye_d_r_unit' => $post['history_ophthalmic_eye_d_r_unit'],
			'history_ophthalmic_eye_d_comm' => $post['history_ophthalmic_eye_d_comm'],
			'eyesu_m' => $eyesu_m,
			'history_ophthalmic_eye_s_l_dur' => $post['history_ophthalmic_eye_s_l_dur'],
			'history_ophthalmic_eye_s_l_unit' => $post['history_ophthalmic_eye_s_l_unit'],
			'history_ophthalmic_eye_s_r_dur' => $post['history_ophthalmic_eye_s_r_dur'],
			'history_ophthalmic_eye_s_r_unit' => $post['history_ophthalmic_eye_s_r_unit'],
			'history_ophthalmic_eye_s_comm' => $post['history_ophthalmic_eye_s_comm'],
			'uve_m' => $uve_m,
			'history_ophthalmic_uvei_l_dur' => $post['history_ophthalmic_uvei_l_dur'],
			'history_ophthalmic_uvei_l_unit' => $post['history_ophthalmic_uvei_l_unit'],
			'history_ophthalmic_uvei_r_dur' => $post['history_ophthalmic_uvei_r_dur'],
			'history_ophthalmic_uvei_r_unit' => $post['history_ophthalmic_uvei_r_unit'],
			'history_ophthalmic_uvei_comm' => $post['history_ophthalmic_uvei_comm'],
			'retil_m' => $retil_m,
			'history_ophthalmic_renti_l_l_dur' => $post['history_ophthalmic_renti_l_l_dur'],
			'history_ophthalmic_renti_l_l_unit' => $post['history_ophthalmic_renti_l_l_unit'],
		...
		$systematic_history = array(
			'dia_m' => $dia_m,
			'history_systemic_diab_dur' => $post['history_systemic_diab_dur'],
			'history_systemic_diab_unit' => $post['history_systemic_diab_unit'],
			'history_systemic_diab_comm' => $post['history_systemic_diab_comm'],
			'hyper_m' => $hyper_m,
			'history_systemic_hyper_dur' => $post['history_systemic_hyper_dur'],
			'history_systemic_hyper_unit' => $post['history_systemic_hyper_unit'],
			'history_systemic_hyper_comm' => $post['history_systemic_hyper_comm'],
			'alcoh_m' => $alcoh_m,
			'history_systemic_alcoh_dur' => $post['history_systemic_alcoh_dur'],
			'history_systemic_alcoh_unit' => $post['history_systemic_alcoh_unit'],
			'history_systemic_alcoh_comm' => $post['history_systemic_alcoh_comm'],
			'smok_m' => $smok_m,
			'history_systemic_smokt_dur' => $post['history_systemic_smokt_dur'],
			'history_systemic_smokt_unit' => $post['history_systemic_smokt_unit'],
			'history_systemic_smokt_comm' => $post['history_systemic_smokt_comm'],
			'card_m' => $card_m,
			'history_systemic_cardd_dur' => $post['history_systemic_cardd_dur'],
			'history_systemic_cardd_unit' => $post['history_systemic_cardd_unit'],
			'history_systemic_cardd_comm' => $post['history_systemic_cardd_comm'],
			'steri_m' => $steri_m,
			'history_systemic_steri_dur' => $post['history_systemic_steri_dur'],
			'history_systemic_steri_unit' => $post['history_systemic_steri_unit'],
			'history_systemic_steri_comm' => $post['history_systemic_steri_comm'],
			'drug_m' => $drug_m,
			'history_systemic_drug_dur' => $post['history_systemic_drug_dur'],
			'history_systemic_drug_unit' => $post['history_systemic_drug_unit'],
			'history_systemic_drug_comm' => $post['history_systemic_drug_comm'],
			'hiva_m' => $hiva_m,
			'history_systemic_hiva_dur' => $post['history_systemic_hiva_dur'],
			'history_systemic_hiva_unit' => $post['history_systemic_hiva_unit'],
			'history_systemic_hiva_comm' => $post['history_systemic_hiva_comm'],
			'cant_m' => $cant_m,
			'history_systemic_cantu_dur' => $post['history_systemic_cantu_dur'],
			'history_systemic_cantu_unit' => $post['history_systemic_cantu_unit'],
			'history_systemic_cantu_comm' => $post['history_systemic_cantu_comm'],
			'tuber_m' => $tuber_m,
			'history_systemic_tuberc_dur' => $post['history_systemic_tuberc_dur'],
			'history_systemic_tuberc_unit' => $post['history_systemic_tuberc_unit'],
			'history_systemic_tuberc_comm' => $post['history_systemic_tuberc_comm'],
			'asth_m' => $asth_m,
			'history_systemic_asthm_dur' => $post['history_systemic_asthm_dur'],
			'history_systemic_asthm_unit' => $post['history_systemic_asthm_unit'],
			'history_systemic_asthm_comm' => $post['history_systemic_asthm_comm'],
			'cnsds_m' => $cnsds_m,
			'history_systemic_cncds_dur' => $post['history_systemic_cncds_dur'],
			'history_systemic_cncds_unit' => $post['history_systemic_cncds_unit'],
			'history_systemic_cncds_comm' => $post['history_systemic_cncds_comm'],
			'hypo_m' => $hypo_m,
			'history_systemic_hypo_dur' => $post['history_systemic_hypo_dur'],
			'history_systemic_hypo_unit' => $post['history_systemic_hypo_unit'],
			'history_systemic_hypo_comm' => $post['history_systemic_hypo_comm'],
			'hyperth_m' => $hyperth_m,
			'history_systemic_hyperth_dur' => $post['history_systemic_hyperth_dur'],
			'history_systemic_hyperth_unit' => $post['history_systemic_hyperth_unit'],
			'history_systemic_hyperth_comm' => $post['history_systemic_hyperth_comm'],
			'hepac_m' => $hepac_m,
			'history_systemic_heptc_dur' => $post['history_systemic_heptc_dur'],
			'history_systemic_heptc_unit' => $post['history_systemic_heptc_unit'],
			'history_systemic_heptc_comm' => $post['history_systemic_heptc_comm'],
			'renald_m' => $renald_m,
			'history_systemic_rendis_dur' => $post['history_systemic_rendis_dur'],
			'history_systemic_rendis_unit' => $post['history_systemic_rendis_unit'],
			'history_systemic_rendis_comm' => $post['history_systemic_rendis_comm'],
			'acid_m' => $acid_m,
			'history_systemic_acid_dur' => $post['history_systemic_acid_dur'],
			'history_systemic_acid_unit' => $post['history_systemic_acid_unit'],
			'history_systemic_acid_comm' => $post['history_systemic_acid_comm'],
			'oins_m' => $oins_m,
			'history_systemic_onins_dur' => $post['history_systemic_onins_dur'],
			'history_systemic_onins_unit' => $post['history_systemic_onins_unit'],
			'history_systemic_onins_comm' => $post['history_systemic_onins_comm'],
			'oasp_m' => $oasp_m,
			'history_systemic_oasbth_dur' => $post['history_systemic_oasbth_dur'],
			'history_systemic_oasbth_unit' => $post['history_systemic_oasbth_unit'],
			'history_systemic_oasbth_comm' => $post['history_systemic_oasbth_comm'],
			'acon_m' => $acon_m,
			'history_systemic_consan_dur' => $post['history_systemic_consan_dur'],
			'history_systemic_consan_unit' => $post['history_systemic_consan_unit'],
			'history_systemic_consan_comm' => $post['history_systemic_consan_comm'],
			'thd_m' => $thd_m,
			'history_systemic_thyrd_dur' => $post['history_systemic_thyrd_dur'],
			'history_systemic_thyrd_unit' => $post['history_systemic_thyrd_unit'],
			'history_systemic_thyrd_comm' => $post['history_systemic_thyrd_comm'],
			'chewt_m' => $chewt_m,
		...
		$drugs_antimi_agent = array(
			...
			'ampic_m' => $ampic_m,
			'history_drug_antimicrobial_ampici_dur' => $post['history_drug_antimicrobial_ampici_dur'],
			'history_drug_antimicrobial_ampici_unit' => $post['history_drug_antimicrobial_ampici_unit'],
			'history_drug_antimicrobial_ampici_comm' => $post['history_drug_antimicrobial_ampici_comm'],
			'amox_m' => $amox_m,
			'history_drug_antimicrobial_amoxi_dur' => $post['history_drug_antimicrobial_amoxi_dur'],
			'history_drug_antimicrobial_amoxi_unit' => $post['history_drug_antimicrobial_amoxi_unit'],
			'history_drug_antimicrobial_amoxi_comm' => $post['history_drug_antimicrobial_amoxi_comm'],
			'ceftr_m' => $ceftr_m,
			'history_drug_antimicrobial_ceftr_dur' => $post['history_drug_antimicrobial_ceftr_dur'],
			'history_drug_antimicrobial_ceftr_unit' => $post['history_drug_antimicrobial_ceftr_unit'],
			'history_drug_antimicrobial_ceftr_comm' => $post['history_drug_antimicrobial_ceftr_comm'],
			'cipro_m' => $cipro_m,
			'history_drug_antimicrobial_ciprof_dur' => $post['history_drug_antimicrobial_ciprof_dur'],
			'history_drug_antimicrobial_ciprof_unit' => $post['history_drug_antimicrobial_ciprof_unit'],
			'history_drug_antimicrobial_ciprof_comm' => $post['history_drug_antimicrobial_ciprof_comm'],
			'clari_m' => $clari_m,
			'history_drug_antimicrobial_clarith_dur' => $post['history_drug_antimicrobial_clarith_dur'],
			'history_drug_antimicrobial_clarith_unit' => $post['history_drug_antimicrobial_clarith_unit'],
			'history_drug_antimicrobial_clarith_comm' => $post['history_drug_antimicrobial_clarith_comm'],
			'cotri_m' => $cotri_m,
			'history_drug_antimicrobial_cotri_dur' => $post['history_drug_antimicrobial_cotri_dur'],
			'history_drug_antimicrobial_cotri_unit' => $post['history_drug_antimicrobial_cotri_unit'],
			'history_drug_antimicrobial_cotri_comm' => $post['history_drug_antimicrobial_cotri_comm'],
			'etham_m' => $etham_m,
			'history_drug_antimicrobial_ethamb_dur' => $post['history_drug_antimicrobial_ethamb_dur'],
			'history_drug_antimicrobial_ethamb_unit' => $post['history_drug_antimicrobial_ethamb_unit'],
			'history_drug_antimicrobial_ethamb_comm' => $post['history_drug_antimicrobial_ethamb_comm'],
			'ison_m' => $ison_m,
			'history_drug_antimicrobial_isoni_dur' => $post['history_drug_antimicrobial_isoni_dur'],
			'history_drug_antimicrobial_isoni_unit' => $post['history_drug_antimicrobial_isoni_unit'],
			'history_drug_antimicrobial_isoni_comm' => $post['history_drug_antimicrobial_isoni_comm'],
			'metro_m' => $metro_m,
			'history_drug_antimicrobial_metron_dur' => $post['history_drug_antimicrobial_metron_dur'],
			'history_drug_antimicrobial_metron_unit' => $post['history_drug_antimicrobial_metron_unit'],
			'history_drug_antimicrobial_metron_comm' => $post['history_drug_antimicrobial_metron_comm'],
			'penic_m' => $penic_m,
			'history_drug_antimicrobial_penic_dur' => $post['history_drug_antimicrobial_penic_dur'],
			'history_drug_antimicrobial_penic_unit' => $post['history_drug_antimicrobial_penic_unit'],
			'history_drug_antimicrobial_penic_comm' => $post['history_drug_antimicrobial_penic_comm'],
			'rifa_m' => $rifa_m,
			'history_drug_antimicrobial_rifam_dur' => $post['history_drug_antimicrobial_rifam_dur'],
			'history_drug_antimicrobial_rifam_unit' => $post['history_drug_antimicrobial_rifam_unit'],
			'history_drug_antimicrobial_rifam_comm' => $post['history_drug_antimicrobial_rifam_comm'],
			'strep_m' => $strep_m,
			'history_drug_antimicrobial_strept_dur' => $post['history_drug_antimicrobial_strept_dur'],
			'history_drug_antimicrobial_strept_unit' => $post['history_drug_antimicrobial_strept_unit'],
			'history_drug_antimicrobial_strept_comm' => $post['history_drug_antimicrobial_strept_comm']
		);
		...
		$drugs_antifungal_agent = array(
			...
			'ketoc_m' => $ketoc_m,
			'history_drug_antifungal_ketoco_dur' => $post['history_drug_antifungal_ketoco_dur'],
			'history_drug_antifungal_ketoco_unit' => $post['history_drug_antifungal_ketoco_unit'],
			'history_drug_antifungal_ketoco_comm' => $post['history_drug_antifungal_ketoco_comm'],
			'fluco_m' => $fluco_m,
			'history_drug_antifungal_flucon_dur' => $post['history_drug_antifungal_flucon_dur'],
			'history_drug_antifungal_flucon_unit' => $post['history_drug_antifungal_flucon_unit'],
			'history_drug_antifungal_flucon_comm' => $post['history_drug_antifungal_flucon_comm'],
			'itrac_m' => $itrac_m,
			'history_drug_antifungal_itrac_dur' => $post['history_drug_antifungal_itrac_dur'],
			'history_drug_antifungal_itrac_unit' => $post['history_drug_antifungal_itrac_unit'],
			'history_drug_antifungal_itrac_comm' => $post['history_drug_antifungal_itrac_comm']
		);

		$drugs_antiviral_agent = array(
			'ant_agen_m' => $ant_agen_m,
			'acyclo_m' => $acyclo_m,
			'history_drug_antiviral_acyclo_dur' => $post['history_drug_antiviral_acyclo_dur'],
			'history_drug_antiviral_acyclo_unit' => $post['history_drug_antiviral_acyclo_unit'],
			'history_drug_antiviral_acyclo_comm' => $post['history_drug_antiviral_acyclo_comm'],
			'efavir_m' => $efavir_m,
			'history_drug_antiviral_efavir_dur' => $post['history_drug_antiviral_efavir_dur'],
			'history_drug_antiviral_efavir_unit' => $post['history_drug_antiviral_efavir_unit'],
			'history_drug_antiviral_efavir_comm' => $post['history_drug_antiviral_efavir_comm'],
			'enfuv_m' => $enfuv_m,
			'history_drug_antiviral_enfuv_dur' => $post['history_drug_antiviral_enfuv_dur'],
			'history_drug_antiviral_enfuv_unit' => $post['history_drug_antiviral_enfuv_unit'],
			'history_drug_antiviral_enfuv_comm' => $post['history_drug_antiviral_enfuv_comm'],
			'nelfin_m' => $nelfin_m,
			'history_drug_antiviral_nelfin_dur' => $post['history_drug_antiviral_nelfin_dur'],
			'history_drug_antiviral_nelfin_unit' => $post['history_drug_antiviral_nelfin_unit'],
			'history_drug_antiviral_nelfin_comm' => $post['history_drug_antiviral_nelfin_comm'],
			'nevira_m' => $nevira_m,
			'history_drug_antiviral_nevira_dur' => $post['history_drug_antiviral_nevira_dur'],
			'history_drug_antiviral_nevira_unit' => $post['history_drug_antiviral_nevira_unit'],
			'history_drug_antiviral_nevira_comm' => $post['history_drug_antiviral_nevira_comm'],
			'zidov_m' => $zidov_m,
			'history_drug_antiviral_zidov_dur' => $post['history_drug_antiviral_zidov_dur'],
			'history_drug_antiviral_zidov_unit' => $post['history_drug_antiviral_zidov_unit'],
			'history_drug_antiviral_zidov_comm' => $post['history_drug_antiviral_zidov_comm']
		);
		...
		$drugs_nsaids_agent = array(
			'nsaids_m' => $nsaids_m,
			'aspirin_m' => $aspirin_m,
			'history_drug_nsaids_aspirin_dur' => $post['history_drug_nsaids_aspirin_dur'],
			'history_drug_nsaids_aspirin_unit' => $post['history_drug_nsaids_aspirin_unit'],
			'history_drug_nsaids_aspirin_comm' => $post['history_drug_nsaids_aspirin_comm'],
			'paracet_m' => $paracet_m,
			'history_drug_nsaids_paracet_dur' => $post['history_drug_nsaids_paracet_dur'],
			'history_drug_nsaids_paracet_unit' => $post['history_drug_nsaids_paracet_unit'],
			'history_drug_nsaids_paracet_comm' => $post['history_drug_nsaids_paracet_comm'],
			'ibupro_m' => $ibupro_m,
			'history_drug_nsaids_ibupro_dur' => $post['history_drug_nsaids_ibupro_dur'],
			'history_drug_nsaids_ibupro_unit' => $post['history_drug_nsaids_ibupro_unit'],
			'history_drug_nsaids_ibupro_comm' => $post['history_drug_nsaids_ibupro_comm'],
			'diclo_m' => $diclo_m,
			'history_drug_nsaids_diclo_dur' => $post['history_drug_nsaids_diclo_dur'],
			'history_drug_nsaids_diclo_unit' => $post['history_drug_nsaids_diclo_unit'],
			'history_drug_nsaids_diclo_comm' => $post['history_drug_nsaids_diclo_comm'],
			'aceclo_m' => $aceclo_m,
			'history_drug_nsaids_aceclo_dur' => $post['history_drug_nsaids_aceclo_dur'],
			'history_drug_nsaids_aceclo_unit' => $post['history_drug_nsaids_aceclo_unit'],
			'history_drug_nsaids_aceclo_comm' => $post['history_drug_nsaids_aceclo_comm'],
			'napro_m' => $napro_m,
			'history_drug_nsaids_napro_dur' => $post['history_drug_nsaids_napro_dur'],
			'history_drug_nsaids_napro_unit' => $post['history_drug_nsaids_napro_unit'],
			'history_drug_nsaids_napro_comm' => $post['history_drug_nsaids_napro_comm']
		);

		$drugs_eyealco_m_agent = array(
			'eye_drops_m' => $eye_drops_m,
			'tropip_m' => $tropip_m,
			'history_drug_eye_tropicp_dur' => $post['history_drug_eye_tropicp_dur'],
			'history_drug_eye_tropicp_unit' => $post['history_drug_eye_tropicp_unit'],
			'history_drug_eye_tropicp_comm' => $post['history_drug_eye_tropicp_comm'],
			'tropi_m' => $tropi_m,
			'history_drug_eye_tropica_dur' => $post['history_drug_eye_tropica_dur'],
			'history_drug_eye_tropica_unit' => $post['history_drug_eye_tropica_unit'],
			'history_drug_eye_tropica_comm' => $post['history_drug_eye_tropica_comm'],
			'timolol_m' => $timolol_m,
			'history_drug_eye_timol_dur' => $post['history_drug_eye_timol_dur'],
			'history_drug_eye_timol_unit' => $post['history_drug_eye_timol_unit'],
			'history_drug_eye_timol_comm' => $post['history_drug_eye_timol_comm'],
			'homide_m' => $homide_m,
			'history_drug_eye_homide_dur' => $post['history_drug_eye_homide_dur'],
			'history_drug_eye_homide_unit' => $post['history_drug_eye_homide_unit'],
			'history_drug_eye_homide_comm' => $post['history_drug_eye_homide_comm'],
			'brimo_m' => $brimo_m,
			'history_drug_eye_brimon_dur' => $post['history_drug_eye_brimon_dur'],
			'history_drug_eye_brimon_unit' => $post['history_drug_eye_brimon_unit'],
			'history_drug_eye_brimon_comm' => $post['history_drug_eye_brimon_comm'],
			'latan_m' => $latan_m,
			'history_drug_eye_latan_dur' => $post['history_drug_eye_latan_dur'],
			'history_drug_eye_latan_unit' => $post['history_drug_eye_latan_unit'],
			'history_drug_eye_latan_comm' => $post['history_drug_eye_latan_comm'],
			'travo_m' => $travo_m,
			'history_drug_eye_travo_dur' => $post['history_drug_eye_travo_dur'],
			'history_drug_eye_travo_unit' => $post['history_drug_eye_travo_unit'],
			'history_drug_eye_travo_comm' => $post['history_drug_eye_travo_comm'],
			'tobra_m' => $tobra_m,
			'history_drug_eye_tobra_dur' => $post['history_drug_eye_tobra_dur'],
			'history_drug_eye_tobra_unit' => $post['history_drug_eye_tobra_unit'],
			'history_drug_eye_tobra_comm' => $post['history_drug_eye_tobra_comm'],
			'moxif_m' => $moxif_m,
			'history_drug_eye_moxif_dur' => $post['history_drug_eye_moxif_dur'],
			'history_drug_eye_moxif_unit' => $post['history_drug_eye_moxif_unit'],
			'history_drug_eye_moxif_comm' => $post['history_drug_eye_moxif_comm'],
			'homat_m' => $homat_m,
			'history_drug_eye_homat_dur' => $post['history_drug_eye_homat_dur'],
			'history_drug_eye_homat_unit' => $post['history_drug_eye_homat_unit'],
			'history_drug_eye_homat_comm' => $post['history_drug_eye_homat_comm'],
			'piloc_m' => $piloc_m,
			'history_drug_eye_piloca_dur' => $post['history_drug_eye_piloca_dur'],
			'history_drug_eye_piloca_unit' => $post['history_drug_eye_piloca_unit'],
			'history_drug_eye_piloca_comm' => $post['history_drug_eye_piloca_comm'],
			'cyclop_m' => $cyclop_m,
			'history_drug_eye_cyclop_dur' => $post['history_drug_eye_cyclop_dur'],
			'history_drug_eye_cyclop_unit' => $post['history_drug_eye_cyclop_unit'],
			'history_drug_eye_cyclop_comm' => $post['history_drug_eye_cyclop_comm'],
			'atrop_m' => $atrop_m,
			'history_drug_eye_atropi_dur' => $post['history_drug_eye_atropi_dur'],
			'history_drug_eye_atropi_unit' => $post['history_drug_eye_atropi_unit'],
			'history_drug_eye_atropi_comm' => $post['history_drug_eye_atropi_comm'],
			'phenyl_m' => $phenyl_m,
			'history_drug_eye_phenyl_dur' => $post['history_drug_eye_phenyl_dur'],
			'history_drug_eye_phenyl_unit' => $post['history_drug_eye_phenyl_unit'],
			'history_drug_eye_phenyl_comm' => $post['history_drug_eye_phenyl_comm'],
			'tropic_m' => $tropic_m,
			'history_drug_eye_tropicac_dur' => $post['history_drug_eye_tropicac_dur'],
			'history_drug_eye_tropicac_unit' => $post['history_drug_eye_tropicac_unit'],
			'history_drug_eye_tropicac_comm' => $post['history_drug_eye_tropicac_comm'],
			'parac_m' => $parac_m,
			'history_drug_eye_paracain_dur' => $post['history_drug_eye_paracain_dur'],
			'history_drug_eye_paracain_unit' => $post['history_drug_eye_paracain_unit'],
			'history_drug_eye_paracain_comm' => $post['history_drug_eye_paracain_comm'],
			'ciplox_m' => $ciplox_m,
			'history_drug_eye_ciplox_dur' => $post['history_drug_eye_ciplox_dur'],
			'history_drug_eye_ciplox_unit' => $post['history_drug_eye_ciplox_unit'],
		...
		$contact_allergies = array(
			...
			'history_contact_alcohol_unit' => $post['history_contact_alcohol_unit'],
			'history_contact_alcohol_comm' => $post['history_contact_alcohol_comm'],
			'latex_m' => $latex_m,
			'history_contact_latex_dur' => $post['history_contact_latex_dur'],
			'history_contact_latex_unit' => $post['history_contact_latex_unit'],
			'history_contact_latex_comm' => $post['history_contact_latex_comm'],
			'betad_m' => $betad_m,
			'history_contact_betad_dur' => $post['history_contact_betad_dur'],
			'history_contact_betad_unit' => $post['history_contact_betad_unit'],
			'history_contact_betad_comm' => $post['history_contact_betad_comm'],
			'adhes_m' => $adhes_m,
			'history_contact_adhes_dur' => $post['history_contact_adhes_dur'],
			'history_contact_adhes_unit' => $post['history_contact_adhes_unit'],
			'history_contact_adhes_comm' => $post['history_contact_adhes_comm'],
			'tegad_m' => $tegad_m,
			'history_contact_tegad_dur' => $post['history_contact_tegad_dur'],
			'history_contact_tegad_unit' => $post['history_contact_tegad_unit'],
			'history_contact_tegad_comm' => $post['history_contact_tegad_comm'],
			'trans_m' => $trans_m,
			'history_contact_transp_dur' => $post['history_contact_transp_dur'],
		...
		$food_allergies = array(
			'seaf_m' => $seaf_m,
			'history_food_seaf_dur' => $post['history_food_seaf_dur'],
			'history_food_seaf_unit' => $post['history_food_seaf_unit'],
			'history_food_seaf_comm' => $post['history_food_seaf_comm'],
			'corn_m' => $corn_m,
			'history_food_corn_dur' => $post['history_food_corn_dur'],
			'history_food_corn_unit' => $post['history_food_corn_unit'],
			'history_food_corn_comm' => $post['history_food_corn_comm'],
			'egg_m' => $egg_m,
			'history_food_egg_dur' => $post['history_food_egg_dur'],
			'history_food_egg_unit' => $post['history_food_egg_unit'],
			'history_food_egg_comm' => $post['history_food_egg_comm'],
			'milk_m' => $milk_m,
			'history_food_milk_p_dur' => $post['history_food_milk_p_dur'],
			'history_food_milk_p_unit' => $post['history_food_milk_p_unit'],
			'history_food_milk_p_comm' => $post['history_food_milk_p_comm'],
			'pean_m' => $pean_m,
			'history_food_pean_dur' => $post['history_food_pean_dur'],
			'history_food_pean_unit' => $post['history_food_pean_unit'],
			'history_food_pean_comm' => $post['history_food_pean_comm'],
			'shell_m' => $shell_m,
			'history_food_shell_dur' => $post['history_food_shell_dur'],
			'history_food_shell_unit' => $post['history_food_shell_unit'],
			'history_food_shell_comm' => $post['history_food_shell_comm'],
			'soy_m' => $soy_m,
			'history_food_soy_dur' => $post['history_food_soy_dur'],
			'history_food_soy_unit' => $post['history_food_soy_unit'],
			'history_food_soy_comm' => $post['history_food_soy_comm'],
			'lact_m' => $lact_m,
			'history_food_lact_dur' => $post['history_food_lact_dur'],
			'history_food_lact_unit' => $post['history_food_lact_unit'],
			'history_food_lact_comm' => $post['history_food_lact_comm'],
			'mush_m' => $mush_m,
			'history_food_mush_dur' => $post['history_food_mush_dur'],
			'history_food_mush_unit' => $post['history_food_mush_unit'],
			'history_food_mush_comm' => $post['history_food_mush_comm'],
			'history_food_comm' => $post['history_food_comm'],
			'history_vital_temp_update' => $post['history_vital_temp_update'],
			'history_vital_pulse_update' => $post['history_vital_pulse_update'],
			'history_vital_bp_update' => $post['history_vital_bp_update']
		);
	...
	public function get_prescription_std_eye_by_id($booking_id = '', $patient_id = '')
	{
		$this->db->select('*');
