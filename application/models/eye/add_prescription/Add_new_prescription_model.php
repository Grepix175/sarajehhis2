		...
		// history tabs
			...
			$chief_complaints=array(
				...
				'swel_m'=>$swel_m,'history_chief_swell_side'=>$post['history_chief_swell_side'], 'history_chief_swell_dur'=>$post['history_chief_swell_dur'], 'history_chief_swell_unit'=>$post['history_chief_swell_unit'],'history_chief_swell_comm'=>$post['history_chief_swell_comm'],
			 	'burns_m'=>$burns_m,'history_chief_sen_burn_side'=>$post['history_chief_sen_burn_side'], 'history_chief_sen_burn_dur'=>$post['history_chief_sen_burn_dur'], 'history_chief_sen_burn_unit'=>$post['history_chief_sen_burn_unit'],'history_chief_sen_burn_comm'=>$post['history_chief_sen_burn_comm'],
			 	'ptosis_sx'=>$ptosis_sx,'history_chief_ptosis_side'=>$post['history_chief_ptosis_side'], 'history_chief_ptosis_dur'=>$post['history_chief_ptosis_dur'], 'history_chief_ptosis_unit'=>$post['history_chief_ptosis_unit'],'history_chief_ptosis_comm'=>$post['history_chief_ptosis_comm'],
			 	'lid_sx'=>$lid_sx,'history_chief_lid_sx_side'=>$post['history_chief_lid_sx_side'], 'history_chief_lid_sx_dur'=>$post['history_chief_lid_sx_dur'], 'history_chief_lid_sx_unit'=>$post['history_chief_lid_sx_unit'],'history_chief_lid_sx_comm'=>$post['history_chief_lid_sx_comm'],
			 	'corneal_sx'=>$corneal_sx,'history_chief_corneal_sx_side'=>$post['history_chief_corneal_sx_side'], 'history_chief_corneal_sx_dur'=>$post['history_chief_corneal_sx_dur'], 'history_chief_corneal_sx_unit'=>$post['history_chief_corneal_sx_unit'],'history_chief_corneal_sx_comm'=>$post['history_chief_corneal_sx_comm'],
			 	'cataract_sx'=>$cataract_sx,'history_chief_cataract_sx_side'=>$post['history_chief_cataract_sx_side'], 'history_chief_cataract_sx_due'=>$post['history_chief_cataract_sx_due'], 'history_chief_cataract_sx_unit'=>$post['history_chief_cataract_sx_unit'],'history_chief_cataract_sx_comm'=>$post['history_chief_cataract_sx_comm'],
			 	'squint_sx'=>$squint_sx,'history_chief_squint_sx_side'=>$post['history_chief_squint_sx_side'], 'history_chief_squint_sx_due'=>$post['history_chief_squint_sx_due'], 'history_chief_squint_sx_unit'=>$post['history_chief_squint_sx_unit'],'history_chief_squint_sx_comm'=>$post['history_chief_squint_sx_comm'],
			 	'pterygium_sx'=>$pterygium_sx,'history_chief_pterygium_sx_side'=>$post['history_chief_pterygium_sx_side'], 'history_chief_pterygium_sx_due'=>$post['history_chief_pterygium_sx_due'], 'history_chief_pterygium_sx_unit'=>$post['history_chief_pterygium_sx_unit'],'history_chief_pterygium_sx_comm'=>$post['history_chief_pterygium_sx_comm'],
			 	'dcr'=>$dcr,'history_chief_dcr_sx_side'=>$post['history_chief_dcr_sx_side'], 'history_chief_dcr_sx_due'=>$post['history_chief_dcr_sx_due'], 'history_chief_dcr_sx_unit'=>$post['history_chief_dcr_sx_unit'],'history_chief_dcr_sx_comm'=>$post['history_chief_dcr_sx_comm'],
			 	'dct_sx'=>$dct_sx,'history_chief_dct_sx_side'=>$post['history_chief_dct_sx_side'], 'history_chief_dct_sx_due'=>$post['history_chief_dct_sx_due'], 'history_chief_dct_sx_unit'=>$post['history_chief_dct_sx_unit'],'history_chief_dct_sx_comm'=>$post['history_chief_dct_sx_comm'],
			 	'patching_therapy'=>$patching_therapy,'history_chief_patching_therapy_side'=>$post['history_chief_patching_therapy_side'], 'history_chief_patching_therapy_due'=>$post['history_chief_patching_therapy_due'], 'history_chief_patching_therapy_unit'=>$post['history_chief_patching_therapy_unit'],'history_chief_patching_therapy_comm'=>$post['history_chief_patching_therapy_comm'],'history_chief_comm'=>$post['history_chief_comm']
			 	);
			...
			$ophthalmic=array(
				...
				'contact_lens_m'=>$contact_lens_m,'history_ophthalmic_contact_lens_l_l_dur'=>$post['history_ophthalmic_contact_lens_l_l_dur'], 'history_ophthalmic_contact_lens_l_l_unit'=>$post['history_ophthalmic_contact_lens_l_l_unit'],'history_ophthalmic_contact_lens_l_r_dur'=>$post['history_ophthalmic_contact_lens_l_r_dur'], 'history_ophthalmic_contact_lens_l_r_unit'=>$post['history_ophthalmic_contact_lens_l_r_unit'], 'history_ophthalmic_contact_lens_l_comm'=>$post['history_ophthalmic_contact_lens_l_comm'],
				'vision_therapy_m'=>$vision_therapy_m,'history_ophthalmic_vision_therapy_l_l_dur'=>$post['history_ophthalmic_vision_therapy_l_l_dur'], 'history_ophthalmic_vision_therapy_l_l_unit'=>$post['history_ophthalmic_vision_therapy_l_l_unit'],'history_ophthalmic_vision_therapy_l_r_dur'=>$post['history_ophthalmic_vision_therapy_l_r_dur'], 'history_ophthalmic_vision_therapy_l_r_unit'=>$post['history_ophthalmic_vision_therapy_l_r_unit'], 'history_ophthalmic_vision_therapy_l_comm'=>$post['history_ophthalmic_vision_therapy_l_comm'],
				'low_vision_m'=>$low_vision_m,'history_ophthalmic_low_vision_l_l_dur'=>$post['history_ophthalmic_low_vision_l_l_dur'], 'history_ophthalmic_low_vision_l_l_unit'=>$post['history_ophthalmic_low_vision_l_l_unit'],'history_ophthalmic_low_vision_l_r_dur'=>$post['history_ophthalmic_low_vision_l_r_dur'], 'history_ophthalmic_low_vision_l_r_unit'=>$post['history_ophthalmic_low_vision_l_r_unit'], 'history_ophthalmic_low_vision_l_comm'=>$post['history_ophthalmic_low_vision_l_comm'],
				'aid_m'=>$aid_m,'history_ophthalmic_aid_l_l_dur'=>$post['history_ophthalmic_aid_l_l_dur'], 'history_ophthalmic_aid_l_l_unit'=>$post['history_ophthalmic_aid_l_l_unit'],'history_ophthalmic_aid_l_r_dur'=>$post['history_ophthalmic_aid_l_r_dur'], 'history_ophthalmic_aid_l_r_unit'=>$post['history_ophthalmic_aid_l_r_unit'], 'history_ophthalmic_aid_l_comm'=>$post['history_ophthalmic_aid_l_comm'],'history_ophthalmic_comm'=>$post['history_ophthalmic_comm']
				);
			...
			$systematic_history=array(
				...
				'thd_m'=>$thd_m,'history_systemic_thyrd_dur'=>$post['history_systemic_thyrd_dur'], 'history_systemic_thyrd_unit'=>$post['history_systemic_thyrd_unit'],'history_systemic_thyrd_comm'=>$post['history_systemic_thyrd_comm'],
			 	'chewt_m'=>$chewt_m,'history_systemic_chewt_dur'=>$post['history_systemic_chewt_dur'], 'history_systemic_chewt_unit'=>$post['history_systemic_chewt_unit'],'history_systemic_chewt_comm'=>$post['history_systemic_chewt_comm'],
			 	'chronic_kidney_disease_m'=>$chronic_kidney_disease_m,'history_systemic_chronic_kidney_dur'=>$post['history_systemic_chronic_kidney_dur'], 'history_systemic_chronic_kidney_unit'=>$post['history_systemic_chronic_kidney_unit'],'history_systemic_chronic_kidney_comm'=>$post['history_systemic_chronic_kidney_comm'],
			 	'can_m'=>$can_m,'history_systemic_can_dur'=>$post['history_systemic_can_dur'], 'history_systemic_can_unit'=>$post['history_systemic_can_unit'],'history_systemic_can_comm'=>$post['history_systemic_can_comm'],
			 	'rheumatoid_artheritis_m'=>$rheumatoid_artheritis_m,'history_systemic_rheumatoid_artheritis_dur'=>$post['history_systemic_rheumatoid_artheritis_dur'], 'history_systemic_rheumatoid_artheritis_unit'=>$post['history_systemic_rheumatoid_artheritis_unit'],'history_systemic_rheumatoid_artheritis_comm'=>$post['history_systemic_rheumatoid_artheritis_comm'],
			 	'benign_ruostatic_hyperplasia_m'=>$benign_ruostatic_hyperplasia_m,'history_systemic_benign_ruostatic_dur'=>$post['history_systemic_benign_ruostatic_dur'], 'history_systemic_benign_ruostatic_unit'=>$post['history_systemic_benign_ruostatic_unit'],'history_systemic_benign_ruostatic_comm'=>$post['history_systemic_benign_ruostatic_comm'],
			 	'drug_medication_history_m'=>$drug_medication_history_m,'history_systemic_drug_medication_dur'=>$post['history_systemic_drug_medication_dur'], 'history_systemic_drug_medication_unit'=>$post['history_systemic_drug_medication_unit'],'history_systemic_drug_medication_comm'=>$post['history_systemic_drug_medication_comm'],
			 	'bph_m'=>$bph_m,'history_systemic_bph_dur'=>$post['history_systemic_bph_dur'], 'history_systemic_bph_unit'=>$post['history_systemic_bph_unit'],'history_systemic_bph_comm'=>$post['history_systemic_bph_comm'],
			 	'thyroid_m'=>$thyroid_m,'history_systemic_thyroid_dur'=>$post['history_systemic_thyroid_dur'], 'history_systemic_thyroid_unit'=>$post['history_systemic_thyroid_unit'],'history_systemic_thyroid_comm'=>$post['history_systemic_thyroid_comm'],
			 	'history_systemic_comm'=>$post['history_systemic_comm']
			 	);
			$family_history_new=array(
				'consanguinity_m'=>$consanguinity_m, 'family_history_consanguinity_dur'=>$post['family_history_consanguinity_dur'], 'family_history_consanguinity_unit'=>$post['family_history_consanguinity_unit'],'family_history_consanguinity_comm'=>$post['family_history_consanguinity_comm'],
				'glaucoma_m'=>$glaucoma_m,'family_history_glaucoma_dur'=>$post['family_history_glaucoma_dur'], 'family_history_glaucoma_unit'=>$post['family_history_glaucoma_unit'],'family_history_glaucoma_comm'=>$post['family_history_glaucoma_comm'],
				'diabetes_m'=>$diabetes_m,'family_history_diabetes_dur'=>$post['family_history_diabetes_dur'], 'family_history_diabetes_unit'=>$post['family_history_diabetes_unit'],'family_history_diabetes_comm'=>$post['family_history_diabetes_comm'],
				'squint_m'=>$squint_m,'family_history_squint_dur'=>$post['family_history_squint_dur'], 'family_history_squint_unit'=>$post['family_history_squint_unit'],'family_history_squint_comm'=>$post['family_history_squint_comm'],
				'retinitis_pigmentosa_m'=>$retinitis_pigmentosa_m,'family_history_retinitis_pigmentosa_dur'=>$post['family_history_retinitis_pigmentosa_dur'], 'history_systemic_cardd_unit'=>$post['family_history_retinitis_pigmentosa_unit'],'family_history_retinitis_pigmentosa_comm'=>$post['family_history_retinitis_pigmentosa_comm'],
				'congenital_cataract_m'=>$congenital_cataract_m,'family_history_congenital_cataract_dur'=>$post['family_history_congenital_cataract_dur'], 'family_history_congenital_cataract_unit'=>$post['family_history_congenital_cataract_unit'],'family_history_congenital_cataract_comm'=>$post['family_history_congenital_cataract_comm'],
            ...
            // print_r($family_history);
			$his_data = array(
			    'branch_id'=>$post['branch_id'], 'pres_id'=>$prescriptionid, 'booking_code'=>$post['booking_code'], 
			    'patient_id'=>$post['patient_id'], 'booking_id'=>$post['booking_id'], 'symptom_fever'=>$post['symptom_fever'],
			    'symptom_cough'=>$post['symptom_cough'], 'symptom_smell_taste'=>$post['symptom_smell_taste'],
			    'symptom_loose_stools'=>$post['symptom_loose_stools'], 'symptom_local_zone'=>$post['symptom_local_zone'],
			    'symptom_travel'=>$post['symptom_travel'], 'symptom_contact'=>$post['symptom_contact'], 'free_test'=>$post['visit_comm']
			    ,'medical'=>$post['medical_history'], 'chief_complaints'=>json_encode($chief_complaints), 
			    'ophthalmic'=>json_encode($ophthalmic), 'systemic'=>json_encode($systematic_history),'family_history'=>json_encode($family_history_new),
			    'drug_allergies'=>json_encode($drug), 'contact_allergies'=>json_encode($contact_allergies), 
			    'food_allergies'=>json_encode($food_allergies), 'temperature'=>$history_vital_temp, 
			    'pulse'=>$history_vital_pulse, 'blood_pressure'=>$history_vital_bp, 
			    'rr'=>$history_vital_rr, 'height'=>$history_anthropometry_height,
			    'weight'=>$history_anthropometry_weight, 'bmi'=>$history_anthropometry_bmi, 
			    'comment'=>$history_anthropometry_comm, 'status'=>1, 'ip_address'=>$_SERVER['REMOTE_ADDR'], 
			    'created_by'=>$user_data['id'], 'created_date'=>date('Y-m-d H:i:s'));
